...
// GenericDataAPIService GenericDataAPI service
type GenericDataAPIService service
...
func (r ApiGetGenericDataRequest) ClientVersion(clientVersion int32) ApiGetGenericDataRequest {
	r.clientVersion = &clientVersion
	return r
}

func (r ApiGetGenericDataRequest) Execute() (*GenericData, *http.Response, error) {
	return r.ApiService.GetGenericDataExecute(r)
}
...
*/
func (a *GenericDataAPIService) GetGenericData(ctx context.Context) ApiGetGenericDataRequest {
	return ApiGetGenericDataRequest{
		ApiService: a,
		ctx: ctx,
	}
...
//  @return GenericData
func (a *GenericDataAPIService) GetGenericDataExecute(r ApiGetGenericDataRequest) (*GenericData, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GenericData
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "GenericDataAPIService.GetGenericData")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/assets/generic-data"
