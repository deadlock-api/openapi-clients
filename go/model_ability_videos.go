...
// checks if the AbilityVideos type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbilityVideos{}

// AbilityVideos struct for AbilityVideos
type AbilityVideos struct {
	Mp4 NullableString `json:"mp4,omitempty"`
	Webm NullableString `json:"webm,omitempty"`
}

// NewAbilityVideos instantiates a new AbilityVideos object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewAbilityVideos() *AbilityVideos {
	this := AbilityVideos{}
	return &this
}

// NewAbilityVideosWithDefaults instantiates a new AbilityVideos object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewAbilityVideosWithDefaults() *AbilityVideos {
	this := AbilityVideos{}
	return &this
}

// GetMp4 returns the Mp4 field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *AbilityVideos) GetMp4() string {
...
func (o *AbilityVideos) GetMp4Ok() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AbilityVideos) HasMp4() bool {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *AbilityVideos) GetWebmOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AbilityVideos) HasWebm() bool {
...
func (o *AbilityVideos) SetWebm(v string) {
	o.Webm.Set(&v)
}
// SetWebmNil sets the value for Webm to be an explicit nil
func (o *AbilityVideos) SetWebmNil() {
	o.Webm.Set(nil)
}

// UnsetWebm ensures that no value is present for Webm, not even an explicit nil
func (o *AbilityVideos) UnsetWebm() {
	o.Webm.Unset()
}

func (o AbilityVideos) MarshalJSON() ([]byte, error) {
...
func (o AbilityVideos) ToMap() (map[string]interface{}, error) {
...
type NullableAbilityVideos struct {
	value *AbilityVideos
	isSet bool
}

func (v NullableAbilityVideos) Get() *AbilityVideos {
	return v.value
}

func (v *NullableAbilityVideos) Set(val *AbilityVideos) {
	v.value = val
	v.isSet = true
}

func (v NullableAbilityVideos) IsSet() bool {
	return v.isSet
}

func (v *NullableAbilityVideos) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbilityVideos(val *AbilityVideos) *NullableAbilityVideos {
	return &NullableAbilityVideos{value: val, isSet: true}
}

func (v NullableAbilityVideos) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbilityVideos) UnmarshalJSON(src []byte) error {
	v.isSet = true
