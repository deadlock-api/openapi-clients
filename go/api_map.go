...
func (r ApiGetMapRequest) ClientVersion(clientVersion int32) ApiGetMapRequest {
...
*/
func (a *MapAPIService) GetMap(ctx context.Context) ApiGetMapRequest {
	return ApiGetMapRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MapAPIService) GetMapExecute(r ApiGetMapRequest) (*Map, *http.Response, error) {
	...
	localVarPath := localBasePath + "/v1/assets/map"
