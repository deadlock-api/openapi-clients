...
func Test_assets_deadlock_api_client_DefaultAPIService(t *testing.T) {
	...
	t.Run("Test DefaultAPIService GetFontsV1FontsGet", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.GetFontsV1FontsGet(context.Background()).Execute()
	...
	t.Run("Test DefaultAPIService GetImagesV1ImagesGet", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.GetImagesV1ImagesGet(context.Background()).Execute()
	...
	t.Run("Test DefaultAPIService GetSteamInfosV1SteamInfoAllGet", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.DefaultAPI.GetSteamInfosV1SteamInfoAllGet(context.Background()).Execute()
