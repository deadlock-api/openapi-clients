...
func (r ApiGetFontsV1FontsGetRequest) Execute() (map[string]string, *http.Response, error) {
	return r.ApiService.GetFontsV1FontsGetExecute(r)
}

/*
GetFontsV1FontsGet Get Fonts

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetFontsV1FontsGetRequest
*/
func (a *DefaultAPIService) GetFontsV1FontsGet(ctx context.Context) ApiGetFontsV1FontsGetRequest {
	return ApiGetFontsV1FontsGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *DefaultAPIService) GetFontsV1FontsGetExecute(r ApiGetFontsV1FontsGetRequest) (map[string]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetFontsV1FontsGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/fonts"
...
func (r ApiGetImagesV1ImagesGetRequest) Execute() (map[string]string, *http.Response, error) {
	return r.ApiService.GetImagesV1ImagesGetExecute(r)
}

/*
GetImagesV1ImagesGet Get Images

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetImagesV1ImagesGetRequest
*/
func (a *DefaultAPIService) GetImagesV1ImagesGet(ctx context.Context) ApiGetImagesV1ImagesGetRequest {
	return ApiGetImagesV1ImagesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]string
func (a *DefaultAPIService) GetImagesV1ImagesGetExecute(r ApiGetImagesV1ImagesGetRequest) (map[string]string, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetImagesV1ImagesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetLootTablesV2LootTablesGetRequest struct {
	ctx context.Context
	ApiService *DefaultAPIService
	clientVersion *DeadlockAssetsApiRoutesValidClientVersions
}

func (r ApiGetLootTablesV2LootTablesGetRequest) ClientVersion(clientVersion DeadlockAssetsApiRoutesValidClientVersions) ApiGetLootTablesV2LootTablesGetRequest {
	r.clientVersion = &clientVersion
	return r
}

func (r ApiGetLootTablesV2LootTablesGetRequest) Execute() (*map[string]LootTableV2, *http.Response, error) {
	return r.ApiService.GetLootTablesV2LootTablesGetExecute(r)
}

/*
GetLootTablesV2LootTablesGet Get Loot Tables

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetLootTablesV2LootTablesGetRequest
*/
func (a *DefaultAPIService) GetLootTablesV2LootTablesGet(ctx context.Context) ApiGetLootTablesV2LootTablesGetRequest {
	return ApiGetLootTablesV2LootTablesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return map[string]LootTableV2
func (a *DefaultAPIService) GetLootTablesV2LootTablesGetExecute(r ApiGetLootTablesV2LootTablesGetRequest) (*map[string]LootTableV2, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *map[string]LootTableV2
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetLootTablesV2LootTablesGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v2/loot-tables"
...
type ApiGetSteamInfosV1SteamInfoAllGetRequest struct {
	ctx context.Context
	ApiService *DefaultAPIService
}

func (r ApiGetSteamInfosV1SteamInfoAllGetRequest) Execute() ([]SteamInfoV1, *http.Response, error) {
	return r.ApiService.GetSteamInfosV1SteamInfoAllGetExecute(r)
}

/*
GetSteamInfosV1SteamInfoAllGet Get Steam Infos

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetSteamInfosV1SteamInfoAllGetRequest
*/
func (a *DefaultAPIService) GetSteamInfosV1SteamInfoAllGet(ctx context.Context) ApiGetSteamInfosV1SteamInfoAllGetRequest {
	return ApiGetSteamInfosV1SteamInfoAllGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
// Execute executes the request
//  @return []SteamInfoV1
func (a *DefaultAPIService) GetSteamInfosV1SteamInfoAllGetExecute(r ApiGetSteamInfosV1SteamInfoAllGetRequest) ([]SteamInfoV1, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetSteamInfosV1SteamInfoAllGet")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/steam-info/all"
