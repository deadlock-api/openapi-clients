...
type ApiGetRawAccoladesRawAccoladesGetRequest struct {
	ctx context.Context
	ApiService *RawAPIService
	clientVersion *DeadlockAssetsApiRoutesValidClientVersions
}

func (r ApiGetRawAccoladesRawAccoladesGetRequest) ClientVersion(clientVersion DeadlockAssetsApiRoutesValidClientVersions) ApiGetRawAccoladesRawAccoladesGetRequest {
...
/*
GetRawAccoladesRawAccoladesGet Get Raw Accolades

 @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 @return ApiGetRawAccoladesRawAccoladesGetRequest
*/
func (a *RawAPIService) GetRawAccoladesRawAccoladesGet(ctx context.Context) ApiGetRawAccoladesRawAccoladesGetRequest {
	return ApiGetRawAccoladesRawAccoladesGetRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *RawAPIService) GetRawAccoladesRawAccoladesGetExecute(r ApiGetRawAccoladesRawAccoladesGetRequest) ([]RawAccoladeV2, *http.Response, error) {
	...
	localVarPath := localBasePath + "/raw/accolades"
...
func (r ApiGetRawHeroesRawHeroesGetRequest) ClientVersion(clientVersion DeadlockAssetsApiRoutesValidClientVersions) ApiGetRawHeroesRawHeroesGetRequest {
	r.clientVersion = &clientVersion
	return r
}
...
func (r ApiGetRawItemsRawItemsGetRequest) ClientVersion(clientVersion DeadlockAssetsApiRoutesValidClientVersions) ApiGetRawItemsRawItemsGetRequest {
	r.clientVersion = &clientVersion
	return r
}
