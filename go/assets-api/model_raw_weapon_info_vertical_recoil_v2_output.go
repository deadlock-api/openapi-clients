...
// checks if the RawWeaponInfoVerticalRecoilV2Output type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RawWeaponInfoVerticalRecoilV2Output{}

// RawWeaponInfoVerticalRecoilV2Output struct for RawWeaponInfoVerticalRecoilV2Output
type RawWeaponInfoVerticalRecoilV2Output struct {
...
func NewRawWeaponInfoVerticalRecoilV2Output() *RawWeaponInfoVerticalRecoilV2Output {
	this := RawWeaponInfoVerticalRecoilV2Output{}
	return &this
}
...
func (o *RawWeaponInfoVerticalRecoilV2Output) SetRangeNil() {
	o.Range.Set(nil)
}
...
func (o *RawWeaponInfoVerticalRecoilV2Output) SetBurstExponentNil() {
...
func (o *RawWeaponInfoVerticalRecoilV2Output) SetBurstConstantNil() {
...
func (o *RawWeaponInfoVerticalRecoilV2Output) SetBurstSlopeNil() {
...
func (o RawWeaponInfoVerticalRecoilV2Output) MarshalJSON() ([]byte, error) {
...
func (o RawWeaponInfoVerticalRecoilV2Output) ToMap() (map[string]interface{}, error) {
...
type NullableRawWeaponInfoVerticalRecoilV2Output struct {
	value *RawWeaponInfoVerticalRecoilV2Output
	isSet bool
}

func (v NullableRawWeaponInfoVerticalRecoilV2Output) Get() *RawWeaponInfoVerticalRecoilV2Output {
	return v.value
}

func (v *NullableRawWeaponInfoVerticalRecoilV2Output) Set(val *RawWeaponInfoVerticalRecoilV2Output) {
	v.value = val
	v.isSet = true
}

func (v NullableRawWeaponInfoVerticalRecoilV2Output) IsSet() bool {
	return v.isSet
}

func (v *NullableRawWeaponInfoVerticalRecoilV2Output) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRawWeaponInfoVerticalRecoilV2Output(val *RawWeaponInfoVerticalRecoilV2Output) *NullableRawWeaponInfoVerticalRecoilV2Output {
	return &NullableRawWeaponInfoVerticalRecoilV2Output{value: val, isSet: true}
}

func (v NullableRawWeaponInfoVerticalRecoilV2Output) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRawWeaponInfoVerticalRecoilV2Output) UnmarshalJSON(src []byte) error {
	v.isSet = true
