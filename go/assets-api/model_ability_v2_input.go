...
// checks if the AbilityV2Input type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbilityV2Input{}

// AbilityV2Input struct for AbilityV2Input
type AbilityV2Input struct {
	Id int32 `json:"id"`
	...
	TooltipDetails NullableAbilityTooltipDetailsV2Input `json:"tooltip_details,omitempty"`
	Upgrades []RawAbilityUpgradeV2Input `json:"upgrades,omitempty"`
...
type _AbilityV2Input AbilityV2Input
...
func (o *AbilityV2Input) SetStartTrainedNil() {
...
func (o *AbilityV2Input) SetImageNil() {
	o.Image.Set(nil)
}
...
func (o *AbilityV2Input) SetImageWebpNil() {
	o.ImageWebp.Set(nil)
}
...
func (o *AbilityV2Input) SetHeroNil() {
	o.Hero.Set(nil)
}
...
func (o *AbilityV2Input) SetUpdateTimeNil() {
...
func (o *AbilityV2Input) SetWeaponInfoNil() {
...
func (o *AbilityV2Input) GetTooltipDetails() AbilityTooltipDetailsV2Input {
	if o == nil || IsNil(o.TooltipDetails.Get()) {
		var ret AbilityTooltipDetailsV2Input
		return ret
	}
...
// SetTooltipDetails gets a reference to the given NullableAbilityTooltipDetailsV2Input and assigns it to the TooltipDetails field.
...
func (o *AbilityV2Input) SetTooltipDetailsNil() {
...
func (o *AbilityV2Input) GetUpgrades() []RawAbilityUpgradeV2Input {
	if o == nil {
		var ret []RawAbilityUpgradeV2Input
		return ret
	}
	return o.Upgrades
}
...
// SetUpgrades gets a reference to the given []RawAbilityUpgradeV2Input and assigns it to the Upgrades field.
...
func (o *AbilityV2Input) SetAbilityTypeNil() {
...
func (o *AbilityV2Input) SetBossDamageScaleNil() {
...
func (o *AbilityV2Input) SetVideosNil() {
	o.Videos.Set(nil)
}
...
func (o AbilityV2Input) MarshalJSON() ([]byte, error) {
...
func (o AbilityV2Input) ToMap() (map[string]interface{}, error) {
...
func (o *AbilityV2Input) UnmarshalJSON(data []byte) (err error) {
	...
	varAbilityV2Input := _AbilityV2Input{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAbilityV2Input)

	if err != nil {
		return err
	}

	*o = AbilityV2Input(varAbilityV2Input)

	return err
}

type NullableAbilityV2Input struct {
	value *AbilityV2Input
	isSet bool
}

func (v NullableAbilityV2Input) Get() *AbilityV2Input {
	return v.value
}

func (v *NullableAbilityV2Input) Set(val *AbilityV2Input) {
	v.value = val
	v.isSet = true
}

func (v NullableAbilityV2Input) IsSet() bool {
	return v.isSet
}

func (v *NullableAbilityV2Input) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbilityV2Input(val *AbilityV2Input) *NullableAbilityV2Input {
	return &NullableAbilityV2Input{value: val, isSet: true}
}

func (v NullableAbilityV2Input) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbilityV2Input) UnmarshalJSON(src []byte) error {
	v.isSet = true
