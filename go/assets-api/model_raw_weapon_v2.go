...
// checks if the RawWeaponV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RawWeaponV2{}

// RawWeaponV2 struct for RawWeaponV2
type RawWeaponV2 struct {
...
func (o *RawWeaponV2) SetStartTrainedNil() {
...
func (o *RawWeaponV2) SetImageNil() {
	o.Image.Set(nil)
}
...
func (o *RawWeaponV2) SetUpdateTimeNil() {
...
func (o *RawWeaponV2) SetWeaponInfoNil() {
...
func (o *RawWeaponV2) SetCssClassNil() {
	o.CssClass.Set(nil)
}
...
func (o RawWeaponV2) ToMap() (map[string]interface{}, error) {
...
func (o *RawWeaponV2) UnmarshalJSON(data []byte) (err error) {
	...
	varRawWeaponV2 := _RawWeaponV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRawWeaponV2)

	if err != nil {
		return err
	}

	*o = RawWeaponV2(varRawWeaponV2)

	return err
}

type NullableRawWeaponV2 struct {
	value *RawWeaponV2
	isSet bool
}

func (v NullableRawWeaponV2) Get() *RawWeaponV2 {
	return v.value
}

func (v *NullableRawWeaponV2) Set(val *RawWeaponV2) {
	v.value = val
	v.isSet = true
}

func (v NullableRawWeaponV2) IsSet() bool {
	return v.isSet
}

func (v *NullableRawWeaponV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRawWeaponV2(val *RawWeaponV2) *NullableRawWeaponV2 {
	return &NullableRawWeaponV2{value: val, isSet: true}
}

func (v NullableRawWeaponV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRawWeaponV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
