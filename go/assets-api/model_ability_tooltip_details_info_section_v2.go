...
// checks if the AbilityTooltipDetailsInfoSectionV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbilityTooltipDetailsInfoSectionV2{}

// AbilityTooltipDetailsInfoSectionV2 struct for AbilityTooltipDetailsInfoSectionV2
type AbilityTooltipDetailsInfoSectionV2 struct {
...
func NewAbilityTooltipDetailsInfoSectionV2() *AbilityTooltipDetailsInfoSectionV2 {
	this := AbilityTooltipDetailsInfoSectionV2{}
	return &this
}
...
func (o *AbilityTooltipDetailsInfoSectionV2) SetLocStringNil() {
	o.LocString.Set(nil)
}
...
func (o *AbilityTooltipDetailsInfoSectionV2) SetPropertyUpgradeRequiredNil() {
...
func (o AbilityTooltipDetailsInfoSectionV2) MarshalJSON() ([]byte, error) {
...
func (o AbilityTooltipDetailsInfoSectionV2) ToMap() (map[string]interface{}, error) {
...
type NullableAbilityTooltipDetailsInfoSectionV2 struct {
	value *AbilityTooltipDetailsInfoSectionV2
	isSet bool
}

func (v NullableAbilityTooltipDetailsInfoSectionV2) Get() *AbilityTooltipDetailsInfoSectionV2 {
	return v.value
}

func (v *NullableAbilityTooltipDetailsInfoSectionV2) Set(val *AbilityTooltipDetailsInfoSectionV2) {
	v.value = val
	v.isSet = true
}

func (v NullableAbilityTooltipDetailsInfoSectionV2) IsSet() bool {
	return v.isSet
}

func (v *NullableAbilityTooltipDetailsInfoSectionV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbilityTooltipDetailsInfoSectionV2(val *AbilityTooltipDetailsInfoSectionV2) *NullableAbilityTooltipDetailsInfoSectionV2 {
	return &NullableAbilityTooltipDetailsInfoSectionV2{value: val, isSet: true}
}

func (v NullableAbilityTooltipDetailsInfoSectionV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbilityTooltipDetailsInfoSectionV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
