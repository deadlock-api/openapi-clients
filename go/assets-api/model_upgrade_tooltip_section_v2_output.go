...
// checks if the UpgradeTooltipSectionV2Output type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpgradeTooltipSectionV2Output{}

// UpgradeTooltipSectionV2Output struct for UpgradeTooltipSectionV2Output
type UpgradeTooltipSectionV2Output struct {
...
func NewUpgradeTooltipSectionV2Output() *UpgradeTooltipSectionV2Output {
	this := UpgradeTooltipSectionV2Output{}
	return &this
}
...
func (o *UpgradeTooltipSectionV2Output) SetSectionTypeNil() {
...
func (o UpgradeTooltipSectionV2Output) MarshalJSON() ([]byte, error) {
...
func (o UpgradeTooltipSectionV2Output) ToMap() (map[string]interface{}, error) {
...
type NullableUpgradeTooltipSectionV2Output struct {
	value *UpgradeTooltipSectionV2Output
	isSet bool
}

func (v NullableUpgradeTooltipSectionV2Output) Get() *UpgradeTooltipSectionV2Output {
	return v.value
}

func (v *NullableUpgradeTooltipSectionV2Output) Set(val *UpgradeTooltipSectionV2Output) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeTooltipSectionV2Output) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeTooltipSectionV2Output) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeTooltipSectionV2Output(val *UpgradeTooltipSectionV2Output) *NullableUpgradeTooltipSectionV2Output {
	return &NullableUpgradeTooltipSectionV2Output{value: val, isSet: true}
}

func (v NullableUpgradeTooltipSectionV2Output) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeTooltipSectionV2Output) UnmarshalJSON(src []byte) error {
	v.isSet = true
