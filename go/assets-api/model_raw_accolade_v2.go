...
// checks if the RawAccoladeV2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RawAccoladeV2{}

// RawAccoladeV2 struct for RawAccoladeV2
type RawAccoladeV2 struct {
...
type _RawAccoladeV2 RawAccoladeV2
...
func (o RawAccoladeV2) MarshalJSON() ([]byte, error) {
...
func (o RawAccoladeV2) ToMap() (map[string]interface{}, error) {
...
func (o *RawAccoladeV2) UnmarshalJSON(data []byte) (err error) {
	...
	varRawAccoladeV2 := _RawAccoladeV2{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRawAccoladeV2)

	if err != nil {
		return err
	}

	*o = RawAccoladeV2(varRawAccoladeV2)

	return err
}

type NullableRawAccoladeV2 struct {
	value *RawAccoladeV2
	isSet bool
}

func (v NullableRawAccoladeV2) Get() *RawAccoladeV2 {
	return v.value
}

func (v *NullableRawAccoladeV2) Set(val *RawAccoladeV2) {
	v.value = val
	v.isSet = true
}

func (v NullableRawAccoladeV2) IsSet() bool {
	return v.isSet
}

func (v *NullableRawAccoladeV2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableRawAccoladeV2(val *RawAccoladeV2) *NullableRawAccoladeV2 {
	return &NullableRawAccoladeV2{value: val, isSet: true}
}

func (v NullableRawAccoladeV2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableRawAccoladeV2) UnmarshalJSON(src []byte) error {
	v.isSet = true
