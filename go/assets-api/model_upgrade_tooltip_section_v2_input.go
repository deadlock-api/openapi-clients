...
// checks if the UpgradeTooltipSectionV2Input type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &UpgradeTooltipSectionV2Input{}

// UpgradeTooltipSectionV2Input struct for UpgradeTooltipSectionV2Input
type UpgradeTooltipSectionV2Input struct {
...
func NewUpgradeTooltipSectionV2Input() *UpgradeTooltipSectionV2Input {
	this := UpgradeTooltipSectionV2Input{}
	return &this
}
...
func (o *UpgradeTooltipSectionV2Input) SetSectionTypeNil() {
...
func (o UpgradeTooltipSectionV2Input) MarshalJSON() ([]byte, error) {
...
func (o UpgradeTooltipSectionV2Input) ToMap() (map[string]interface{}, error) {
...
type NullableUpgradeTooltipSectionV2Input struct {
	value *UpgradeTooltipSectionV2Input
	isSet bool
}

func (v NullableUpgradeTooltipSectionV2Input) Get() *UpgradeTooltipSectionV2Input {
	return v.value
}

func (v *NullableUpgradeTooltipSectionV2Input) Set(val *UpgradeTooltipSectionV2Input) {
	v.value = val
	v.isSet = true
}

func (v NullableUpgradeTooltipSectionV2Input) IsSet() bool {
	return v.isSet
}

func (v *NullableUpgradeTooltipSectionV2Input) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableUpgradeTooltipSectionV2Input(val *UpgradeTooltipSectionV2Input) *NullableUpgradeTooltipSectionV2Input {
	return &NullableUpgradeTooltipSectionV2Input{value: val, isSet: true}
}

func (v NullableUpgradeTooltipSectionV2Input) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableUpgradeTooltipSectionV2Input) UnmarshalJSON(src []byte) error {
	v.isSet = true
