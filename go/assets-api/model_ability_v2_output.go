...
// checks if the AbilityV2Output type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AbilityV2Output{}

// AbilityV2Output struct for AbilityV2Output
type AbilityV2Output struct {
	Id int32 `json:"id"`
	...
	TooltipDetails NullableAbilityTooltipDetailsV2Output `json:"tooltip_details,omitempty"`
	Upgrades []RawAbilityUpgradeV2Output `json:"upgrades,omitempty"`
...
type _AbilityV2Output AbilityV2Output
...
func (o *AbilityV2Output) SetStartTrainedNil() {
...
func (o *AbilityV2Output) SetImageNil() {
	o.Image.Set(nil)
}
...
func (o *AbilityV2Output) SetImageWebpNil() {
	o.ImageWebp.Set(nil)
}
...
func (o *AbilityV2Output) SetHeroNil() {
	o.Hero.Set(nil)
}
...
func (o *AbilityV2Output) SetUpdateTimeNil() {
...
func (o *AbilityV2Output) SetWeaponInfoNil() {
...
func (o *AbilityV2Output) GetTooltipDetails() AbilityTooltipDetailsV2Output {
	if o == nil || IsNil(o.TooltipDetails.Get()) {
		var ret AbilityTooltipDetailsV2Output
		return ret
	}
...
// SetTooltipDetails gets a reference to the given NullableAbilityTooltipDetailsV2Output and assigns it to the TooltipDetails field.
...
func (o *AbilityV2Output) SetTooltipDetailsNil() {
...
func (o *AbilityV2Output) GetUpgrades() []RawAbilityUpgradeV2Output {
	if o == nil {
		var ret []RawAbilityUpgradeV2Output
		return ret
	}
	return o.Upgrades
}
...
// SetUpgrades gets a reference to the given []RawAbilityUpgradeV2Output and assigns it to the Upgrades field.
...
func (o *AbilityV2Output) SetAbilityTypeNil() {
...
func (o *AbilityV2Output) SetBossDamageScaleNil() {
...
func (o *AbilityV2Output) SetVideosNil() {
	o.Videos.Set(nil)
}
...
func (o AbilityV2Output) MarshalJSON() ([]byte, error) {
...
func (o AbilityV2Output) ToMap() (map[string]interface{}, error) {
...
func (o *AbilityV2Output) UnmarshalJSON(data []byte) (err error) {
	...
	varAbilityV2Output := _AbilityV2Output{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAbilityV2Output)

	if err != nil {
		return err
	}

	*o = AbilityV2Output(varAbilityV2Output)

	return err
}

type NullableAbilityV2Output struct {
	value *AbilityV2Output
	isSet bool
}

func (v NullableAbilityV2Output) Get() *AbilityV2Output {
	return v.value
}

func (v *NullableAbilityV2Output) Set(val *AbilityV2Output) {
	v.value = val
	v.isSet = true
}

func (v NullableAbilityV2Output) IsSet() bool {
	return v.isSet
}

func (v *NullableAbilityV2Output) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAbilityV2Output(val *AbilityV2Output) *NullableAbilityV2Output {
	return &NullableAbilityV2Output{value: val, isSet: true}
}

func (v NullableAbilityV2Output) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAbilityV2Output) UnmarshalJSON(src []byte) error {
	v.isSet = true
