...
**PropertiesBlock** | Pointer to [**[]TooltipDetailsBlock**](TooltipDetailsBlock.md) |  | [optional] 
**PropertyUpgradeRequired** | Pointer to **NullableString** |  | [optional] 

## Methods

### NewTooltipDetailsInfoSection
...
### NewTooltipDetailsInfoSectionWithDefaults
...
`func (o *TooltipDetailsInfoSection) SetBasicPropertiesNil(b bool)`

 SetBasicPropertiesNil sets the value for BasicProperties to be an explicit nil

### UnsetBasicProperties
`func (o *TooltipDetailsInfoSection) UnsetBasicProperties()`
...
`func (o *TooltipDetailsInfoSection) SetLocStringNil(b bool)`
...
`func (o *TooltipDetailsInfoSection) SetPropertiesBlockNil(b bool)`

 SetPropertiesBlockNil sets the value for PropertiesBlock to be an explicit nil

### UnsetPropertiesBlock
`func (o *TooltipDetailsInfoSection) UnsetPropertiesBlock()`
...
`func (o *TooltipDetailsInfoSection) SetPropertyUpgradeRequiredNil(b bool)`
