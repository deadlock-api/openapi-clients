...
**MatchesPlayed** | **int64** | Lane matchups behind the curve, counted at its *least* covered sample. A match that ended before 900s still contributes to the earlier points, so the earlier points rest on at least this many matchups and never fewer. | 
...
**SampleTimesS** | **[]int32** | Seconds into the match each entry of &#x60;net_worth_diff&#x60; was sampled at, ascending. | 
