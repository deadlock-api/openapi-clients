...
`func NewAccountRank(badge int32, rank int32, subrank int32, accountId int32, ) *AccountRank`

NewAccountRank instantiates a new AccountRank object
This constructor will assign default values to properties that have it defined,
and makes sure properties required by API are set, but the set of arguments
will change when the set of required properties is changed

### NewAccountRankWithDefaults

`func NewAccountRankWithDefaults() *AccountRank`

NewAccountRankWithDefaults instantiates a new AccountRank object
This constructor will only assign default values to properties that have it defined,
but it doesn't guarantee that properties required by API are set

### GetBadge

`func (o *AccountRank) GetBadge() int32`

GetBadge returns the Badge field if non-nil, zero value otherwise.

### GetBadgeOk

`func (o *AccountRank) GetBadgeOk() (*int32, bool)`
...
`func (o *AccountRank) SetBadge(v int32)`
...
`func (o *AccountRank) GetLastMatch() LastRankedMatch`

GetLastMatch returns the LastMatch field if non-nil, zero value otherwise.

### GetLastMatchOk

`func (o *AccountRank) GetLastMatchOk() (*LastRankedMatch, bool)`
...
`func (o *AccountRank) SetRank(v int32)`
...
`func (o *AccountRank) GetSubrank() int32`

GetSubrank returns the Subrank field if non-nil, zero value otherwise.

### GetSubrankOk

`func (o *AccountRank) GetSubrankOk() (*int32, bool)`
...
`func (o *AccountRank) SetSubrank(v int32)`
...
`func (o *AccountRank) GetAccountId() int32`

GetAccountId returns the AccountId field if non-nil, zero value otherwise.

### GetAccountIdOk

`func (o *AccountRank) GetAccountIdOk() (*int32, bool)`
...
`func (o *AccountRank) SetAccountId(v int32)`
