...
type ApiListColorsRequest struct {
	ctx context.Context
...
func (r ApiListColorsRequest) ClientVersion(clientVersion int32) ApiListColorsRequest {
	r.clientVersion = &clientVersion
	return r
}

func (r ApiListColorsRequest) Execute() (*map[string]Color, *http.Response, error) {
	return r.ApiService.ListColorsExecute(r)
}
...
Panorama color palette (`@define <name>: #RRGGBB[AA];` declarations from `citadel_base_styles.css`), keyed by `snake_case` name.
 ...
 @return ApiListColorsRequest
*/
func (a *ColorsAPIService) ListColors(ctx context.Context) ApiListColorsRequest {
	return ApiListColorsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *ColorsAPIService) ListColorsExecute(r ApiListColorsRequest) (*map[string]Color, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *map[string]Color
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ColorsAPIService.ListColors")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/assets/colors"
