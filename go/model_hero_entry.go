...
// checks if the HeroEntry type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &HeroEntry{}

// HeroEntry struct for HeroEntry
...
func (o HeroEntry) MarshalJSON() ([]byte, error) {
...
func (o HeroEntry) ToMap() (map[string]interface{}, error) {
...
func (o *HeroEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varHeroEntry := _HeroEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varHeroEntry)

	if err != nil {
		return err
	}

	*o = HeroEntry(varHeroEntry)

	return err
}

type NullableHeroEntry struct {
	value *HeroEntry
	isSet bool
}

func (v NullableHeroEntry) Get() *HeroEntry {
	return v.value
}

func (v *NullableHeroEntry) Set(val *HeroEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableHeroEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableHeroEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableHeroEntry(val *HeroEntry) *NullableHeroEntry {
	return &NullableHeroEntry{value: val, isSet: true}
}

func (v NullableHeroEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableHeroEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
