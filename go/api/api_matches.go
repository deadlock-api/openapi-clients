...
*/
func (a *MatchesAPIService) BadgeDistribution(ctx context.Context) ApiBadgeDistributionRequest {
	return ApiBadgeDistributionRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MatchesAPIService) BadgeDistributionExecute(r ApiBadgeDistributionRequest) ([]BadgeDistribution, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MatchesAPIService.BadgeDistribution")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/v1/matches/badge-distribution"
