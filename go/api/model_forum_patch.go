...
// checks if the ForumPatch type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ForumPatch{}

// ForumPatch struct for ForumPatch
...
func (o ForumPatch) MarshalJSON() ([]byte, error) {
...
func (o ForumPatch) ToMap() (map[string]interface{}, error) {
...
func (o *ForumPatch) UnmarshalJSON(data []byte) (err error) {
	...
	varForumPatch := _ForumPatch{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varForumPatch)

	if err != nil {
		return err
	}

	*o = ForumPatch(varForumPatch)

	return err
}

type NullableForumPatch struct {
	value *ForumPatch
	isSet bool
}

func (v NullableForumPatch) Get() *ForumPatch {
	return v.value
}

func (v *NullableForumPatch) Set(val *ForumPatch) {
	v.value = val
	v.isSet = true
}

func (v NullableForumPatch) IsSet() bool {
	return v.isSet
}

func (v *NullableForumPatch) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableForumPatch(val *ForumPatch) *NullableForumPatch {
	return &NullableForumPatch{value: val, isSet: true}
}

func (v NullableForumPatch) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableForumPatch) UnmarshalJSON(src []byte) error {
	v.isSet = true
