...
type Curve struct {
	Base NullableFloat64 `json:"base,omitempty"`
	PerMinuteAfterStart NullableFloat64 `json:"per_minute_after_start,omitempty"`
}
...
// SetBase gets a reference to the given NullableFloat64 and assigns it to the Base field.
...
// SetPerMinuteAfterStart gets a reference to the given NullableFloat64 and assigns it to the PerMinuteAfterStart field.
