package deadlock_api_client.infrastructure
...
import deadlock_api_client.auth.*
...
open class ApiClient(
    ...
    private val authentications: kotlin.collections.Map<String, Authentication> by lazy {
        mapOf(
                "api_key_header" to ApiKeyAuth("header", "X-API-KEY"), 
                "api_key_query" to ApiKeyAuth("query", "api_key"))
    }

    companion object {
          const val BASE_URL: String = "https://api.deadlock-api.com"
