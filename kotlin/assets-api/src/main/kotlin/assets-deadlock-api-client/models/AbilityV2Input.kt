...
data class AbilityV2Input (
    ...
    @Json(name = "type")
    val type: AbilityV2Input.Type? = Type.ability,

    @Json(name = "behaviours")
    val behaviours: kotlin.collections.List<kotlin.String>? = null,

    @Json(name = "tooltip_details")
    val tooltipDetails: AbilityTooltipDetailsV2Input? = null,

    @Json(name = "upgrades")
    val upgrades: kotlin.collections.List<RawAbilityUpgradeV2Input>? = null,
