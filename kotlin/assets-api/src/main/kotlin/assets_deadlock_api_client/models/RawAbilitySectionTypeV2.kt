...
enum class RawAbilitySectionTypeV2(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is RawAbilitySectionTypeV2) "$data" else null

        /**
         * Returns a valid [RawAbilitySectionTypeV2] for [data], null otherwise.
         */
