...
open class RawApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    /**
     * To obtain the request config of the operation getRawAccoladesRawAccoladesGet
     *
     * @param clientVersion  (optional)
     * @return RequestConfig
     */
    fun getRawAccoladesRawAccoladesGetRequestConfig(clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : RequestConfig<Unit> {
     ...
     * @return RequestConfig
     */
    fun getRawHeroesRawHeroesGetRequestConfig(clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (clientVersion != null) {
     ...
     * @return RequestConfig
     */
    fun getRawItemsRawItemsGetRequestConfig(clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (clientVersion != null) {
