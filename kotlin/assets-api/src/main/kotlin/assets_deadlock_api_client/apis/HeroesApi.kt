...
open class HeroesApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    fun getHeroByNameV2HeroesByNameNameGet(name: kotlin.String, language: Language? = null, clientVersion: DeadlockAssetsApiRoutesValidClientVersions? = null) : HeroV2 {
    ...
    fun getHeroByNameV2HeroesByNameNameGetWithHttpInfo(name: kotlin.String, language: Language?, clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : ApiResponse<HeroV2?> {
     ...
     */
    fun getHeroByNameV2HeroesByNameNameGetRequestConfig(name: kotlin.String, language: Language?, clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getHeroV2HeroesIdGet(id: kotlin.Int, language: Language? = null, clientVersion: DeadlockAssetsApiRoutesValidClientVersions? = null) : HeroV2 {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getHeroV2HeroesIdGetWithHttpInfo(id: kotlin.Int, language: Language?, clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : ApiResponse<HeroV2?> {
     ...
     * @return RequestConfig
     */
    fun getHeroV2HeroesIdGetRequestConfig(id: kotlin.Int, language: Language?, clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (language != null) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun getHeroesV2HeroesGet(language: Language? = null, clientVersion: DeadlockAssetsApiRoutesValidClientVersions? = null, onlyActive: kotlin.Boolean? = null) : kotlin.collections.List<HeroV2> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun getHeroesV2HeroesGetWithHttpInfo(language: Language?, clientVersion: DeadlockAssetsApiRoutesValidClientVersions?, onlyActive: kotlin.Boolean?) : ApiResponse<kotlin.collections.List<HeroV2>?> {
     ...
     * @return RequestConfig
     */
    fun getHeroesV2HeroesGetRequestConfig(language: Language?, clientVersion: DeadlockAssetsApiRoutesValidClientVersions?, onlyActive: kotlin.Boolean?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (language != null) {
