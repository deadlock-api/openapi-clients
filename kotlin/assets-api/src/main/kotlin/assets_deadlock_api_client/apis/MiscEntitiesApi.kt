...
open class MiscEntitiesApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun getMiscEntitiesV2MiscEntitiesGet(clientVersion: DeadlockAssetsApiRoutesValidClientVersions? = null) : kotlin.collections.List<MiscV2> {
    ...
    fun getMiscEntitiesV2MiscEntitiesGetWithHttpInfo(clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : ApiResponse<kotlin.collections.List<MiscV2>?> {
     ...
     */
    fun getMiscEntitiesV2MiscEntitiesGetRequestConfig(clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : RequestConfig<Unit> {
     ...
     * @return RequestConfig
     */
    fun getMiscEntityV2MiscEntitiesIdOrClassNameGetRequestConfig(idOrClassName: kotlin.String, clientVersion: DeadlockAssetsApiRoutesValidClientVersions?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (clientVersion != null) {
