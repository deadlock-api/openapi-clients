...
# **getFontsV1FontsGet**
> kotlin.collections.Map&lt;kotlin.String, kotlin.String&gt; getFontsV1FontsGet()
...
try {
    ...
    println("4xx response calling DefaultApi#getFontsV1FontsGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#getFontsV1FontsGet")
    e.printStackTrace()
}
```
...
# **getIconsV1IconsGet**
> kotlin.collections.Map&lt;kotlin.String, kotlin.String&gt; getIconsV1IconsGet()
...
> kotlin.collections.Map&lt;kotlin.String, kotlin.String&gt; getImagesV1ImagesGet()
...
> kotlin.collections.Map&lt;kotlin.String, kotlin.Any&gt; getSoundsV1SoundsGet()
...
> kotlin.collections.List&lt;SteamInfoV1&gt; getSteamInfosV1SteamInfoAllGet()
...
try {
    ...
    println("4xx response calling DefaultApi#getSteamInfosV1SteamInfoAllGet")
    e.printStackTrace()
} catch (e: ServerException) {
    println("5xx response calling DefaultApi#getSteamInfosV1SteamInfoAllGet")
    e.printStackTrace()
}
```
...
[**kotlin.collections.List&lt;SteamInfoV1&gt;**](SteamInfoV1.md)
