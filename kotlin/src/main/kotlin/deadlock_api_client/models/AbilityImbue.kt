...
enum class AbilityImbue(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is AbilityImbue) "$data" else null

        /**
         * Returns a valid [AbilityImbue] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): AbilityImbue? = data?.let {
