...
enum class StatsUsageFlag(val value: kotlin.String) {
    ...
    companion object {
         ...
         */
        fun encode(data: kotlin.Any?): kotlin.String? = if (data is StatsUsageFlag) "$data" else null

        /**
         * Returns a valid [StatsUsageFlag] for [data], null otherwise.
         */
        fun decode(data: kotlin.Any?): StatsUsageFlag? = data?.let {
