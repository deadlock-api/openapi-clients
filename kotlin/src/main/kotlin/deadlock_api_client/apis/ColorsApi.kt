...
open class ColorsApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
     ...
     * @return kotlin.collections.Map<kotlin.String, Color>
    ...
    fun listColors(clientVersion: kotlin.Int? = null) : kotlin.collections.Map<kotlin.String, Color> {
        val localVarResponse = listColorsWithHttpInfo(clientVersion = clientVersion)

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.Map<kotlin.String, Color>
     ...
     * Panorama color palette (&#x60;@define &lt;name&gt;: #RRGGBB[AA];&#x60; declarations from &#x60;citadel_base_styles.css&#x60;), keyed by &#x60;snake_case&#x60; name.
     * @param clientVersion Client/game version (e.g. &#x60;6518&#x60;). Defaults to the latest known version. (optional)
     * @return ApiResponse<kotlin.collections.Map<kotlin.String, Color>?>
     * @throws IllegalStateException If the request is not correctly configured
     * @throws IOException Rethrows the OkHttp execute method exception
     */
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun listColorsWithHttpInfo(clientVersion: kotlin.Int?) : ApiResponse<kotlin.collections.Map<kotlin.String, Color>?> {
        val localVariableConfig = listColorsRequestConfig(clientVersion = clientVersion)

        return request<Unit, kotlin.collections.Map<kotlin.String, Color>>(
            localVariableConfig
        )
    }

    /**
     * To obtain the request config of the operation listColors
     *
     * @param clientVersion Client/game version (e.g. &#x60;6518&#x60;). Defaults to the latest known version. (optional)
     * @return RequestConfig
     */
    fun listColorsRequestConfig(clientVersion: kotlin.Int?) : RequestConfig<Unit> {
