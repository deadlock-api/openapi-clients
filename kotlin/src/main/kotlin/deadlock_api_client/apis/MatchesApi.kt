...
open class MatchesApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     * @param onlyFilteredPlayers Only include the players matching &#x60;account_ids&#x60; in the &#x60;players&#x60; array instead of all players of the match. Requires &#x60;account_ids&#x60;. (optional)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun bulkMetadata(includeInfo: kotlin.Boolean? = true, includeMoreInfo: kotlin.Boolean? = null, includeObjectives: kotlin.Boolean? = null, includeMidBoss: kotlin.Boolean? = null, includePlayerInfo: kotlin.Boolean? = null, includePlayerKda: kotlin.Boolean? = null, includePlayerItems: kotlin.Boolean? = null, includePlayerStats: kotlin.Boolean? = null, includePlayerFinalStats: kotlin.Boolean? = null, includePlayerDeathDetails: kotlin.Boolean? = null, gameMode: GameModeBulkMetadata? = null, matchMode: kotlin.String? = null, matchIds: kotlin.collections.List<kotlin.Long>? = null, minUnixTimestamp: kotlin.Long? = null, maxUnixTimestamp: kotlin.Long? = null, minDurationS: kotlin.Long? = null, maxDurationS: kotlin.Long? = null, minAverageBadge: kotlin.Int? = null, maxAverageBadge: kotlin.Int? = null, minMatchId: kotlin.Long? = null, maxMatchId: kotlin.Long? = null, isHighSkillRangeParties: kotlin.Boolean? = null, isLowPriPool: kotlin.Boolean? = null, isNewPlayerPool: kotlin.Boolean? = null, accountIds: kotlin.collections.List<kotlin.Int>? = null, onlyFilteredPlayers: kotlin.Boolean? = null, heroIds: kotlin.String? = null, itemFilterHeroId: kotlin.Int? = null, includeItemIds: kotlin.String? = null, excludeItemIds: kotlin.String? = null, extraMatchColumns: kotlin.String? = null, extraPlayerColumns: kotlin.String? = null, orderBy: OrderByBulkMetadata? = null, orderDirection: OrderDirectionBulkMetadata? = null, limit: kotlin.Int? = 1000, format: FormatBulkMetadata? = null) : kotlin.collections.List<kotlin.Int> {
    ...
    fun bulkMetadataRequestConfig(includeInfo: kotlin.Boolean?, includeMoreInfo: kotlin.Boolean?, includeObjectives: kotlin.Boolean?, includeMidBoss: kotlin.Boolean?, includePlayerInfo: kotlin.Boolean?, includePlayerKda: kotlin.Boolean?, includePlayerItems: kotlin.Boolean?, includePlayerStats: kotlin.Boolean?, includePlayerFinalStats: kotlin.Boolean?, includePlayerDeathDetails: kotlin.Boolean?, gameMode: GameModeBulkMetadata?, matchMode: kotlin.String?, matchIds: kotlin.collections.List<kotlin.Long>?, minUnixTimestamp: kotlin.Long?, maxUnixTimestamp: kotlin.Long?, minDurationS: kotlin.Long?, maxDurationS: kotlin.Long?, minAverageBadge: kotlin.Int?, maxAverageBadge: kotlin.Int?, minMatchId: kotlin.Long?, maxMatchId: kotlin.Long?, isHighSkillRangeParties: kotlin.Boolean?, isLowPriPool: kotlin.Boolean?, isNewPlayerPool: kotlin.Boolean?, accountIds: kotlin.collections.List<kotlin.Int>?, onlyFilteredPlayers: kotlin.Boolean?, heroIds: kotlin.String?, itemFilterHeroId: kotlin.Int?, includeItemIds: kotlin.String?, excludeItemIds: kotlin.String?, extraMatchColumns: kotlin.String?, extraPlayerColumns: kotlin.String?, orderBy: OrderByBulkMetadata?, orderDirection: OrderDirectionBulkMetadata?, limit: kotlin.Int?, format: FormatBulkMetadata?) : RequestConfig<Unit> {
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                ...
                if (onlyFilteredPlayers != null) {
                    put("only_filtered_players", listOf(onlyFilteredPlayers.toString()))
                }
                if (heroIds != null) {
