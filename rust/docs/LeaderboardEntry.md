...
**badge_level** | Option<**u32**> | The badge level of the player (tier = first digits, subtier = last digit). See more: <https://api.deadlock-api.com/v1/assets/ranks> | [optional]
...
**ranked_rank** | Option<**u32**> | The ranked rank of the player. See more: <https://api.deadlock-api.com/v1/assets/ranks> | [optional]
**ranked_subrank** | Option<**u32**> | The ranked subrank of the player. See more: <https://api.deadlock-api.com/v1/assets/ranks> | [optional]
