...
**zipline_paths** | [**Vec<models::ZiplanePathV1>**](ZiplanePathV1.md) | The ziplane paths of the map. Each path is a list of P0, P1, and P2 points, describing the cubic spline. | [readonly]
