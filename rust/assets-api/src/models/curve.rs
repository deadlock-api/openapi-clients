...
pub struct Curve {
    ...
    #[serde(rename = "per_minute_after_start", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub per_minute_after_start: Option<Option<f64>>,
}
