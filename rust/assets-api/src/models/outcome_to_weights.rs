...
pub struct OutcomeToWeights {
    #[serde(rename = "outcomes_to_weights")]
    pub outcomes_to_weights: std::collections::HashMap<String, f64>,
}

impl OutcomeToWeights {
    pub fn new(outcomes_to_weights: std::collections::HashMap<String, f64>) -> OutcomeToWeights {
        OutcomeToWeights {
            outcomes_to_weights,
        }
    }
