...
pub struct UpgradeV2Output {
    ...
    pub properties: Option<Option<std::collections::HashMap<String, models::UpgradePropertyV2Output>>>,
    #[serde(rename = "weapon_info", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub weapon_info: Option<Option<Box<models::RawItemWeaponInfoV2Output>>>,
    ...
    pub tooltip_sections: Option<Option<Vec<models::UpgradeTooltipSectionV2Output>>>,
...
impl UpgradeV2Output {
    pub fn new(id: i32, class_name: String, name: String, item_slot_type: models::ItemSlotTypeV2, item_tier: models::ItemTierV2, activation: models::RawAbilityActivationV2, is_active_item: bool, shopable: bool, cost: Option<i32>) -> UpgradeV2Output {
        UpgradeV2Output {
            id,
            class_name,
            name,
