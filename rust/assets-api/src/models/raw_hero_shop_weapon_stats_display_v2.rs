...
pub struct RawHeroShopWeaponStatsDisplayV2 {
    ...
    pub weapon_attributes: Option<Option<String>>,
...
impl RawHeroShopWeaponStatsDisplayV2 {
    pub fn new(display_stats: Vec<String>, other_display_stats: Vec<String>) -> RawHeroShopWeaponStatsDisplayV2 {
