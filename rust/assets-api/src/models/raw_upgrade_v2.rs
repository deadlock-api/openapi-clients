...
pub struct RawUpgradeV2 {
    ...
    pub tooltip_sections: Option<Option<Vec<models::RawUpgradeTooltipSectionV2>>>,
...
impl RawUpgradeV2 {
    pub fn new(class_name: String, item_slot_type: models::ItemSlotTypeV2, item_tier: models::ItemTierV2) -> RawUpgradeV2 {
        RawUpgradeV2 {
            class_name,
            start_trained: None,
            image: None,
