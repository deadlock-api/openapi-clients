...
pub struct RawAbilityV2TooltipDetailsInfoSectionPropertyBlock {
    ...
    pub properties: Option<Option<Vec<models::RawAbilityV2TooltipDetailsInfoSectionPropertyBlockProperty>>>,
}

impl RawAbilityV2TooltipDetailsInfoSectionPropertyBlock {
    pub fn new() -> RawAbilityV2TooltipDetailsInfoSectionPropertyBlock {
