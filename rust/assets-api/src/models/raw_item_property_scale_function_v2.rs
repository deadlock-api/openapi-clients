...
pub struct RawItemPropertyScaleFunctionV2 {
    #[serde(rename = "subclass", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub subclass: Option<Option<Box<models::RawItemPropertyScaleFunctionSubclassV2>>>,
}

impl RawItemPropertyScaleFunctionV2 {
    pub fn new() -> RawItemPropertyScaleFunctionV2 {
