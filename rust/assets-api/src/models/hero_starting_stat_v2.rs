...
pub struct HeroStartingStatV2 {
    #[serde(rename = "value")]
    pub value: Box<models::Value>,
    #[serde(rename = "display_stat_name")]
    pub display_stat_name: String,
}

impl HeroStartingStatV2 {
    pub fn new(value: models::Value, display_stat_name: String) -> HeroStartingStatV2 {
        HeroStartingStatV2 {
            value: Box::new(value),
            display_stat_name,
        }
