...
pub struct AbilityV2 {
    ...
    pub tooltip_details: Option<Option<Box<models::AbilityTooltipDetailsV2>>>,
...
impl AbilityV2 {
    pub fn new(id: i32, class_name: String, name: String, description: models::AbilityDescriptionV2) -> AbilityV2 {
        AbilityV2 {
            id,
            class_name,
            name,
