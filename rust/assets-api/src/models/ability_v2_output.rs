...
pub struct AbilityV2Output {
    ...
    pub properties: Option<Option<std::collections::HashMap<String, models::ItemPropertyV2Output>>>,
    ...
    pub tooltip_details: Option<Option<Box<models::AbilityTooltipDetailsV2Output>>>,
    #[serde(rename = "upgrades", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub upgrades: Option<Option<Vec<models::RawAbilityUpgradeV2Output>>>,
...
impl AbilityV2Output {
    pub fn new(id: i32, class_name: String, name: String, description: models::AbilityDescriptionV2) -> AbilityV2Output {
        AbilityV2Output {
            id,
            class_name,
            name,
