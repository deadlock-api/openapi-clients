...
pub struct RawAbilityUpgradePropertyUpgradeV2Output {
    #[serde(rename = "name")]
    pub name: String,
    #[serde(rename = "bonus")]
...
impl RawAbilityUpgradePropertyUpgradeV2Output {
    pub fn new(name: String, bonus: models::Bonus) -> RawAbilityUpgradePropertyUpgradeV2Output {
