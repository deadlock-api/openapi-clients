...
pub struct PickupDefinition {
    ...
    pub pickup_name: Option<Option<String>>,
    #[serde(rename = "pickup_weight", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub pickup_weight: Option<Option<f64>>,
}
