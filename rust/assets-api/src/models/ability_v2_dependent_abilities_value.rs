...
pub struct AbilityV2DependentAbilitiesValue {
    #[serde(rename = "flags", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub flags: Option<Option<Vec<String>>>,
}

impl AbilityV2DependentAbilitiesValue {
    pub fn new() -> AbilityV2DependentAbilitiesValue {
