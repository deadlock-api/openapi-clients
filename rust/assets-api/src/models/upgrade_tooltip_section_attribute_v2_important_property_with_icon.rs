...
pub struct UpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon {
    ...
    #[serde(rename = "localized_name", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub localized_name: Option<Option<String>>,
}

impl UpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon {
    pub fn new() -> UpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon {
