...
pub struct UpgradePropertyV2 {
    ...
    pub scale_function: Option<Option<Box<models::RawItemPropertyScaleFunctionSubclassV2>>>,
...
impl UpgradePropertyV2 {
    pub fn new() -> UpgradePropertyV2 {
        UpgradePropertyV2 {
            value: None,
