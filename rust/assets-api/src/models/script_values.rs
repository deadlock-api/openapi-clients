...
pub struct ScriptValues {
    #[serde(rename = "modifier_value", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub modifier_value: Option<Option<String>>,
    #[serde(rename = "value", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub value: Option<Option<f64>>,
}

impl ScriptValues {
    pub fn new() -> ScriptValues {
        ScriptValues {
            modifier_value: None,
            value: None,
        }
