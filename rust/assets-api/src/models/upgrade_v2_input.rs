...
pub struct UpgradeV2Input {
    ...
    pub properties: Option<Option<std::collections::HashMap<String, models::UpgradePropertyV2Input>>>,
    ...
    pub tooltip_sections: Option<Option<Vec<models::UpgradeTooltipSectionV2Input>>>,
}

impl UpgradeV2Input {
    pub fn new(id: i32, class_name: String, name: String, item_slot_type: models::ItemSlotTypeV2, item_tier: models::ItemTierV2, activation: models::RawAbilityActivationV2) -> UpgradeV2Input {
        UpgradeV2Input {
            id,
            class_name,
            name,
