...
pub struct AbilityDescriptionV2 {
    ...
    #[serde(rename = "quip", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub quip: Option<Option<String>>,
    #[serde(rename = "t1_desc", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub t1_desc: Option<Option<String>>,
    #[serde(rename = "t2_desc", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub t2_desc: Option<Option<String>>,
    #[serde(rename = "t3_desc", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub t3_desc: Option<Option<String>>,
    ...
    pub passive: Option<Option<String>>,
}

impl AbilityDescriptionV2 {
    pub fn new() -> AbilityDescriptionV2 {
