...
pub struct DraftBucket {
    #[serde(rename = "normal", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub normal: Option<Option<f64>>,
    #[serde(rename = "good", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub good: Option<Option<f64>>,
}

impl DraftBucket {
    pub fn new() -> DraftBucket {
        DraftBucket {
            normal: None,
            good: None,
        }
