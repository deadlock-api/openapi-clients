# Rust API client for deadlock-api-client
...
Put the package under your project folder in a directory named `deadlock-api-client` and add the following to `Cargo.toml` under `[dependencies]`:

```
deadlock-api-client = { path = "./deadlock-api-client" }
```
...
*MmrApi* | [**hero_mmr**](docs/MmrApi.md#hero_mmr) | **GET** /v1/players/mmr/{hero_id} | Hero MMR
