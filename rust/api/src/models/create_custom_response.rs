...
pub struct CreateCustomResponse {
    ...
    #[serde(rename = "callback_secret", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub callback_secret: Option<Option<String>>,
...
impl CreateCustomResponse {
    pub fn new(party_code: String, party_id: String) -> CreateCustomResponse {
