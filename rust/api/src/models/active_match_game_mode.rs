...
pub enum ActiveMatchGameMode {
    #[serde(rename = "KECitadelGameModeInvalid")]
    KeCitadelGameModeInvalid,
    #[serde(rename = "KECitadelGameModeNormal")]
    KeCitadelGameModeNormal,
    #[serde(rename = "KECitadelGameMode1v1Test")]
...
impl Default for ActiveMatchGameMode {
    fn default() -> ActiveMatchGameMode {
        Self::KeCitadelGameModeInvalid
    }
}
