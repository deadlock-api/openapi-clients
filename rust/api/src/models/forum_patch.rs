...
impl ForumPatch {
    pub fn new(category: models::PatchCategory, content: String, guid: models::PatchGuid, link: String, pub_date: chrono::DateTime<chrono::FixedOffset>, title: String) -> ForumPatch {
        ForumPatch {
