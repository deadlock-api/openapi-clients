...
pub async fn list_client_versions(configuration: &configuration::Configuration) -> Result<Vec<u32>, Error<ListClientVersionsError>> {

    let uri_str = format!("{}/v1/assets/client-versions", configuration.base_path);
