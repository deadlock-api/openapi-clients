...
impl ItemFlowSummary {
    /// Population-level totals for the (optionally locked) build path.
    pub fn new(avg_duration_s: f64, avg_net_worth: f64, losses: u64, matches: u64, players: u64, total_assists: u64, total_deaths: u64, total_kills: u64, wins: u64) -> ItemFlowSummary {
        ItemFlowSummary {
            avg_duration_s,
            avg_net_worth,
            losses,
