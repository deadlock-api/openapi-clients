...
pub struct SubclassIntrinsicModifiers {
    #[serde(rename = "subclass")]
    pub subclass: Box<models::SubclassIntrinsicModifiersSubclass>,
}

impl SubclassIntrinsicModifiers {
    /// Serializes back as `{\"subclass\": ...}` to preserve the KV3 wrapper shape in JSON output.
    pub fn new(subclass: models::SubclassIntrinsicModifiersSubclass) -> SubclassIntrinsicModifiers {
