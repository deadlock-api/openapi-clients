...
pub struct SteamAccountListItem {
    ...
    #[serde(rename = "id")]
    pub id: uuid::Uuid,
    #[serde(rename = "is_in_cooldown")]
    pub is_in_cooldown: bool,
    #[serde(rename = "steam_id3")]
    pub steam_id3: i64,
}

impl SteamAccountListItem {
    /// Response for a Steam account in the list endpoint (includes `is_in_cooldown`)
    pub fn new(created_at: chrono::DateTime<chrono::FixedOffset>, id: uuid::Uuid, is_in_cooldown: bool, steam_id3: i64) -> SteamAccountListItem {
