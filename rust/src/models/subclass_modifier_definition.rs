...
pub struct SubclassModifierDefinition {
    #[serde(rename = "subclass")]
    pub subclass: Box<models::SubclassModifierDefinitionSubclass>,
}

impl SubclassModifierDefinition {
    /// Serializes back as `{\"subclass\": ...}` to preserve the KV3 wrapper shape in JSON output.
    pub fn new(subclass: models::SubclassModifierDefinitionSubclass) -> SubclassModifierDefinition {
