...
pub struct DamageFlash {
    ...
    pub melee_damage: Box<models::FlashData>,
    #[serde(rename = "tech_damage")]
    pub tech_damage: Box<models::FlashData>,
}

impl DamageFlash {
    pub fn new(bullet_damage: models::FlashData, crit_damage: models::FlashData, healing_damage: models::FlashData, melee_damage: models::FlashData, tech_damage: models::FlashData) -> DamageFlash {
        DamageFlash {
