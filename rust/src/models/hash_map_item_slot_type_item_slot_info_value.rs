...
pub struct HashMapItemSlotTypeItemSlotInfoValue {
    #[serde(rename = "max_purchases_for_tier")]
    pub max_purchases_for_tier: Vec<i64>,
}

impl HashMapItemSlotTypeItemSlotInfoValue {
    pub fn new(max_purchases_for_tier: Vec<i64>) -> HashMapItemSlotTypeItemSlotInfoValue {
