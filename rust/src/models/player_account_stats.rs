...
pub struct PlayerAccountStats {
    #[serde(rename = "account_id")]
    pub account_id: u32,
    #[serde(rename = "stats")]
    pub stats: Vec<models::PlayerAccountHeroStats>,
}

impl PlayerAccountStats {
    pub fn new(account_id: u32, stats: Vec<models::PlayerAccountHeroStats>) -> PlayerAccountStats {
        PlayerAccountStats {
            account_id,
            stats,
        }
