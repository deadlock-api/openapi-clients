...
pub struct RawAbilityUpgrade {
    #[serde(rename = "property_upgrades", skip_serializing_if = "Option::is_none")]
    pub property_upgrades: Option<Vec<models::RawAbilityUpgradePropertyUpgrade>>,
}

impl RawAbilityUpgrade {
    pub fn new() -> RawAbilityUpgrade {
        RawAbilityUpgrade {
