...
pub struct HashMapItemSlotTypeVecPurchaseBonusValueInner {
    #[serde(rename = "tier")]
    pub tier: i64,
    #[serde(rename = "value")]
    pub value: String,
...
impl HashMapItemSlotTypeVecPurchaseBonusValueInner {
    pub fn new(tier: i64, value: String, value_type: String) -> HashMapItemSlotTypeVecPurchaseBonusValueInner {
