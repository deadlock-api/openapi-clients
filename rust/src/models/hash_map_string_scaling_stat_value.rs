...
pub struct HashMapStringScalingStatValue {
    #[serde(rename = "scale")]
    pub scale: f64,
    #[serde(rename = "scaling_stat")]
    pub scaling_stat: String,
}

impl HashMapStringScalingStatValue {
    pub fn new(scale: f64, scaling_stat: String) -> HashMapStringScalingStatValue {
