...
pub struct HeroStatsUi {
    #[serde(rename = "display_stats")]
    pub display_stats: Vec<models::HeroStatsUiDisplay>,
    #[serde(rename = "weapon_stat_display")]
    pub weapon_stat_display: String,
}

impl HeroStatsUi {
    pub fn new(display_stats: Vec<models::HeroStatsUiDisplay>, weapon_stat_display: String) -> HeroStatsUi {
        HeroStatsUi {
            display_stats,
            weapon_stat_display,
        }
