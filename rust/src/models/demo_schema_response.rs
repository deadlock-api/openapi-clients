...
pub struct DemoSchemaResponse {
    #[serde(rename = "demo_url")]
    pub demo_url: String,
    #[serde(rename = "match_id")]
    pub match_id: u64,
    #[serde(rename = "tables")]
    pub tables: Vec<models::TableSchemaResponse>,
}

impl DemoSchemaResponse {
    pub fn new(demo_url: String, match_id: u64, tables: Vec<models::TableSchemaResponse>) -> DemoSchemaResponse {
        DemoSchemaResponse {
            demo_url,
            match_id,
            tables,
