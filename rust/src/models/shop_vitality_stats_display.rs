...
pub struct ShopVitalityStatsDisplay {
...
impl ShopVitalityStatsDisplay {
    pub fn new(display_stats: Vec<String>, other_display_stats: Vec<String>) -> ShopVitalityStatsDisplay {
