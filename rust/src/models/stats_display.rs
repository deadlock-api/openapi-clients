...
impl StatsDisplay {
    pub fn new(health_header_stats: Vec<String>, health_stats: Vec<String>, magic_header_stats: Vec<String>, magic_stats: Vec<String>, weapon_header_stats: Vec<String>, weapon_stats: Vec<String>) -> StatsDisplay {
        StatsDisplay {
            health_header_stats,
            health_stats,
            magic_header_stats,
