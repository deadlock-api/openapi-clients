...
impl FeedItemOneOf {
    pub fn new(category: models::PatchCategory, content: String, guid: models::PatchGuid, link: String, pub_date: chrono::DateTime<chrono::FixedOffset>, title: String, source: Source) -> FeedItemOneOf {
        FeedItemOneOf {
