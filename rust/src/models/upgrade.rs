...
pub struct Upgrade {
    ...
    pub activation: models::AbilityActivation,
    ...
    pub imbue: Option<Option<models::AbilityImbue>>,
    #[serde(rename = "is_active_item")]
    pub is_active_item: bool,
    #[serde(rename = "item_slot_type")]
    pub item_slot_type: models::ItemSlotType,
    ...
    pub tooltip_sections: Option<Option<Vec<models::UpgradeTooltipSection>>>,
    #[serde(rename = "type")]
...
impl Upgrade {
    pub fn new(activation: models::AbilityActivation, class_name: String, id: u32, is_active_item: bool, item_slot_type: models::ItemSlotType, item_tier: u32, name: String, shopable: bool, r#type: models::ItemType) -> Upgrade {
        Upgrade {
            activation,
            class_name,
