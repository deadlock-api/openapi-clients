...
pub enum StatsUsageFlag {
    #[serde(rename = "ConditionallyApplied")]
    ConditionallyApplied,
    #[serde(rename = "ConditionallyEnemyApplied")]
    ConditionallyEnemyApplied,
    #[serde(rename = "IntrinsicallyProvidedInAbility")]
    IntrinsicallyProvidedInAbility,
    #[serde(rename = "IntrinsicallyProvidedInModifier")]
    IntrinsicallyProvidedInModifier,

}

impl std::fmt::Display for StatsUsageFlag {
...
impl Default for StatsUsageFlag {
    fn default() -> StatsUsageFlag {
        Self::ConditionallyApplied
    }
}
