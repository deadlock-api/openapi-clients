...
pub struct Accolade {
    ...
    pub enabled_game_modes: Option<Option<Vec<String>>>,
...
impl Accolade {
    pub fn new(class_name: String, description: String, flavor_name: String, id: u32, threshold_type: String, tracked_stat_name: String) -> Accolade {
        Accolade {
            class_name,
            description,
