...
pub struct SubclassIntrinsicModifiersSubclass {
    #[serde(rename = "script_values", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub script_values: Option<Option<Vec<models::ScriptValues>>>,
}

impl SubclassIntrinsicModifiersSubclass {
    pub fn new() -> SubclassIntrinsicModifiersSubclass {
