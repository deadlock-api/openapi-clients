...
pub struct HashMapItemSlotTypeVecMapModCostBonusValueInner {
    #[serde(rename = "bonus")]
    pub bonus: f64,
    #[serde(rename = "gold_threshold")]
    pub gold_threshold: i64,
    #[serde(rename = "percent_on_graph")]
    pub percent_on_graph: f64,
}

impl HashMapItemSlotTypeVecMapModCostBonusValueInner {
    pub fn new(bonus: f64, gold_threshold: i64, percent_on_graph: f64) -> HashMapItemSlotTypeVecMapModCostBonusValueInner {
