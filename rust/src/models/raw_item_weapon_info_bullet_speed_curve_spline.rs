...
pub struct RawItemWeaponInfoBulletSpeedCurveSpline {
...
impl RawItemWeaponInfoBulletSpeedCurveSpline {
    pub fn new(slope_incoming: f64, slope_outgoing: f64, x: f64, y: f64) -> RawItemWeaponInfoBulletSpeedCurveSpline {
