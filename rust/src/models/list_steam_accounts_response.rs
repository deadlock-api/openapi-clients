...
pub struct ListSteamAccountsResponse {
    #[serde(rename = "accounts")]
    pub accounts: Vec<models::SteamAccountListItem>,
    #[serde(rename = "summary")]
    pub summary: Box<models::SlotsSummary>,
}

impl ListSteamAccountsResponse {
    /// Response for listing Steam accounts
    pub fn new(accounts: Vec<models::SteamAccountListItem>, summary: models::SlotsSummary) -> ListSteamAccountsResponse {
