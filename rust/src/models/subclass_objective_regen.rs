...
pub struct SubclassObjectiveRegen {
    #[serde(rename = "subclass")]
    pub subclass: Box<models::SubclassObjectiveRegenSubclass>,
}

impl SubclassObjectiveRegen {
    /// Serializes back as `{\"subclass\": ...}` to preserve the KV3 wrapper shape in JSON output.
    pub fn new(subclass: models::SubclassObjectiveRegenSubclass) -> SubclassObjectiveRegen {
