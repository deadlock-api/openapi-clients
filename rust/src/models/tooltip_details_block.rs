...
pub struct TooltipDetailsBlock {
    ...
    pub properties: Option<Option<Vec<models::TooltipDetailsBlockProperty>>>,
}

impl TooltipDetailsBlock {
    pub fn new() -> TooltipDetailsBlock {
        TooltipDetailsBlock {
            loc_string: None,
            properties: None,
        }
