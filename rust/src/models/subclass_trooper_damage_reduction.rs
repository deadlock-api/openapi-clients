...
pub struct SubclassTrooperDamageReduction {
    #[serde(rename = "subclass")]
    pub subclass: Box<models::SubclassTrooperDamageReductionSubclass>,
}

impl SubclassTrooperDamageReduction {
    /// Serializes back as `{\"subclass\": ...}` to preserve the KV3 wrapper shape in JSON output.
    pub fn new(subclass: models::SubclassTrooperDamageReductionSubclass) -> SubclassTrooperDamageReduction {
