...
impl GlitchSettings {
    pub fn new(breakup_strength: f64, distort_strength: f64, frame_rate: f64, jump_strength: f64, quantize_scale: f64, quantize_strength: f64, scanline_strength: f64, speed: f64, strength: f64, uantize_type: f64, white_noise_strength: f64) -> GlitchSettings {
        GlitchSettings {
            breakup_strength,
            distort_strength,
            frame_rate,
