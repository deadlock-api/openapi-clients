...
pub struct RawItemWeaponInfoInner {
    #[serde(rename = "m_BulletSpeedCurve", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub m_bullet_speed_curve: Option<Option<Box<models::RawItemWeaponInfoBulletSpeedCurve>>>,
}

impl RawItemWeaponInfoInner {
    pub fn new() -> RawItemWeaponInfoInner {
