...
pub struct SubclassBulletResistModifier {
    #[serde(rename = "subclass")]
    pub subclass: Box<models::SubclassBulletResistModifierSubclass>,
}

impl SubclassBulletResistModifier {
    /// Serializes back as `{\"subclass\": ...}` to preserve the KV3 wrapper shape in JSON output.
    pub fn new(subclass: models::SubclassBulletResistModifierSubclass) -> SubclassBulletResistModifier {
