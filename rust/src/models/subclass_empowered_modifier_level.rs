...
pub struct SubclassEmpoweredModifierLevel {
    #[serde(rename = "subclass")]
    pub subclass: Box<models::SubclassEmpoweredModifierLevelSubclass>,
}

impl SubclassEmpoweredModifierLevel {
    /// Serializes back as `{\"subclass\": ...}` to preserve the KV3 wrapper shape in JSON output.
    pub fn new(subclass: models::SubclassEmpoweredModifierLevelSubclass) -> SubclassEmpoweredModifierLevel {
