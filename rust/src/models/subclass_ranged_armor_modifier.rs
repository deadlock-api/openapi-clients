...
pub struct SubclassRangedArmorModifier {
    #[serde(rename = "subclass")]
    pub subclass: Box<models::SubclassRangedArmorModifierSubclass>,
}

impl SubclassRangedArmorModifier {
    /// Serializes back as `{\"subclass\": ...}` to preserve the KV3 wrapper shape in JSON output.
    pub fn new(subclass: models::SubclassRangedArmorModifierSubclass) -> SubclassRangedArmorModifier {
