...
// tests for HeroCombStats
void main() {
  // final instance = HeroCombStats();

  group('test HeroCombStats', () {
    // See more: <https://assets.deadlock-api.com/v2/heroes>
    // List<int> heroIds (default value: const [])
    test('to test the property `heroIds`', () async {
      // TODO
    });
