...
void main() {
  ...
  group('tests for DefaultApi', () {
    // Get Build Tags
    //
    //Future<List<BuildTagV2Output>> getBuildTagsV2BuildTagsGet({ Language language, DeadlockAssetsApiRoutesRawValidClientVersions clientVersion }) async
    ...
    // Get Ranks
    //
    //Future<List<RankV2Output>> getRanksV2RanksGet({ Language language, DeadlockAssetsApiRoutesRawValidClientVersions clientVersion }) async
