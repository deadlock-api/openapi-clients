...
class TestServerStatusRequest(unittest.TestCase):
    """ServerStatusRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerStatusRequest:
    ...
    def testServerStatusRequest(self):
        """Test ServerStatusRequest"""
