...
class TestCommandsApi(unittest.TestCase):
    ...
    def test_available_variables(self) -> None:
        """Test case for available_variables

        Available Variables
        """
        pass

    def test_command_resolve(self) -> None:
        """Test case for command_resolve

        Resolve Command
        """
        pass

    def test_variables_resolve(self) -> None:
        """Test case for variables_resolve

        Resolve Variables
        """
        pass

    def test_widget_versions(self) -> None:
        """Test case for widget_versions
