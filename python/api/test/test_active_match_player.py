...
class TestActiveMatchPlayer(unittest.TestCase):
    """ActiveMatchPlayer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActiveMatchPlayer:
    ...
    def testActiveMatchPlayer(self):
        """Test ActiveMatchPlayer"""
