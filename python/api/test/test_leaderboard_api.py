...
class TestLeaderboardApi(unittest.TestCase):
    ...
    def test_leaderboard_hero(self) -> None:
        """Test case for leaderboard_hero

        Hero Leaderboard
        """
        pass

    def test_leaderboard_hero_raw(self) -> None:
        """Test case for leaderboard_hero_raw

        Hero Leaderboard as Protobuf
        """
        pass

    def test_leaderboard_raw(self) -> None:
        """Test case for leaderboard_raw
