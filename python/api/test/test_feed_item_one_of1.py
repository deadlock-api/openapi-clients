...
class TestFeedItemOneOf1(unittest.TestCase):
    """FeedItemOneOf1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedItemOneOf1:
        """Test FeedItemOneOf1
        ...
        """
        model = FeedItemOneOf1()
        if include_optional:
            return FeedItemOneOf1(
                content = '',
