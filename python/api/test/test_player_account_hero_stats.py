...
class TestPlayerAccountHeroStats(unittest.TestCase):
    """PlayerAccountHeroStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlayerAccountHeroStats:
        ...
        """
        model = PlayerAccountHeroStats()
        if include_optional:
            return PlayerAccountHeroStats(
                hero_id = 0,
                medals_bronze = [
                    0
                    ],
    ...
    def testPlayerAccountHeroStats(self):
        """Test PlayerAccountHeroStats"""
