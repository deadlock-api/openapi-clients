...
class TestMetricIngestRequest(unittest.TestCase):
    """MetricIngestRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MetricIngestRequest:
        """Test MetricIngestRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MetricIngestRequest`
        """
        model = MetricIngestRequest()
        if include_optional:
    ...
    def testMetricIngestRequest(self):
        """Test MetricIngestRequest"""
