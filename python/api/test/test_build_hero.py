...
class TestBuildHero(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BuildHero:
        """Test BuildHero
        ...
        if include_optional:
            return BuildHero(
                author_account_id = 0,
                description = '',
                details = openapi_client.models.build_hero_details.BuildHeroDetails(
                ...
                hero_id = 0,
                language = 0,
                last_updated_timestamp = 56,
                name = '',
                origin_build_id = 0,
                publish_timestamp = 56,
                tags = [
                    0
                    ],
                version = 0
