...
class TestCreateCustomRequest(unittest.TestCase):
    """CreateCustomRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCustomRequest:
    ...
    def testCreateCustomRequest(self):
        """Test CreateCustomRequest"""
