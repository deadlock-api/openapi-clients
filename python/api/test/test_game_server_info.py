...
class TestGameServerInfo(unittest.TestCase):
    """GameServerInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GameServerInfo:
        """Test GameServerInfo
