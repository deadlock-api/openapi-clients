...
class TestBuildHeroDetailsCategory(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BuildHeroDetailsCategory:
        ...
        """
        model = BuildHeroDetailsCategory()
        if include_optional:
            return BuildHeroDetailsCategory(
                description = '',
                height = 1.337,
                mods = [
    ...
    def testBuildHeroDetailsCategory(self):
        """Test BuildHeroDetailsCategory"""
