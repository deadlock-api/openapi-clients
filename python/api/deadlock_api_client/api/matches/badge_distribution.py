...
from ...models.badge_distribution import BadgeDistribution
...
) -> Optional[Union[Any, list["BadgeDistribution"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = BadgeDistribution.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["BadgeDistribution"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[Any, list['BadgeDistribution']]
    """
