...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/players/{account_id}/steam",
    }
...
) -> Optional[Union[Any, SteamProfile]]:
    if response.status_code == 200:
        response_200 = SteamProfile.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, SteamProfile]]:
    return Response(
