...
from ...models.mate_stats import MateStats
...
def _get_kwargs(
    ...
    *,
    ...
    same_party: Union[Unset, bool] = True,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    params["same_party"] = same_party

    params = {k: v for k, v in params.items() if v is not UNSET and v is not None}

    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/players/{account_id}/mate-stats",
        "params": params,
    }
...
) -> Optional[Union[Any, list["MateStats"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = MateStats.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["MateStats"]]]:
    return Response(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        ...
        same_party (Union[Unset, bool]):  Default: True.
