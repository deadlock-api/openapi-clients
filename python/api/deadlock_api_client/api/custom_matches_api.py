...
class CustomMatchesApi:
    ...
    @validate_call
    def leave_without_preload_content(
        self,
        lobby_id: StrictStr,
        _request_timeout: Union[
            None,
    ...
    def _leave_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/matches/custom/{lobby_id}/leave',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _start_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/matches/custom/{lobby_id}/start',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
