...
class ServersApi:
    ...
    def ingest(
        self,
        metric_ingest_request: MetricIngestRequest,
        ...
        :param metric_ingest_request: (required)
        :type metric_ingest_request: MetricIngestRequest
        ...
        _param = self._ingest_serialize(
            metric_ingest_request=metric_ingest_request,
    ...
    def _ingest_serialize(
        ...
        if metric_ingest_request is not None:
            _body_params = metric_ingest_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/servers/metrics',
    ...
    def status(
        self,
        server_status_request: ServerStatusRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param server_status_request: (required)
        :type server_status_request: ServerStatusRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _status_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if server_status_request is not None:
            _body_params = server_status_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/servers/status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def steam_list(
        ...
        _param = self._steam_list_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def steam_list_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _steam_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/servers/steam',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
