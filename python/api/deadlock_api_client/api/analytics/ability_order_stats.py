...
from ...models.analytics_ability_order_stats import AnalyticsAbilityOrderStats
...
def _get_kwargs(
    *,
    ...
    min_ability_upgrades: Union[None, Unset, int] = UNSET,
    max_ability_upgrades: Union[None, Unset, int] = UNSET,
    ...
    json_min_ability_upgrades: Union[None, Unset, int]
    if isinstance(min_ability_upgrades, Unset):
        json_min_ability_upgrades = UNSET
    else:
        json_min_ability_upgrades = min_ability_upgrades
    params["min_ability_upgrades"] = json_min_ability_upgrades

    json_max_ability_upgrades: Union[None, Unset, int]
    if isinstance(max_ability_upgrades, Unset):
        json_max_ability_upgrades = UNSET
    else:
        json_max_ability_upgrades = max_ability_upgrades
    params["max_ability_upgrades"] = json_max_ability_upgrades
...
) -> Optional[Union[Any, list["AnalyticsAbilityOrderStats"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AnalyticsAbilityOrderStats.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["AnalyticsAbilityOrderStats"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        ...
        min_ability_upgrades (Union[None, Unset, int]):
        max_ability_upgrades (Union[None, Unset, int]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, list['AnalyticsAbilityOrderStats']]
    """
