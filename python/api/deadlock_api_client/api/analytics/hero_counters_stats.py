...
from ...models.hero_counter_stats import HeroCounterStats
...
def _get_kwargs(
    *,
    ...
    min_enemy_networth: Union[None, Unset, int] = UNSET,
    max_enemy_networth: Union[None, Unset, int] = UNSET,
    ...
    json_min_enemy_networth: Union[None, Unset, int]
    if isinstance(min_enemy_networth, Unset):
        json_min_enemy_networth = UNSET
    else:
        json_min_enemy_networth = min_enemy_networth
    params["min_enemy_networth"] = json_min_enemy_networth

    json_max_enemy_networth: Union[None, Unset, int]
    if isinstance(max_enemy_networth, Unset):
        json_max_enemy_networth = UNSET
    else:
        json_max_enemy_networth = max_enemy_networth
    params["max_enemy_networth"] = json_max_enemy_networth
...
) -> Optional[Union[Any, list["HeroCounterStats"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = HeroCounterStats.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["HeroCounterStats"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    This endpoint analyzes completed matches to calculate how often a specific hero (`hero_id`) wins
    against an enemy hero (`enemy_hero_id`) and the total number of times they have faced each other
    ...
    Args:
        ...
        min_enemy_networth (Union[None, Unset, int]):
        max_enemy_networth (Union[None, Unset, int]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, list['HeroCounterStats']]
    """
