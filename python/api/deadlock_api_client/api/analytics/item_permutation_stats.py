...
from ...models.item_permutation_stats import ItemPermutationStats
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    item_ids: Union[None, Unset, list[int]] = UNSET,
    comb_size: Union[None, Unset, int] = 2,
    ...
    json_item_ids: Union[None, Unset, list[int]]
...
) -> Optional[Union[Any, list["ItemPermutationStats"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = ItemPermutationStats.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["ItemPermutationStats"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        item_ids (Union[None, Unset, list[int]]):
        comb_size (Union[None, Unset, int]):  Default: 2.
...
def sync(
    *,
    ...
    Returns:
        Union[Any, list['ItemPermutationStats']]
    """
