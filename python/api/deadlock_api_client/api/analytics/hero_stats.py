...
from ...models.analytics_hero_stats import AnalyticsHeroStats
from ...models.hero_stats_bucket import HeroStatsBucket
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    bucket: Union[Unset, HeroStatsBucket] = UNSET,
    ...
    min_hero_matches: Union[None, Unset, int] = UNSET,
    max_hero_matches: Union[None, Unset, int] = UNSET,
    ...
    json_min_hero_matches: Union[None, Unset, int]
    if isinstance(min_hero_matches, Unset):
        json_min_hero_matches = UNSET
    else:
        json_min_hero_matches = min_hero_matches
    params["min_hero_matches"] = json_min_hero_matches

    json_max_hero_matches: Union[None, Unset, int]
    if isinstance(max_hero_matches, Unset):
        json_max_hero_matches = UNSET
    else:
        json_max_hero_matches = max_hero_matches
    params["max_hero_matches"] = json_max_hero_matches
...
) -> Optional[Union[Any, list["AnalyticsHeroStats"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = AnalyticsHeroStats.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["AnalyticsHeroStats"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Args:
        bucket (Union[Unset, HeroStatsBucket]):
        ...
        min_hero_matches (Union[None, Unset, int]):
        max_hero_matches (Union[None, Unset, int]):
...
def sync(
    *,
    ...
    Returns:
        Union[Any, list['AnalyticsHeroStats']]
    """
