...
from ...models.hero_comb_stats import HeroCombStats
...
def _get_kwargs(
    *,
    ...
    include_hero_ids: Union[None, Unset, list[int]] = UNSET,
    exclude_hero_ids: Union[None, Unset, list[int]] = UNSET,
    min_matches: Union[None, Unset, int] = 20,
    max_matches: Union[None, Unset, int] = UNSET,
    comb_size: Union[None, Unset, int] = 6,
    ...
    json_include_hero_ids: Union[None, Unset, list[int]]
    if isinstance(include_hero_ids, Unset):
        json_include_hero_ids = UNSET
    elif isinstance(include_hero_ids, list):
        json_include_hero_ids = include_hero_ids

    else:
        json_include_hero_ids = include_hero_ids
    params["include_hero_ids"] = json_include_hero_ids

    json_exclude_hero_ids: Union[None, Unset, list[int]]
    if isinstance(exclude_hero_ids, Unset):
        json_exclude_hero_ids = UNSET
    elif isinstance(exclude_hero_ids, list):
        json_exclude_hero_ids = exclude_hero_ids

    else:
        json_exclude_hero_ids = exclude_hero_ids
    params["exclude_hero_ids"] = json_exclude_hero_ids
    ...
    json_comb_size: Union[None, Unset, int]
    if isinstance(comb_size, Unset):
        json_comb_size = UNSET
    else:
        json_comb_size = comb_size
    params["comb_size"] = json_comb_size
...
) -> Optional[Union[Any, list["HeroCombStats"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = HeroCombStats.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[Any, list["HeroCombStats"]]]:
    return Response(
...
def sync_detailed(
    *,
    ...
    Results are cached for **1 hour**. The cache key is determined by the specific combination of filter
    parameters used in the query. Subsequent requests using the exact same filters within this timeframe
    ...
    Args:
        ...
        include_hero_ids (Union[None, Unset, list[int]]):
        exclude_hero_ids (Union[None, Unset, list[int]]):
        min_matches (Union[None, Unset, int]):  Default: 20.
        max_matches (Union[None, Unset, int]):
        comb_size (Union[None, Unset, int]):  Default: 6.
