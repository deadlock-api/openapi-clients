...
from ...models.player_scoreboard_sort_by import PlayerScoreboardSortBy
from ...models.player_scoreboard_sort_direction import PlayerScoreboardSortDirection
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    sort_by: PlayerScoreboardSortBy,
    sort_direction: Union[Unset, PlayerScoreboardSortDirection] = UNSET,
    ...
    json_start: Union[None, Unset, int]
...
def sync_detailed(
    *,
    ...
    Args:
        sort_by (PlayerScoreboardSortBy):
        sort_direction (Union[Unset, PlayerScoreboardSortDirection]):
