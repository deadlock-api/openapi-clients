...
class Status(BaseModel):
    ...
    Status
    """ # noqa: E501
    services: StatusServices = Field(description="Status of the services.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "services": StatusServices.from_dict(obj["services"]) if obj.get("services") is not None else None
        })
        return _obj
