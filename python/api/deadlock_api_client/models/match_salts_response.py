...
class MatchSaltsResponse(BaseModel):
    """
    MatchSaltsResponse
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["cluster_id", "demo_url", "match_id", "metadata_salt", "metadata_url", "replay_salt"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if demo_url (nullable) is None
        # and model_fields_set contains the field
        if self.demo_url is None and "demo_url" in self.model_fields_set:
            _dict['demo_url'] = None

        # set to None if metadata_salt (nullable) is None
        # and model_fields_set contains the field
        if self.metadata_salt is None and "metadata_salt" in self.model_fields_set:
            _dict['metadata_salt'] = None
        ...
        # set to None if replay_salt (nullable) is None
        # and model_fields_set contains the field
