...
class Patch(BaseModel):
    ...
    content_encoded: StrictStr
    dc_creator: StrictStr
    guid: PatchGuid
    link: StrictStr
    pub_date: datetime
    slash_comments: StrictStr
    title: StrictStr
    __properties: ClassVar[List[str]] = ["author", "category", "content_encoded", "dc_creator", "guid", "link", "pub_date", "slash_comments", "title"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of guid
        if self.guid:
            _dict['guid'] = self.guid.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "category": PatchCategory.from_dict(obj["category"]) if obj.get("category") is not None else None,
            "content_encoded": obj.get("content_encoded"),
            "dc_creator": obj.get("dc_creator"),
            "guid": PatchGuid.from_dict(obj["guid"]) if obj.get("guid") is not None else None,
            "link": obj.get("link"),
