...
class BuildHeroDetailsCategory(BaseModel):
    ...
    mods: Optional[List[BuildHeroDetailsCategoryAbility]] = None
    name: StrictStr
    optional: Optional[StrictBool] = None
    width: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["description", "height", "mods", "name", "optional", "width"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mods": [BuildHeroDetailsCategoryAbility.from_dict(_item) for _item in obj["mods"]] if obj.get("mods") is not None else None,
            "name": obj.get("name"),
