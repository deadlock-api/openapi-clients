...
class MMRHistory(BaseModel):
    ...
    rank: Annotated[int, Field(strict=True, ge=0)] = Field(description="The Player Rank (tier = first digits, subtier = last digit). See more: <https://assets.deadlock-api.com/v2/ranks>")
