...
class BuildHeroDetailsAbilityOrder(BaseModel):
    ...
    """ # noqa: E501
    currency_changes: Optional[List[BuildHeroDetailsAbilityOrderCurrencyChange]] = None
    __properties: ClassVar[List[str]] = ["currency_changes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "currency_changes": [BuildHeroDetailsAbilityOrderCurrencyChange.from_dict(_item) for _item in obj["currency_changes"]] if obj.get("currency_changes") is not None else None
        })
        return _obj
