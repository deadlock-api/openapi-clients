...
class CreateCustomResponse(BaseModel):
    """
    CreateCustomResponse
    """ # noqa: E501
    callback_secret: Optional[StrictStr] = Field(default=None, description="If a callback url is provided, this is the secret that should be used to verify the callback. The secret is a base64 encoded random string. To verify it you should compare it with the X-Callback-Secret header. If no callback url is provided, this will be None.")
    party_code: StrictStr
    party_id: StrictStr
    __properties: ClassVar[List[str]] = ["callback_secret", "party_code", "party_id"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if callback_secret (nullable) is None
        # and model_fields_set contains the field
        if self.callback_secret is None and "callback_secret" in self.model_fields_set:
            _dict['callback_secret'] = None
