...
class ServerStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    server_id: StrictStr = Field(description="The server ID that reported status")
    ttl_secs: StrictInt = Field(description="TTL in seconds before this registration expires")
    __properties: ClassVar[List[str]] = ["server_id", "ttl_secs"]
