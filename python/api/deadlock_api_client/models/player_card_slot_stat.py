...
class PlayerCardSlotStat(BaseModel):
    ...
    PlayerCardSlotStat
    """ # noqa: E501
    stat_id: Optional[StrictInt] = None
    stat_score: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    __properties: ClassVar[List[str]] = ["stat_id", "stat_score"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if stat_id (nullable) is None
        # and model_fields_set contains the field
        if self.stat_id is None and "stat_id" in self.model_fields_set:
            _dict['stat_id'] = None

        # set to None if stat_score (nullable) is None
        # and model_fields_set contains the field
        if self.stat_score is None and "stat_score" in self.model_fields_set:
            _dict['stat_score'] = None
