...
class FeedItemOneOf1(BaseModel):
    """
    FeedItemOneOf1
    """ # noqa: E501
    content: StrictStr
    ...
    title: StrictStr
    source: StrictStr
    __properties: ClassVar[List[str]] = ["content", "guid", "link", "pub_date", "title", "source"]

    @field_validator('source')
    def source_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['steam']):
            raise ValueError("must be one of enum values ('steam')")
        return value
