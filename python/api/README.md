# deadlock-api-client
A client library for accessing Deadlock API

## Usage
First, create a client:

```python
from deadlock_api_client import Client
...
```python
from deadlock_api_client import AuthenticatedClient
...
```python
from deadlock_api_client.models import MyDataModel
from deadlock_api_client.api.my_tag import get_my_data_model
from deadlock_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `deadlock_api_client.api.default`
