...
| MAE    | 1.19 sub-ranks |
| RMSE   | 2.06 sub-ranks |
| Within ±1 sub-rank | 74.3% |
| Within ±3 sub-rank | 93.2% |
| Within ±5 sub-rank | 97.4% |
| Within ±6 sub-rank | 98.3% |
| Within ±10 sub-rank | 99.4% |

Accuracy by tier:

| Tier range | n | MAE |
|------------|---|-----|
| Low (1-4)  | 760 | 5.24 sub-ranks |
| Mid (5-7)  | 2065 | 3.02 sub-ranks |
| High (8-11)| 72340 | 1.09 sub-ranks |
