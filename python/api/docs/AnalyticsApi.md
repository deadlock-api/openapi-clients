...
with deadlock-api-client.ApiClient(configuration) as api_client:
    ...
    min_last_updated_unix_timestamp = 1758672000 # int | Filter builds based on their last updated time (Unix timestamp). **Default:** 30 days ago. (optional) (default to 1758672000)
