...
class Leaderboard(BaseModel):
    ...
    Leaderboard
    """ # noqa: E501
    entries: List[LeaderboardEntry] = Field(description="The leaderboard entries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entries": [LeaderboardEntry.from_dict(_item) for _item in obj["entries"]] if obj.get("entries") is not None else None
        })
        return _obj
