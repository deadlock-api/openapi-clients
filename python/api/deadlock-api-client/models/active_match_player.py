...
class ActiveMatchPlayer(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if abandoned (nullable) is None
        # and model_fields_set contains the field
        if self.abandoned is None and "abandoned" in self.model_fields_set:
            _dict['abandoned'] = None
        ...
        # set to None if team_parsed (nullable) is None
        # and model_fields_set contains the field
        if self.team_parsed is None and "team_parsed" in self.model_fields_set:
            _dict['team_parsed'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "team": obj.get("team"),
            "team_parsed": obj.get("team_parsed")
        })
        return _obj
