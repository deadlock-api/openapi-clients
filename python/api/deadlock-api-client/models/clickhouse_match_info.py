...
class ClickhouseMatchInfo(BaseModel):
    """
    ClickhouseMatchInfo
    """ # noqa: E501
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.average_badge_team0 is None and "average_badge_team0" in self.model_fields_set:
            _dict['average_badge_team0'] = None

        # set to None if average_badge_team1 (nullable) is None
        # and model_fields_set contains the field
        if self.average_badge_team1 is None and "average_badge_team1" in self.model_fields_set:
            _dict['average_badge_team1'] = None
