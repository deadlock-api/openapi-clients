...
class PlayersApi:
    ...
    def _steam_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/players/{account_id}/steam',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def steam_batch(
        ...
        _param = self._steam_batch_serialize(
            account_ids=account_ids,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def steam_batch_with_http_info(
        self,
        account_ids: Annotated[List[Annotated[int, Field(strict=True, ge=0)]], Field(min_length=1, max_length=1000, description="Comma separated list of account ids, Account IDs are in `SteamID3` format.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def steam_batch_without_preload_content(
        self,
        account_ids: Annotated[List[Annotated[int, Field(strict=True, ge=0)]], Field(min_length=1, max_length=1000, description="Comma separated list of account ids, Account IDs are in `SteamID3` format.")],
        _request_timeout: Union[
            None,
