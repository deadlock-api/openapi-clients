...
class ItemFlowSummary(BaseModel):
    """
    Population-level totals for the (optionally locked) build path.
    """ # noqa: E501
    avg_duration_s: Union[StrictFloat, StrictInt] = Field(description="Average match duration (seconds) of the population.")
    avg_net_worth: Union[StrictFloat, StrictInt] = Field(description="Average final net worth of the population.")
    ...
    __properties: ClassVar[List[str]] = ["avg_duration_s", "avg_net_worth", "losses", "matches", "players", "total_assists", "total_deaths", "total_kills", "wins"]
