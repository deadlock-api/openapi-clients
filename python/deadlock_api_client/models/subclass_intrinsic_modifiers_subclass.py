...
class SubclassIntrinsicModifiersSubclass(BaseModel):
    """
    SubclassIntrinsicModifiersSubclass
    """ # noqa: E501
    script_values: Optional[List[ScriptValues]] = None
    __properties: ClassVar[List[str]] = ["script_values"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubclassIntrinsicModifiersSubclass from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubclassIntrinsicModifiersSubclass from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "script_values": [ScriptValues.from_dict(_item) for _item in obj["script_values"]] if obj.get("script_values") is not None else None
        })
        return _obj
