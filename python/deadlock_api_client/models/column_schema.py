...
class ColumnSchema(BaseModel):
    ...
    ColumnSchema
    """ # noqa: E501
    data_type: StrictStr = Field(description="Arrow data type, rendered as its canonical textual form (e.g. `Int32`, `Utf8`).")
    name: StrictStr
    nullable: StrictBool
    __properties: ClassVar[List[str]] = ["data_type", "name", "nullable"]
