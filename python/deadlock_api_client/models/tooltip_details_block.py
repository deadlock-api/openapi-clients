...
class TooltipDetailsBlock(BaseModel):
    """
    TooltipDetailsBlock
    """ # noqa: E501
    loc_string: Optional[StrictStr] = None
    properties: Optional[List[TooltipDetailsBlockProperty]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [TooltipDetailsBlockProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
