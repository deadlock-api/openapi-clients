...
class SlotsSummary(BaseModel):
    ...
    """ # noqa: E501
    available_slots: StrictInt
    slots_in_cooldown: StrictInt
    total_slots: StrictInt
    used_slots: StrictInt
    __properties: ClassVar[List[str]] = ["available_slots", "slots_in_cooldown", "total_slots", "used_slots"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "slots_in_cooldown": obj.get("slots_in_cooldown"),
            "total_slots": obj.get("total_slots"),
            "used_slots": obj.get("used_slots")
        })
        return _obj
