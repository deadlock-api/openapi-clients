...
class DemoQueryRequest(BaseModel):
    ...
    DemoQueryRequest
    """ # noqa: E501
    format: Optional[OutputFormat] = Field(default=None, description="Output format of the result artifact.")
    match_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="Match whose demo to query.")
    query: StrictStr = Field(description="SQL query to run over the demo's entity/event tables (see `/demo/schema`).")
    __properties: ClassVar[List[str]] = ["format", "match_id", "query"]
