...
class ListSteamAccountsResponse(BaseModel):
    """
    Response for listing Steam accounts
    """ # noqa: E501
    accounts: List[SteamAccountListItem]
    summary: SlotsSummary
    __properties: ClassVar[List[str]] = ["accounts", "summary"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "accounts": [SteamAccountListItem.from_dict(_item) for _item in obj["accounts"]] if obj.get("accounts") is not None else None,
            "summary": SlotsSummary.from_dict(obj["summary"]) if obj.get("summary") is not None else None
        })
        return _obj
