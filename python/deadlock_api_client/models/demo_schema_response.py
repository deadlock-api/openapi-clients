...
class DemoSchemaResponse(BaseModel):
    """
    DemoSchemaResponse
    """ # noqa: E501
    demo_url: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["demo_url", "match_id", "tables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tables": [TableSchemaResponse.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
        return _obj
