...
class RawItemWeaponInfoBulletSpeedCurveSpline(BaseModel):
    ...
    """ # noqa: E501
    slope_incoming: Union[StrictFloat, StrictInt]
    slope_outgoing: Union[StrictFloat, StrictInt]
    x: Union[StrictFloat, StrictInt]
    y: Union[StrictFloat, StrictInt]
    __properties: ClassVar[List[str]] = ["slope_incoming", "slope_outgoing", "x", "y"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawItemWeaponInfoBulletSpeedCurveSpline from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawItemWeaponInfoBulletSpeedCurveSpline from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "slope_incoming": obj.get("slope_incoming"),
            "slope_outgoing": obj.get("slope_outgoing"),
            "x": obj.get("x"),
            "y": obj.get("y")
        })
        return _obj
