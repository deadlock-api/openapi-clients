...
class FeedItemOneOf(BaseModel):
    ...
    title: StrictStr
    source: StrictStr
    __properties: ClassVar[List[str]] = ["category", "content", "guid", "link", "pub_date", "title", "source"]

    @field_validator('source')
    def source_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['forum']):
            raise ValueError("must be one of enum values ('forum')")
        return value
