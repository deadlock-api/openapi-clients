...
class HashMapStringScalingStatValue(BaseModel):
    """
    HashMapStringScalingStatValue
    """ # noqa: E501
    scale: Union[StrictFloat, StrictInt]
    scaling_stat: StrictStr
    __properties: ClassVar[List[str]] = ["scale", "scaling_stat"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HashMapStringScalingStatValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HashMapStringScalingStatValue from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "scale": obj.get("scale"),
            "scaling_stat": obj.get("scaling_stat")
        })
        return _obj
