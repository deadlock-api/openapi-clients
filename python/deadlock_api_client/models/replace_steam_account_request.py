...
class ReplaceSteamAccountRequest(BaseModel):
    """
    Request body for replacing a Steam account
    """ # noqa: E501
    steam_id3: StrictInt = Field(description="New Steam ID3 (32-bit unsigned integer format)")
    __properties: ClassVar[List[str]] = ["steam_id3"]
