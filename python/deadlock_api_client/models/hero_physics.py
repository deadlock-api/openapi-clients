...
class HeroPhysics(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["collision_height", "collision_radius", "footstep_sound_travel_distance_meters", "stealth_speed_meters_per_second", "step_height", "step_sound_time", "step_sound_time_sprinting"]
