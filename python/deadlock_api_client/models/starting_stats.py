...
class StartingStats(BaseModel):
    ...
    stamina_regen_per_second: StartingStat
    tech_armor_damage_reduction: Optional[StartingStat] = None
    tech_duration: StartingStat
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "stamina": StartingStat.from_dict(obj["stamina"]) if obj.get("stamina") is not None else None,
            "stamina_regen_per_second": StartingStat.from_dict(obj["stamina_regen_per_second"]) if obj.get("stamina_regen_per_second") is not None else None,
            "tech_armor_damage_reduction": StartingStat.from_dict(obj["tech_armor_damage_reduction"]) if obj.get("tech_armor_damage_reduction") is not None else None,
            "tech_duration": StartingStat.from_dict(obj["tech_duration"]) if obj.get("tech_duration") is not None else None,
            "tech_range": StartingStat.from_dict(obj["tech_range"]) if obj.get("tech_range") is not None else None,
            "weapon_power": StartingStat.from_dict(obj["weapon_power"]) if obj.get("weapon_power") is not None else None,
            "weapon_power_scale": StartingStat.from_dict(obj["weapon_power_scale"]) if obj.get("weapon_power_scale") is not None else None
        })
        return _obj
