...
class ShopSpiritStatsDisplay(BaseModel):
    """
    ShopSpiritStatsDisplay
    """ # noqa: E501
    display_stats: List[StrictStr]
    __properties: ClassVar[List[str]] = ["display_stats"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ShopSpiritStatsDisplay from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ShopSpiritStatsDisplay from a dict"""
        if obj is None:
            return None
