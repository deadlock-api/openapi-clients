...
class SteamAccountListItem(BaseModel):
    """
    ...
    id: UUID
    is_in_cooldown: StrictBool
    steam_id3: StrictInt
    __properties: ClassVar[List[str]] = ["created_at", "deleted_at", "id", "is_in_cooldown", "steam_id3"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "is_in_cooldown": obj.get("is_in_cooldown"),
            "steam_id3": obj.get("steam_id3")
        })
        return _obj
