...
class RawItemWeaponInfoInner(BaseModel):
    """
    RawItemWeaponInfoInner
    """ # noqa: E501
    m_bullet_speed_curve: Optional[RawItemWeaponInfoBulletSpeedCurve] = Field(default=None, alias="m_BulletSpeedCurve")
    __properties: ClassVar[List[str]] = ["m_BulletSpeedCurve"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "m_BulletSpeedCurve": RawItemWeaponInfoBulletSpeedCurve.from_dict(obj["m_BulletSpeedCurve"]) if obj.get("m_BulletSpeedCurve") is not None else None
        })
        return _obj
