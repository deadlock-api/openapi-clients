...
class WeaponInfo(BaseModel):
    ...
    WeaponInfo
    """ # noqa: E501
    aiming_shot_spread_penalty: Optional[Any] = None
    ...
    bullet_speed_curve: Optional[RawItemWeaponInfoBulletSpeedCurve] = None
    bullet_whiz_distance: Optional[Union[StrictFloat, StrictInt]] = None
    bullets: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    bullets_per_second: Optional[Union[StrictFloat, StrictInt]] = None
    bullets_per_second_with_reload: Optional[Union[StrictFloat, StrictInt]] = None
    burst_shot_cooldown: Optional[Union[StrictFloat, StrictInt]] = None
    burst_shot_count: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    can_zoom: Optional[StrictBool] = None
    clip_size: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    ...
    damage_per_magazine: Optional[Union[StrictFloat, StrictInt]] = None
    damage_per_second: Optional[Union[StrictFloat, StrictInt]] = None
    damage_per_second_with_reload: Optional[Union[StrictFloat, StrictInt]] = None
    damage_per_shot: Optional[Union[StrictFloat, StrictInt]] = None
    horizontal_punch: Optional[Union[StrictFloat, StrictInt]] = None
    horizontal_recoil: Optional[RawWeaponInfoHorizontalRecoil] = None
    ...
    shots_per_second: Optional[Union[StrictFloat, StrictInt]] = None
    shots_per_second_with_reload: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    standing_shot_spread_penalty: Optional[Any] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "aiming_shot_spread_penalty": obj.get("aiming_shot_spread_penalty"),
            ...
            "bullet_speed_curve": RawItemWeaponInfoBulletSpeedCurve.from_dict(obj["bullet_speed_curve"]) if obj.get("bullet_speed_curve") is not None else None,
            ...
            "horizontal_recoil": RawWeaponInfoHorizontalRecoil.from_dict(obj["horizontal_recoil"]) if obj.get("horizontal_recoil") is not None else None,
            ...
            "standing_shot_spread_penalty": obj.get("standing_shot_spread_penalty"),
            "standing_spread": obj.get("standing_spread"),
            "vertical_punch": obj.get("vertical_punch"),
            "vertical_recoil": RawWeaponInfoVerticalRecoil.from_dict(obj["vertical_recoil"]) if obj.get("vertical_recoil") is not None else None,
