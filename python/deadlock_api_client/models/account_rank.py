...
class AccountRank(BaseModel):
    ...
    account_id: Annotated[int, Field(strict=True, ge=0)] = Field(description="The players `SteamID3`")
    __properties: ClassVar[List[str]] = ["badge", "last_match", "rank", "subrank", "account_id"]
