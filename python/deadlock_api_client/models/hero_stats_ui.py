...
class HeroStatsUI(BaseModel):
    """
    HeroStatsUI
    """ # noqa: E501
    display_stats: List[HeroStatsUIDisplay]
    weapon_stat_display: StrictStr
    __properties: ClassVar[List[str]] = ["display_stats", "weapon_stat_display"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "display_stats": [HeroStatsUIDisplay.from_dict(_item) for _item in obj["display_stats"]] if obj.get("display_stats") is not None else None,
