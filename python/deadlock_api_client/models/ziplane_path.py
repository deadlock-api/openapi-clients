...
class ZiplanePath(BaseModel):
    ...
    """ # noqa: E501
    p0_points: List[List[Union[StrictFloat, StrictInt]]] = Field(alias="P0_points")
    p1_points: List[List[Union[StrictFloat, StrictInt]]] = Field(alias="P1_points")
    p2_points: List[List[Union[StrictFloat, StrictInt]]] = Field(alias="P2_points")
    color: StrictStr
    color_parsed: Color
    origin: List[Union[StrictFloat, StrictInt]]
    __properties: ClassVar[List[str]] = ["P0_points", "P1_points", "P2_points", "color", "color_parsed", "origin"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "color": obj.get("color"),
            "color_parsed": Color.from_dict(obj["color_parsed"]) if obj.get("color_parsed") is not None else None,
