...
class RawItemPropertyScaleFunctionSubclass(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["class_name", "scaling_stats", "specific_stat_scale_type", "stat_scale", "street_brawl_stat_scale", "subclass_name"]
