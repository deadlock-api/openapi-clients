...
class IngestLiveUrl(BaseModel):
    """
    IngestLiveUrl
    """ # noqa: E501
    broadcast_url: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["broadcast_url", "lobby_id", "match_id", "started_at"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "broadcast_url": obj.get("broadcast_url"),
