...
class TableSchemaResponse(BaseModel):
    ...
    kind: StrictStr = Field(description="`entity` for tables discovered from the demo's send-tables, `event` for the event tables common to every demo.")
    name: StrictStr
    __properties: ClassVar[List[str]] = ["columns", "kind", "name"]
