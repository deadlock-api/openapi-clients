...
class RawAbilityUpgrade(BaseModel):
    ...
    RawAbilityUpgrade
    """ # noqa: E501
    property_upgrades: Optional[List[RawAbilityUpgradePropertyUpgrade]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property_upgrades": [RawAbilityUpgradePropertyUpgrade.from_dict(_item) for _item in obj["property_upgrades"]] if obj.get("property_upgrades") is not None else None
        })
        return _obj
