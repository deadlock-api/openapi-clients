...
class SteamInfoApi:
    ...
    def get_all_steam_info(
        ...
        _param = self._get_all_steam_info_serialize(
    ...
    @validate_call
    def get_all_steam_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_all_steam_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_all_steam_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/steam-info/all',
    ...
    def get_steam_info(
        ...
        _param = self._get_steam_info_serialize(
    ...
    @validate_call
    def get_steam_info_with_http_info(
        self,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_steam_info_without_preload_content(
        self,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _get_steam_info_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/steam-info',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
