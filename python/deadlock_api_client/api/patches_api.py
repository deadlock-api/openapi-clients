...
class PatchesApi:
    ...
    def feed(
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("GET /v1/patches is deprecated.", DeprecationWarning)
    ...
    @validate_call
    def feed_0_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
