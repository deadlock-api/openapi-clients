...
class HeroesApi:
    ...
    def get_hero(
        self,
        hero_id: Annotated[int, Field(strict=True, ge=0, description="Hero id (`m_HeroID`)")],
        ...
        :param hero_id: Hero id (`m_HeroID`) (required)
        :type hero_id: int
        ...
        _param = self._get_hero_serialize(
            hero_id=hero_id,
            language=language,
    ...
    @validate_call
    def get_hero_without_preload_content(
        self,
        hero_id: Annotated[int, Field(strict=True, ge=0, description="Hero id (`m_HeroID`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
    ...
    def _get_hero_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/heroes/{hero_id}',
    ...
    def get_hero_by_name(
        self,
        name: Annotated[StrictStr, Field(description="Hero class name (e.g. `hero_atlas`) or short name (e.g. `atlas`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param name: Hero class name (e.g. `hero_atlas`) or short name (e.g. `atlas`) (required)
        :type name: str
        :param language: Language code. Defaults to `english`.
        :type language: str
        :param client_version: Client/game version (e.g. `6518`). Defaults to the latest known version.
        ...
        _param = self._get_hero_by_name_serialize(
            name=name,
            language=language,
            client_version=client_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_hero_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Hero class name (e.g. `hero_atlas`) or short name (e.g. `atlas`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
    ...
    @validate_call
    def get_hero_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Hero class name (e.g. `hero_atlas`) or short name (e.g. `atlas`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
    ...
    def _get_hero_by_name_serialize(
        self,
        name,
        language,
        client_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/heroes/by-name/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_heroes(
        ...
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        only_active: Annotated[Optional[StrictBool], Field(description="When true, hides heroes that aren't player-selectable or are disabled / in-development.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param client_version: Client/game version (e.g. `6518`). Defaults to the latest known version.
        :type client_version: int
        :param only_active: When true, hides heroes that aren't player-selectable or are disabled / in-development.
        ...
        _param = self._list_heroes_serialize(
            language=language,
            client_version=client_version,
    ...
    @validate_call
    def list_heroes_with_http_info(
        self,
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        only_active: Annotated[Optional[StrictBool], Field(description="When true, hides heroes that aren't player-selectable or are disabled / in-development.")] = None,
    ...
    @validate_call
    def list_heroes_without_preload_content(
        self,
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        only_active: Annotated[Optional[StrictBool], Field(description="When true, hides heroes that aren't player-selectable or are disabled / in-development.")] = None,
    ...
    def _list_heroes_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/heroes',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
