...
class BuildTagsApi:
    ...
    def get_build_tag(
        self,
        build_tag_id: Annotated[int, Field(strict=True, ge=0, description="Build tag id (murmurhash2 of `class_name`)")],
        ...
        :param build_tag_id: Build tag id (murmurhash2 of `class_name`) (required)
        :type build_tag_id: int
        ...
        _param = self._get_build_tag_serialize(
    ...
    @validate_call
    def get_build_tag_with_http_info(
        self,
        build_tag_id: Annotated[int, Field(strict=True, ge=0, description="Build tag id (murmurhash2 of `class_name`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
    ...
    @validate_call
    def get_build_tag_without_preload_content(
        self,
        build_tag_id: Annotated[int, Field(strict=True, ge=0, description="Build tag id (murmurhash2 of `class_name`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
    ...
    def _get_build_tag_serialize(
        ...
        if build_tag_id is not None:
            _path_params['build_tag_id'] = build_tag_id
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/build-tags/{build_tag_id}',
    ...
    @validate_call
    def get_build_tag_by_name(
        self,
        name: Annotated[StrictStr, Field(description="Build tag `class_name` (e.g. `citadel_build_tag_weapon`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param name: Build tag `class_name` (e.g. `citadel_build_tag_weapon`) (required)
        :type name: str
        :param language: Language code. Defaults to `english`.
        :type language: str
        :param client_version: Client/game version (e.g. `6518`). Defaults to the latest known version.
        ...
        _param = self._get_build_tag_by_name_serialize(
            name=name,
            language=language,
            client_version=client_version,
            _request_auth=_request_auth,
    ...
    @validate_call
    def get_build_tag_by_name_with_http_info(
        self,
        name: Annotated[StrictStr, Field(description="Build tag `class_name` (e.g. `citadel_build_tag_weapon`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
    ...
    @validate_call
    def get_build_tag_by_name_without_preload_content(
        self,
        name: Annotated[StrictStr, Field(description="Build tag `class_name` (e.g. `citadel_build_tag_weapon`)")],
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
    ...
    def _get_build_tag_by_name_serialize(
        self,
        name,
        language,
        client_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/build-tags/by-name/{name}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def list_build_tags(
        ...
        _param = self._list_build_tags_serialize(
            language=language,
            client_version=client_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def list_build_tags_with_http_info(
        self,
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def list_build_tags_without_preload_content(
        self,
        language: Annotated[Optional[StrictStr], Field(description="Language code. Defaults to `english`.")] = None,
        client_version: Annotated[Optional[Annotated[int, Field(strict=True, ge=0)]], Field(description="Client/game version (e.g. `6518`). Defaults to the latest known version.")] = None,
        _request_timeout: Union[
    ...
    def _list_build_tags_serialize(
        self,
        language,
        client_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/build-tags',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
