...
class ClientVersionsApi:
    ...
    def list_client_versions(
        ...
        _param = self._list_client_versions_serialize(
    ...
    @validate_call
    def list_client_versions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_client_versions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_client_versions_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/assets/client-versions',
