...
**tooltip_section** | [**AbilitySectionType**](AbilitySectionType.md) |  | [optional] 
...
json = "{}"
# create an instance of UpgradeProperty from a JSON string
upgrade_property_instance = UpgradeProperty.from_json(json)
# print the JSON string representation of the object
print(UpgradeProperty.to_json())

# convert the object into a dict
upgrade_property_dict = upgrade_property_instance.to_dict()
# create an instance of UpgradeProperty from a dict
upgrade_property_from_dict = UpgradeProperty.from_dict(upgrade_property_dict)
```
