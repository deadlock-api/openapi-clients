...
class RawAbilityUpgradePropertyUpgradeV2Output(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "bonus", "scale_stat_filter", "upgrade_type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.scale_stat_filter is None and "scale_stat_filter" in self.model_fields_set:
            _dict['scale_stat_filter'] = None

        # set to None if upgrade_type (nullable) is None
        # and model_fields_set contains the field
        if self.upgrade_type is None and "upgrade_type" in self.model_fields_set:
            _dict['upgrade_type'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "bonus": Bonus.from_dict(obj["bonus"]) if obj.get("bonus") is not None else None,
