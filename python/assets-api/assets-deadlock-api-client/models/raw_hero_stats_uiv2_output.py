...
class RawHeroStatsUIV2Output(BaseModel):
    """
    RawHeroStatsUIV2Output
    """ # noqa: E501
    weapon_stat_display: StrictStr
    display_stats: List[RawHeroStatsUIDisplayV2Output]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "display_stats": [RawHeroStatsUIDisplayV2Output.from_dict(_item) for _item in obj["display_stats"]] if obj.get("display_stats") is not None else None
        })
        return _obj
