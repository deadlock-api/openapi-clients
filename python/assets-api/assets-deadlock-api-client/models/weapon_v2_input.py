...
class WeaponV2Input(BaseModel):
    ...
    weapon_info: Optional[RawWeaponInfoV2Input] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "weapon_info": RawWeaponInfoV2Input.from_dict(obj["weapon_info"]) if obj.get("weapon_info") is not None else None,
