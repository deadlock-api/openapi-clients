...
class UpgradePropertyV2Output(BaseModel):
    """
    ...
    scale_function: Optional[RawItemPropertyScaleFunctionSubclassV2Output] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "scale_function": RawItemPropertyScaleFunctionSubclassV2Output.from_dict(obj["scale_function"]) if obj.get("scale_function") is not None else None,
