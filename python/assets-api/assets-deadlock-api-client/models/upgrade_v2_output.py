...
class UpgradeV2Output(BaseModel):
    """
    UpgradeV2Output
    """ # noqa: E501
    id: StrictInt
    ...
    properties: Optional[Dict[str, UpgradePropertyV2Output]] = None
    ...
    tooltip_sections: Optional[List[UpgradeTooltipSectionV2Output]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": dict(
                (_k, UpgradePropertyV2Output.from_dict(_v))
            ...
            "tooltip_sections": [UpgradeTooltipSectionV2Output.from_dict(_item) for _item in obj["tooltip_sections"]] if obj.get("tooltip_sections") is not None else None,
