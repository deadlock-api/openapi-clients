...
class RawAbilityUpgradeV2Output(BaseModel):
    """
    RawAbilityUpgradeV2Output
    """ # noqa: E501
    property_upgrades: Optional[List[RawAbilityUpgradePropertyUpgradeV2Output]] = None
    __properties: ClassVar[List[str]] = ["property_upgrades"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property_upgrades": [RawAbilityUpgradePropertyUpgradeV2Output.from_dict(_item) for _item in obj["property_upgrades"]] if obj.get("property_upgrades") is not None else None
        })
        return _obj
