...
class RawWeaponInfoV2Output(BaseModel):
    """
    ...
    bullet_speed_curve: Optional[RawItemWeaponInfoBulletSpeedCurveV2Output] = None
    horizontal_recoil: Optional[RawWeaponInfoHorizontalRecoilV2Output] = None
    vertical_recoil: Optional[RawWeaponInfoVerticalRecoilV2Output] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "bullet_speed_curve": RawItemWeaponInfoBulletSpeedCurveV2Output.from_dict(obj["bullet_speed_curve"]) if obj.get("bullet_speed_curve") is not None else None,
            "horizontal_recoil": RawWeaponInfoHorizontalRecoilV2Output.from_dict(obj["horizontal_recoil"]) if obj.get("horizontal_recoil") is not None else None,
            "vertical_recoil": RawWeaponInfoVerticalRecoilV2Output.from_dict(obj["vertical_recoil"]) if obj.get("vertical_recoil") is not None else None
        })
        return _obj
