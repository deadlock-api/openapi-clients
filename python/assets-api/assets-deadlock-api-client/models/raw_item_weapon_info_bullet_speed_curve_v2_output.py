...
class RawItemWeaponInfoBulletSpeedCurveV2Output(BaseModel):
    """
    RawItemWeaponInfoBulletSpeedCurveV2Output
    """ # noqa: E501
    spline: Optional[List[RawItemWeaponInfoBulletSpeedCurveSplineV2Output]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "spline": [RawItemWeaponInfoBulletSpeedCurveSplineV2Output.from_dict(_item) for _item in obj["spline"]] if obj.get("spline") is not None else None,
