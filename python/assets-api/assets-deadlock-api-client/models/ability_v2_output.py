...
class AbilityV2Output(BaseModel):
    """
    AbilityV2Output
    """ # noqa: E501
    id: StrictInt
    ...
    properties: Optional[Dict[str, ItemPropertyV2Output]] = None
    weapon_info: Optional[RawItemWeaponInfoV2Output] = None
    type: Optional[StrictStr] = 'ability'
    behaviours: Optional[List[StrictStr]] = None
    description: AbilityDescriptionV2
    tooltip_details: Optional[AbilityTooltipDetailsV2Output] = None
    upgrades: Optional[List[RawAbilityUpgradeV2Output]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": dict(
                (_k, ItemPropertyV2Output.from_dict(_v))
                for _k, _v in obj["properties"].items()
            )
            if obj.get("properties") is not None
            else None,
            "weapon_info": RawItemWeaponInfoV2Output.from_dict(obj["weapon_info"]) if obj.get("weapon_info") is not None else None,
            ...
            "tooltip_details": AbilityTooltipDetailsV2Output.from_dict(obj["tooltip_details"]) if obj.get("tooltip_details") is not None else None,
            "upgrades": [RawAbilityUpgradeV2Output.from_dict(_item) for _item in obj["upgrades"]] if obj.get("upgrades") is not None else None,
