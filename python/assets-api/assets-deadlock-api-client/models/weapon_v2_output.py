...
class WeaponV2Output(BaseModel):
    """
    WeaponV2Output
    """ # noqa: E501
    id: StrictInt
    ...
    weapon_info: Optional[RawWeaponInfoV2Output] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "weapon_info": RawWeaponInfoV2Output.from_dict(obj["weapon_info"]) if obj.get("weapon_info") is not None else None,
