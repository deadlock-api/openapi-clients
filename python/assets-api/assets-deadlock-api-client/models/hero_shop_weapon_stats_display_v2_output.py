...
class HeroShopWeaponStatsDisplayV2Output(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["display_stats", "other_display_stats", "weapon_attributes", "weapon_image", "weapon_image_webp"]
