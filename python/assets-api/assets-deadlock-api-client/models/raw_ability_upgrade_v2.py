...
class RawAbilityUpgradeV2(BaseModel):
    ...
    RawAbilityUpgradeV2
    """ # noqa: E501
    property_upgrades: Optional[List[RawAbilityUpgradePropertyUpgradeV2]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "property_upgrades": [RawAbilityUpgradePropertyUpgradeV2.from_dict(_item) for _item in obj["property_upgrades"]] if obj.get("property_upgrades") is not None else None
        })
        return _obj
