...
class UpgradeV2Input(BaseModel):
    """
    UpgradeV2Input
    """ # noqa: E501
    id: StrictInt
    ...
    properties: Optional[Dict[str, UpgradePropertyV2Input]] = None
    ...
    tooltip_sections: Optional[List[UpgradeTooltipSectionV2Input]] = None
    __properties: ClassVar[List[str]] = ["id", "class_name", "name", "start_trained", "image", "image_webp", "hero", "heroes", "update_time", "properties", "weapon_info", "type", "shop_image", "shop_image_webp", "shop_image_small", "shop_image_small_webp", "item_slot_type", "item_tier", "disabled", "description", "activation", "imbue", "component_items", "tooltip_sections"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": dict(
                (_k, UpgradePropertyV2Input.from_dict(_v))
            ...
            "tooltip_sections": [UpgradeTooltipSectionV2Input.from_dict(_item) for _item in obj["tooltip_sections"]] if obj.get("tooltip_sections") is not None else None
        })
        return _obj
