...
class ItemPropertyV2Input(BaseModel):
    """
    ItemPropertyV2Input
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["m_strValue", "m_bCanSetTokenOverride", "m_eProvidedPropertyType", "m_strCSSClass", "m_eStatsUsageFlags", "m_bIsNegativeAttribute", "m_strDisableValue", "m_strLocTokenOverride", "m_eDisplayUnits", "scale_function", "prefix", "label", "postfix", "postvalue_label", "conditional", "icon"]
