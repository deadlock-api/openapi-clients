...
A client library for accessing Assets - Deadlock API

## Usage
First, create a client:

```python
from assets_deadlock_api_client import Client
...
```python
from assets_deadlock_api_client import AuthenticatedClient
...
```python
from assets_deadlock_api_client.models import MyDataModel
from assets_deadlock_api_client.api.my_tag import get_my_data_model
from assets_deadlock_api_client.types import Response
...
1. Any endpoint which did not have a tag will be in `assets_deadlock_api_client.api.default`
