...
class TestLaneInfoV2(unittest.TestCase):
    """LaneInfoV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaneInfoV2:
        """Test LaneInfoV2
        ...
        if include_optional:
            return LaneInfoV2(
                ...
                minimap_zipline_color_override = assets_deadlock_api_client.models.color_v1.ColorV1(
                    ...
                    blue = 0.0, 
                    alpha = 0.0, ),
                objective_color = assets_deadlock_api_client.models.color_v1.ColorV1(
                    red = 0.0, 
                    green = 0.0, 
                    blue = 0.0, 
                    alpha = 0.0, )
