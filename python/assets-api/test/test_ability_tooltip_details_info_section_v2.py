...
class TestAbilityTooltipDetailsInfoSectionV2(unittest.TestCase):
    """AbilityTooltipDetailsInfoSectionV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityTooltipDetailsInfoSectionV2:
        ...
        """
        model = AbilityTooltipDetailsInfoSectionV2()
        if include_optional:
            return AbilityTooltipDetailsInfoSectionV2(
                loc_string = '',
    ...
    def testAbilityTooltipDetailsInfoSectionV2(self):
        """Test AbilityTooltipDetailsInfoSectionV2"""
