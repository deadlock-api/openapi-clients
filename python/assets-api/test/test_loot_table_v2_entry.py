...
class TestLootTableV2Entry(unittest.TestCase):
    """LootTableV2Entry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LootTableV2Entry:
        """Test LootTableV2Entry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LootTableV2Entry`
        """
        model = LootTableV2Entry()
        if include_optional:
            return LootTableV2Entry(
                item = ''
            )
        else:
            return LootTableV2Entry(
