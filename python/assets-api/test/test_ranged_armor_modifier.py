...
class TestRangedArmorModifier(unittest.TestCase):
    """RangedArmorModifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RangedArmorModifier:
        """Test RangedArmorModifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RangedArmorModifier`
        """
        model = RangedArmorModifier()
        if include_optional:
            return RangedArmorModifier(
                range_min = 1.337,
                range_max = 1.337,
                invuln_range = 1.337
            )
    ...
    def testRangedArmorModifier(self):
        """Test RangedArmorModifier"""
