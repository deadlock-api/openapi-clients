...
class TestEmpoweredModifierLevel(unittest.TestCase):
    """EmpoweredModifierLevel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmpoweredModifierLevel:
        ...
        """
        model = EmpoweredModifierLevel()
        if include_optional:
            return EmpoweredModifierLevel(
                max_health = 56,
    ...
    def testEmpoweredModifierLevel(self):
        """Test EmpoweredModifierLevel"""
