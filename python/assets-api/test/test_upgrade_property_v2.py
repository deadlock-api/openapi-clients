...
class TestUpgradePropertyV2(unittest.TestCase):
    """UpgradePropertyV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradePropertyV2:
        """Test UpgradePropertyV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpgradePropertyV2`
        """
        model = UpgradePropertyV2()
        if include_optional:
            return UpgradePropertyV2(
                value = None,
    ...
    def testUpgradePropertyV2(self):
        """Test UpgradePropertyV2"""
