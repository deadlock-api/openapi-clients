...
class TestUpgradeV2Input(unittest.TestCase):
    """UpgradeV2Input unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradeV2Input:
        """Test UpgradeV2Input
        ...
        """
        model = UpgradeV2Input()
        if include_optional:
            return UpgradeV2Input(
                id = 56,
                class_name = '',
                name = '',
                start_trained = True,
