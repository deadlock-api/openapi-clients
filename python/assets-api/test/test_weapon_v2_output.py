...
class TestWeaponV2Output(unittest.TestCase):
    """WeaponV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> WeaponV2Output:
        """Test WeaponV2Output
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `WeaponV2Output`
        """
        model = WeaponV2Output()
        if include_optional:
            return WeaponV2Output(
                id = 56,
                class_name = '',
                name = '',
                start_trained = True,
