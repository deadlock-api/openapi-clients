...
class TestAbilityV2DependentAbilitiesValue(unittest.TestCase):
    """AbilityV2DependentAbilitiesValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityV2DependentAbilitiesValue:
        """Test AbilityV2DependentAbilitiesValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbilityV2DependentAbilitiesValue`
        """
        model = AbilityV2DependentAbilitiesValue()
        if include_optional:
            return AbilityV2DependentAbilitiesValue(
                flags = [
                    ''
                    ]
            )
    ...
    def testAbilityV2DependentAbilitiesValue(self):
        """Test AbilityV2DependentAbilitiesValue"""
