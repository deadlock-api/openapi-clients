...
class TestAimingShotSpreadPenalty(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AimingShotSpreadPenalty:
        """Test AimingShotSpreadPenalty
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AimingShotSpreadPenalty`
        """
        model = AimingShotSpreadPenalty()
        if include_optional:
            return AimingShotSpreadPenalty(
            )
        else:
            return AimingShotSpreadPenalty(
        )
    ...
    def testAimingShotSpreadPenalty(self):
        """Test AimingShotSpreadPenalty"""
