...
class TestGlowColorTeamNeutral(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GlowColorTeamNeutral:
        """Test GlowColorTeamNeutral
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlowColorTeamNeutral`
        """
        model = GlowColorTeamNeutral()
        if include_optional:
            return GlowColorTeamNeutral(
            )
        else:
            return GlowColorTeamNeutral(
        )
    ...
    def testGlowColorTeamNeutral(self):
        """Test GlowColorTeamNeutral"""
