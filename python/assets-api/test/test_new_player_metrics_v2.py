...
class TestNewPlayerMetricsV2(unittest.TestCase):
    """NewPlayerMetricsV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewPlayerMetricsV2:
        """Test NewPlayerMetricsV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewPlayerMetricsV2`
        """
        model = NewPlayerMetricsV2()
        if include_optional:
            return NewPlayerMetricsV2(
                skill_tier_name = '',
                net_worth = 56,
                damage_taken = 56,
                boss_damage = 56,
    ...
    def testNewPlayerMetricsV2(self):
        """Test NewPlayerMetricsV2"""
