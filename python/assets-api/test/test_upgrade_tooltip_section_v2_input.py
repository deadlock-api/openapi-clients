...
class TestUpgradeTooltipSectionV2Input(unittest.TestCase):
    """UpgradeTooltipSectionV2Input unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradeTooltipSectionV2Input:
        """Test UpgradeTooltipSectionV2Input
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpgradeTooltipSectionV2Input`
        """
        model = UpgradeTooltipSectionV2Input()
        if include_optional:
            return UpgradeTooltipSectionV2Input(
                section_type = 'innate',
                section_attributes = [
    ...
    def testUpgradeTooltipSectionV2Input(self):
        """Test UpgradeTooltipSectionV2Input"""
