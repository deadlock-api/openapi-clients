...
class TestAbilityV2Output(unittest.TestCase):
    """AbilityV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityV2Output:
        """Test AbilityV2Output
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AbilityV2Output`
        """
        model = AbilityV2Output()
        if include_optional:
            return AbilityV2Output(
                id = 56,
                class_name = '',
                name = '',
                start_trained = True,
