...
class TestLootTableV2(unittest.TestCase):
    """LootTableV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LootTableV2:
        """Test LootTableV2
        ...
        if include_optional:
            return LootTableV2(
                entries = [
                    assets_deadlock_api_client.models.loot_table_v2_entry.LootTableV2Entry(
                        item = '', )
                    ]
            )
        else:
