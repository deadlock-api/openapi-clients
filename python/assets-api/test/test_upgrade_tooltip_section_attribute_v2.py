...
class TestUpgradeTooltipSectionAttributeV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UpgradeTooltipSectionAttributeV2:
        ...
        """
        model = UpgradeTooltipSectionAttributeV2()
        if include_optional:
            return UpgradeTooltipSectionAttributeV2(
                loc_string = '',
                properties = [
                    ''
                    ],
    ...
    def testUpgradeTooltipSectionAttributeV2(self):
        """Test UpgradeTooltipSectionAttributeV2"""
