...
class TestRawHeroItemSlotInfoValueV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RawHeroItemSlotInfoValueV2:
        ...
        """
        model = RawHeroItemSlotInfoValueV2()
        if include_optional:
            return RawHeroItemSlotInfoValueV2(
    ...
    def testRawHeroItemSlotInfoValueV2(self):
        """Test RawHeroItemSlotInfoValueV2"""
