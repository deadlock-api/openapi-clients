...
class TestHeroV2ItemDraftBucketingValue(unittest.TestCase):
    """HeroV2ItemDraftBucketingValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeroV2ItemDraftBucketingValue:
        """Test HeroV2ItemDraftBucketingValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeroV2ItemDraftBucketingValue`
        """
        model = HeroV2ItemDraftBucketingValue()
        if include_optional:
            return HeroV2ItemDraftBucketingValue(
                bucket = '',
                weight = 1.337
            )
        else:
    ...
    def testHeroV2ItemDraftBucketingValue(self):
        """Test HeroV2ItemDraftBucketingValue"""
