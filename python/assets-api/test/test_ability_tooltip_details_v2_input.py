...
class TestAbilityTooltipDetailsV2Input(unittest.TestCase):
    """AbilityTooltipDetailsV2Input unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityTooltipDetailsV2Input:
        ...
        """
        model = AbilityTooltipDetailsV2Input()
        if include_optional:
            return AbilityTooltipDetailsV2Input(
                info_sections = [
    ...
    def testAbilityTooltipDetailsV2Input(self):
        """Test AbilityTooltipDetailsV2Input"""
