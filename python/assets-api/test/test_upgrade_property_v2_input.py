...
class TestUpgradePropertyV2Input(unittest.TestCase):
    """UpgradePropertyV2Input unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradePropertyV2Input:
        ...
        """
        model = UpgradePropertyV2Input()
        if include_optional:
            return UpgradePropertyV2Input(
                m_str_value = None,
    ...
    def testUpgradePropertyV2Input(self):
        """Test UpgradePropertyV2Input"""
