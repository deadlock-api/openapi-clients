...
class TestRawAccoladeV2(unittest.TestCase):
    """RawAccoladeV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawAccoladeV2:
        """Test RawAccoladeV2
        ...
        if include_optional:
            return RawAccoladeV2(
                class_name = '',
                id = 56,
                tracked_stat_name = 'ability_damage',
                flavor_name = '',
                description = '',
