...
class TestRawItemPropertyV2(unittest.TestCase):
    """RawItemPropertyV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawItemPropertyV2:
        ...
        """
        model = RawItemPropertyV2()
        if include_optional:
            return RawItemPropertyV2(
                value = None,
                ...
                display_units = '',
                icon_path = '',
                scale_function = assets_deadlock_api_client.models.raw_item_property_scale_function_v2.RawItemPropertyScaleFunctionV2(
                    subclass = null, )
            )
        else:
            return RawItemPropertyV2(
    ...
    def testRawItemPropertyV2(self):
        """Test RawItemPropertyV2"""
