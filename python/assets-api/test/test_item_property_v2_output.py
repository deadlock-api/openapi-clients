...
class TestItemPropertyV2Output(unittest.TestCase):
    """ItemPropertyV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemPropertyV2Output:
        """Test ItemPropertyV2Output
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemPropertyV2Output`
        """
        model = ItemPropertyV2Output()
        if include_optional:
            return ItemPropertyV2Output(
                value = None,
    ...
    def testItemPropertyV2Output(self):
        """Test ItemPropertyV2Output"""
