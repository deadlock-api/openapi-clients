...
class TestRawWeaponInfoHorizontalRecoilV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RawWeaponInfoHorizontalRecoilV2:
        ...
        """
        model = RawWeaponInfoHorizontalRecoilV2()
        if include_optional:
            return RawWeaponInfoHorizontalRecoilV2(
                range = None,
    ...
    def testRawWeaponInfoHorizontalRecoilV2(self):
        """Test RawWeaponInfoHorizontalRecoilV2"""
