...
class TestHealthBarColorTeam2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HealthBarColorTeam2:
        """Test HealthBarColorTeam2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthBarColorTeam2`
        """
        model = HealthBarColorTeam2()
        if include_optional:
            return HealthBarColorTeam2(
            )
        else:
            return HealthBarColorTeam2(
        )
    ...
    def testHealthBarColorTeam2(self):
        """Test HealthBarColorTeam2"""
