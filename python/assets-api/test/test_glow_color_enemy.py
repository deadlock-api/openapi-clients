...
class TestGlowColorEnemy(unittest.TestCase):
    """GlowColorEnemy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlowColorEnemy:
        """Test GlowColorEnemy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlowColorEnemy`
        """
        model = GlowColorEnemy()
        if include_optional:
            return GlowColorEnemy(
            )
        else:
            return GlowColorEnemy(
        )
