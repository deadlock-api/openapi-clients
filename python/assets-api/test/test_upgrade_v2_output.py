...
class TestUpgradeV2Output(unittest.TestCase):
    """UpgradeV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradeV2Output:
        """Test UpgradeV2Output
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpgradeV2Output`
        """
        model = UpgradeV2Output()
        if include_optional:
            return UpgradeV2Output(
                id = 56,
                class_name = '',
                name = '',
                start_trained = True,
