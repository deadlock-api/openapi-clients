...
class TestHeroStartingStatV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HeroStartingStatV2:
        """Test HeroStartingStatV2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeroStartingStatV2`
        """
        model = HeroStartingStatV2()
        if include_optional:
            return HeroStartingStatV2(
                value = None,
                display_stat_name = ''
            )
        else:
    ...
    def testHeroStartingStatV2(self):
        """Test HeroStartingStatV2"""
