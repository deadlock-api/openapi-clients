...
class TestGlowColorFriend(unittest.TestCase):
    """GlowColorFriend unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlowColorFriend:
        """Test GlowColorFriend
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlowColorFriend`
        """
        model = GlowColorFriend()
        if include_optional:
            return GlowColorFriend(
            )
        else:
            return GlowColorFriend(
        )
