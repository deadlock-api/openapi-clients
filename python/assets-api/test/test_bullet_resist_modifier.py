...
class TestBulletResistModifier(unittest.TestCase):
    """BulletResistModifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulletResistModifier:
        ...
        """
        model = BulletResistModifier()
        if include_optional:
            return BulletResistModifier(
                bullet_resist = 56,
    ...
    def testBulletResistModifier(self):
        """Test BulletResistModifier"""
