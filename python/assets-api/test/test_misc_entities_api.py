...
class TestMiscEntitiesApi(unittest.TestCase):
    """MiscEntitiesApi unit test stubs"""

    def setUp(self) -> None:
        self.api = MiscEntitiesApi()

    def tearDown(self) -> None:
        pass

    def test_get_misc_entities_v2_misc_entities_get(self) -> None:
        """Test case for get_misc_entities_v2_misc_entities_get

        Get Misc Entities
        """
        pass

    def test_get_misc_entity_v2_misc_entities_id_or_class_name_get(self) -> None:
        """Test case for get_misc_entity_v2_misc_entities_id_or_class_name_get
