...
class TestUpgradeTooltipSectionV2Output(unittest.TestCase):
    """UpgradeTooltipSectionV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradeTooltipSectionV2Output:
        """Test UpgradeTooltipSectionV2Output
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpgradeTooltipSectionV2Output`
        """
        model = UpgradeTooltipSectionV2Output()
        if include_optional:
            return UpgradeTooltipSectionV2Output(
                section_type = 'innate',
                section_attributes = [
    ...
    def testUpgradeTooltipSectionV2Output(self):
        """Test UpgradeTooltipSectionV2Output"""
