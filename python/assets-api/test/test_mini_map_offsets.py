...
class TestMiniMapOffsets(unittest.TestCase):
    """MiniMapOffsets unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MiniMapOffsets:
        """Test MiniMapOffsets
        ...
        """
        model = MiniMapOffsets()
        if include_optional:
            return MiniMapOffsets(
                entity_class = '',
                offset_2d = [
                    1.337
                    ],
