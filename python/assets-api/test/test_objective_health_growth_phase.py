...
class TestObjectiveHealthGrowthPhase(unittest.TestCase):
    """ObjectiveHealthGrowthPhase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjectiveHealthGrowthPhase:
        ...
        """
        model = ObjectiveHealthGrowthPhase()
        if include_optional:
            return ObjectiveHealthGrowthPhase(
    ...
    def testObjectiveHealthGrowthPhase(self):
        """Test ObjectiveHealthGrowthPhase"""
