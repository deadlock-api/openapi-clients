...
class TestItemDraftsValue(unittest.TestCase):
    """ItemDraftsValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemDraftsValue:
        """Test ItemDraftsValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemDraftsValue`
        """
        model = ItemDraftsValue()
        if include_optional:
            return ItemDraftsValue(
                bucket = assets_deadlock_api_client.models.draft_bucket.DraftBucket(
                    normal = 1.337, 
                    good = 1.337, ),
                name = ''
            )
