...
class TestDependantAbilities(unittest.TestCase):
    """DependantAbilities unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DependantAbilities:
        """Test DependantAbilities
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DependantAbilities`
        """
        model = DependantAbilities()
        if include_optional:
            return DependantAbilities(
                flags = [
                    ''
                    ]
            )
    ...
    def testDependantAbilities(self):
        """Test DependantAbilities"""
