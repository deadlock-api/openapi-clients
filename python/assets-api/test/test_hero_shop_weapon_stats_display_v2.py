...
class TestHeroShopWeaponStatsDisplayV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HeroShopWeaponStatsDisplayV2:
        ...
        """
        model = HeroShopWeaponStatsDisplayV2()
        if include_optional:
            return HeroShopWeaponStatsDisplayV2(
                display_stats = [
                    ''
                    ],
                other_display_stats = [
    ...
    def testHeroShopWeaponStatsDisplayV2(self):
        """Test HeroShopWeaponStatsDisplayV2"""
