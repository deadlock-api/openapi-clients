...
class TestAbilityTooltipDetailsInfoSectionV2Input(unittest.TestCase):
    """AbilityTooltipDetailsInfoSectionV2Input unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityTooltipDetailsInfoSectionV2Input:
        ...
        """
        model = AbilityTooltipDetailsInfoSectionV2Input()
        if include_optional:
            return AbilityTooltipDetailsInfoSectionV2Input(
                loc_string = '',
    ...
    def testAbilityTooltipDetailsInfoSectionV2Input(self):
        """Test AbilityTooltipDetailsInfoSectionV2Input"""
