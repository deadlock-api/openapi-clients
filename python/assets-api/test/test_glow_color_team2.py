...
class TestGlowColorTeam2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GlowColorTeam2:
        """Test GlowColorTeam2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GlowColorTeam2`
        """
        model = GlowColorTeam2()
        if include_optional:
            return GlowColorTeam2(
            )
        else:
            return GlowColorTeam2(
        )
