...
class TestSubclassObjectiveHealthGrowthPhase(unittest.TestCase):
    """SubclassObjectiveHealthGrowthPhase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubclassObjectiveHealthGrowthPhase:
        """Test SubclassObjectiveHealthGrowthPhase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubclassObjectiveHealthGrowthPhase`
        """
        model = SubclassObjectiveHealthGrowthPhase()
        if include_optional:
            return SubclassObjectiveHealthGrowthPhase(
    ...
    def testSubclassObjectiveHealthGrowthPhase(self):
        """Test SubclassObjectiveHealthGrowthPhase"""
