...
class TestObjectiveRegen(unittest.TestCase):
    """ObjectiveRegen unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjectiveRegen:
        """Test ObjectiveRegen
        ...
        """
        model = ObjectiveRegen()
        if include_optional:
            return ObjectiveRegen(
