...
class TestIntrinsicModifiers(unittest.TestCase):
    """IntrinsicModifiers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IntrinsicModifiers:
        """Test IntrinsicModifiers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IntrinsicModifiers`
        """
        model = IntrinsicModifiers()
        if include_optional:
            return IntrinsicModifiers(
                script_values = [
    ...
    def testIntrinsicModifiers(self):
        """Test IntrinsicModifiers"""
