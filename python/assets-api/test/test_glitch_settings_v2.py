...
class TestGlitchSettingsV2(unittest.TestCase):
    """GlitchSettingsV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlitchSettingsV2:
        ...
        """
        model = GlitchSettingsV2()
        if include_optional:
            return GlitchSettingsV2(
                strength = 1.337,
                uantize_type = 1.337,
