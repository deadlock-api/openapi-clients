...
class TestNPCUnitsApi(unittest.TestCase):
    """NPCUnitsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = NPCUnitsApi()

    def tearDown(self) -> None:
        pass

    def test_get_npc_unit_v2_npc_units_id_or_class_name_get(self) -> None:
        """Test case for get_npc_unit_v2_npc_units_id_or_class_name_get

        Get Npc Unit
        """
        pass

    def test_get_npc_units_v2_npc_units_get(self) -> None:
        """Test case for get_npc_units_v2_npc_units_get
