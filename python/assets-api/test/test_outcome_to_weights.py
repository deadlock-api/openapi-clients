...
class TestOutcomeToWeights(unittest.TestCase):
    """OutcomeToWeights unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OutcomeToWeights:
        """Test OutcomeToWeights
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OutcomeToWeights`
        """
        model = OutcomeToWeights()
        if include_optional:
            return OutcomeToWeights(
                outcomes_to_weights = {
                    'key' : 1.337
                    }
            )
