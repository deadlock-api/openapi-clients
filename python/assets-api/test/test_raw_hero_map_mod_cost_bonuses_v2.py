...
class TestRawHeroMapModCostBonusesV2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> RawHeroMapModCostBonusesV2:
        ...
        """
        model = RawHeroMapModCostBonusesV2()
        if include_optional:
            return RawHeroMapModCostBonusesV2(
                gold_threshold = 56,
                bonus = 1.337,
    ...
    def testRawHeroMapModCostBonusesV2(self):
        """Test RawHeroMapModCostBonusesV2"""
