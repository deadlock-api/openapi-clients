...
class TestRawItemWeaponInfoV2Output(unittest.TestCase):
    """RawItemWeaponInfoV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawItemWeaponInfoV2Output:
        """Test RawItemWeaponInfoV2Output
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RawItemWeaponInfoV2Output`
        """
        model = RawItemWeaponInfoV2Output()
        if include_optional:
            return RawItemWeaponInfoV2Output(
    ...
    def testRawItemWeaponInfoV2Output(self):
        """Test RawItemWeaponInfoV2Output"""
