...
class TestHealthBarColorTeamNeutral(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HealthBarColorTeamNeutral:
        """Test HealthBarColorTeamNeutral
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthBarColorTeamNeutral`
        """
        model = HealthBarColorTeamNeutral()
        if include_optional:
            return HealthBarColorTeamNeutral(
            )
        else:
            return HealthBarColorTeamNeutral(
        )
    ...
    def testHealthBarColorTeamNeutral(self):
        """Test HealthBarColorTeamNeutral"""
