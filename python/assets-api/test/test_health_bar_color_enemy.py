...
class TestHealthBarColorEnemy(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> HealthBarColorEnemy:
        """Test HealthBarColorEnemy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthBarColorEnemy`
        """
        model = HealthBarColorEnemy()
        if include_optional:
            return HealthBarColorEnemy(
            )
        else:
            return HealthBarColorEnemy(
        )
    ...
    def testHealthBarColorEnemy(self):
        """Test HealthBarColorEnemy"""
