...
class TestItemDraftRound(unittest.TestCase):
    """ItemDraftRound unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemDraftRound:
        """Test ItemDraftRound
