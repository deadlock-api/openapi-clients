...
class TestAbilityTooltipDetailsInfoSectionV2Output(unittest.TestCase):
    """AbilityTooltipDetailsInfoSectionV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityTooltipDetailsInfoSectionV2Output:
        ...
        """
        model = AbilityTooltipDetailsInfoSectionV2Output()
        if include_optional:
            return AbilityTooltipDetailsInfoSectionV2Output(
                loc_string = '',
    ...
    def testAbilityTooltipDetailsInfoSectionV2Output(self):
        """Test AbilityTooltipDetailsInfoSectionV2Output"""
