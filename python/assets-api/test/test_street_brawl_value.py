...
class TestStreetBrawlValue(unittest.TestCase):
    """StreetBrawlValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreetBrawlValue:
        """Test StreetBrawlValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreetBrawlValue`
        """
        model = StreetBrawlValue()
        if include_optional:
            return StreetBrawlValue(
            )
        else:
            return StreetBrawlValue(
        )
