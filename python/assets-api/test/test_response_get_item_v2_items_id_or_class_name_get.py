...
class TestResponseGetItemV2ItemsIdOrClassNameGet(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ResponseGetItemV2ItemsIdOrClassNameGet:
        ...
        """
        model = ResponseGetItemV2ItemsIdOrClassNameGet()
        if include_optional:
    ...
    def testResponseGetItemV2ItemsIdOrClassNameGet(self):
        """Test ResponseGetItemV2ItemsIdOrClassNameGet"""
