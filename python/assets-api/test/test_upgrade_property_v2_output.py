...
class TestUpgradePropertyV2Output(unittest.TestCase):
    """UpgradePropertyV2Output unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradePropertyV2Output:
        """Test UpgradePropertyV2Output
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpgradePropertyV2Output`
        """
        model = UpgradePropertyV2Output()
        if include_optional:
            return UpgradePropertyV2Output(
                value = None,
    ...
    def testUpgradePropertyV2Output(self):
        """Test UpgradePropertyV2Output"""
