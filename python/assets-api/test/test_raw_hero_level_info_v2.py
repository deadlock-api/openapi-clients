...
class TestRawHeroLevelInfoV2(unittest.TestCase):
    """RawHeroLevelInfoV2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawHeroLevelInfoV2:
        ...
        """
        model = RawHeroLevelInfoV2()
        if include_optional:
            return RawHeroLevelInfoV2(
    ...
    def testRawHeroLevelInfoV2(self):
        """Test RawHeroLevelInfoV2"""
