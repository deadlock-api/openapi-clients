...
class UpgradeTooltipSectionV2(BaseModel):
    ...
    """ # noqa: E501
    section_type: Optional[RawAbilitySectionTypeV2] = None
    section_attributes: Optional[List[UpgradeTooltipSectionAttributeV2]] = None
    __properties: ClassVar[List[str]] = ["section_type", "section_attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "section_attributes": [UpgradeTooltipSectionAttributeV2.from_dict(_item) for _item in obj["section_attributes"]] if obj.get("section_attributes") is not None else None
        })
        return _obj
