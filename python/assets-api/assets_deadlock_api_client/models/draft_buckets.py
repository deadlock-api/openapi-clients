...
class DraftBuckets(BaseModel):
    ...
    DraftBuckets
    """ # noqa: E501
    bucket: Optional[DraftBucket] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["bucket", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "bucket": DraftBucket.from_dict(obj["bucket"]) if obj.get("bucket") is not None else None,
            "name": obj.get("name")
        })
        return _obj
