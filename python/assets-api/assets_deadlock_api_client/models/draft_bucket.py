...
class DraftBucket(BaseModel):
    ...
    DraftBucket
    """ # noqa: E501
    normal: Optional[Union[StrictFloat, StrictInt]] = None
    good: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["normal", "good"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if normal (nullable) is None
        # and model_fields_set contains the field
        if self.normal is None and "normal" in self.model_fields_set:
            _dict['normal'] = None

        # set to None if good (nullable) is None
        # and model_fields_set contains the field
        if self.good is None and "good" in self.model_fields_set:
            _dict['good'] = None
