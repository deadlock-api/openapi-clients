...
class HeroDescriptionV2(BaseModel):
    ...
    HeroDescriptionV2
    """ # noqa: E501
    lore: Optional[StrictStr] = None
    role: Optional[StrictStr] = None
    playstyle: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["lore", "role", "playstyle"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if lore (nullable) is None
        # and model_fields_set contains the field
        if self.lore is None and "lore" in self.model_fields_set:
            _dict['lore'] = None
        ...
        # set to None if playstyle (nullable) is None
        # and model_fields_set contains the field
        if self.playstyle is None and "playstyle" in self.model_fields_set:
            _dict['playstyle'] = None
