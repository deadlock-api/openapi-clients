...
class ObjectivePositionV1(BaseModel):
    ...
    ObjectivePositionV1
    """ # noqa: E501
    left_relative: Union[StrictFloat, StrictInt] = Field(description="The relative margin left of the map image.")
    top_relative: Union[StrictFloat, StrictInt] = Field(description="The relative margin top of the map image.")
    __properties: ClassVar[List[str]] = ["left_relative", "top_relative"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "left_relative": obj.get("left_relative"),
            "top_relative": obj.get("top_relative")
        })
        return _obj
