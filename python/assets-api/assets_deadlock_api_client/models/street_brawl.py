...
class StreetBrawl(BaseModel):
    ...
    outline_color_friend: Optional[List[StrictInt]] = None
    outline_color_enemy: Optional[List[StrictInt]] = None
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.outline_color_friend is None and "outline_color_friend" in self.model_fields_set:
            _dict['outline_color_friend'] = None

        # set to None if outline_color_enemy (nullable) is None
        # and model_fields_set contains the field
        if self.outline_color_enemy is None and "outline_color_enemy" in self.model_fields_set:
            _dict['outline_color_enemy'] = None

        # set to None if outline_color_team1 (nullable) is None
        # and model_fields_set contains the field
        if self.outline_color_team1 is None and "outline_color_team1" in self.model_fields_set:
            _dict['outline_color_team1'] = None

        # set to None if outline_color_team2 (nullable) is None
        # and model_fields_set contains the field
        if self.outline_color_team2 is None and "outline_color_team2" in self.model_fields_set:
            _dict['outline_color_team2'] = None

        # set to None if outline_color_neutral (nullable) is None
        # and model_fields_set contains the field
        if self.outline_color_neutral is None and "outline_color_neutral" in self.model_fields_set:
            _dict['outline_color_neutral'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outline_color_friend": obj.get("outline_color_friend"),
