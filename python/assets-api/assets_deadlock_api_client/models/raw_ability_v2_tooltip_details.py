...
class RawAbilityV2TooltipDetails(BaseModel):
    ...
    """ # noqa: E501
    info_sections: Optional[List[RawAbilityV2TooltipDetailsInfoSection]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "info_sections": [RawAbilityV2TooltipDetailsInfoSection.from_dict(_item) for _item in obj["info_sections"]] if obj.get("info_sections") is not None else None,
