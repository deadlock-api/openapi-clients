...
class RawAbilityV2TooltipDetailsInfoSectionPropertyBlock(BaseModel):
    ...
    properties: Optional[List[RawAbilityV2TooltipDetailsInfoSectionPropertyBlockProperty]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [RawAbilityV2TooltipDetailsInfoSectionPropertyBlockProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
