...
class OutcomeToWeights(BaseModel):
    ...
    OutcomeToWeights
    """ # noqa: E501
    outcomes_to_weights: Dict[str, Union[StrictFloat, StrictInt]]
    __properties: ClassVar[List[str]] = ["outcomes_to_weights"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "outcomes_to_weights": obj.get("outcomes_to_weights")
        })
        return _obj
