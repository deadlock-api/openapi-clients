...
class AbilityTooltipDetailsInfoSectionPropertyBlockV2(BaseModel):
    ...
    properties: Optional[List[AbilityV2TooltipDetailsInfoSectionPropertyBlockProperty]] = None
    __properties: ClassVar[List[str]] = ["loc_string", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": [AbilityV2TooltipDetailsInfoSectionPropertyBlockProperty.from_dict(_item) for _item in obj["properties"]] if obj.get("properties") is not None else None
        })
        return _obj
