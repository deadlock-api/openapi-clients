...
STANDINGSHOTSPREADPENALTY_ANY_OF_SCHEMAS = ["List[float]", "str"]

class StandingShotSpreadPenalty(BaseModel):
    """
    ...
    def actual_instance_must_validate_anyof(cls, v):
        ...
        instance = StandingShotSpreadPenalty.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in StandingShotSpreadPenalty with anyOf schemas: List[float], str. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into StandingShotSpreadPenalty with anyOf schemas: List[float], str. Details: " + ", ".join(error_messages))
        else:
            return instance
