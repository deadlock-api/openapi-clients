...
class MiniMapOffsets(BaseModel):
    ...
    MiniMapOffsets
    """ # noqa: E501
    entity_class: StrictStr
    offset_2d: List[Union[StrictFloat, StrictInt]]
    lane_index: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["entity_class", "offset_2d", "lane_index"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if lane_index (nullable) is None
        # and model_fields_set contains the field
        if self.lane_index is None and "lane_index" in self.model_fields_set:
            _dict['lane_index'] = None
