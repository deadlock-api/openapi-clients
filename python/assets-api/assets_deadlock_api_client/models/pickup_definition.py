...
class PickupDefinition(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pickup_name", "pickup_weight"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if pickup_name (nullable) is None
        # and model_fields_set contains the field
        if self.pickup_name is None and "pickup_name" in self.model_fields_set:
            _dict['pickup_name'] = None

        # set to None if pickup_weight (nullable) is None
        # and model_fields_set contains the field
        if self.pickup_weight is None and "pickup_weight" in self.model_fields_set:
            _dict['pickup_weight'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "pickup_name": obj.get("pickup_name"),
            "pickup_weight": obj.get("pickup_weight")
        })
        return _obj
