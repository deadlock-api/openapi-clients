...
class Curve(BaseModel):
    ...
    per_minute_after_start: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["base", "per_minute_after_start"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if per_minute_after_start (nullable) is None
        # and model_fields_set contains the field
        if self.per_minute_after_start is None and "per_minute_after_start" in self.model_fields_set:
            _dict['per_minute_after_start'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "base": obj.get("base"),
            "per_minute_after_start": obj.get("per_minute_after_start")
        })
        return _obj
