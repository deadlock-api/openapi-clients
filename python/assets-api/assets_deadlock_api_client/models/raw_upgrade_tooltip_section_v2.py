...
class RawUpgradeTooltipSectionV2(BaseModel):
    ...
    section_attributes: List[RawUpgradeTooltipSectionAttributeV2]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "section_attributes": [RawUpgradeTooltipSectionAttributeV2.from_dict(_item) for _item in obj["section_attributes"]] if obj.get("section_attributes") is not None else None
        })
        return _obj
