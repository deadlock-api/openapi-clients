...
T = TypeVar("T", bound="WeaponV2PropertiesType0")


@_attrs_define
class WeaponV2PropertiesType0:
    """ """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        weapon_v2_properties_type_0 = cls()
        ...
        weapon_v2_properties_type_0.additional_properties = additional_properties
        return weapon_v2_properties_type_0
