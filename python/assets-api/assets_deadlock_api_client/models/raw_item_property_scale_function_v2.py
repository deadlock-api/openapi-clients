...
class RawItemPropertyScaleFunctionV2(BaseModel):
    ...
    """ # noqa: E501
    subclass: Optional[RawItemPropertyScaleFunctionSubclassV2] = None
    __properties: ClassVar[List[str]] = ["subclass"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RawItemPropertyScaleFunctionV2 from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if subclass (nullable) is None
        # and model_fields_set contains the field
        if self.subclass is None and "subclass" in self.model_fields_set:
            _dict['subclass'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RawItemPropertyScaleFunctionV2 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "subclass": RawItemPropertyScaleFunctionSubclassV2.from_dict(obj["subclass"]) if obj.get("subclass") is not None else None
        })
        return _obj
