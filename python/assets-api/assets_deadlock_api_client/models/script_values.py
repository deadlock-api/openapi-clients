...
class ScriptValues(BaseModel):
    ...
    ScriptValues
    """ # noqa: E501
    modifier_value: Optional[StrictStr] = None
    value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["modifier_value", "value"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if modifier_value (nullable) is None
        # and model_fields_set contains the field
        if self.modifier_value is None and "modifier_value" in self.model_fields_set:
            _dict['modifier_value'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "modifier_value": obj.get("modifier_value"),
            "value": obj.get("value")
        })
        return _obj
