...
class RawHeroStatsUIV2(BaseModel):
    ...
    RawHeroStatsUIV2
    """ # noqa: E501
    weapon_stat_display: StrictStr
    display_stats: List[RawHeroStatsUIDisplayV2]
    __properties: ClassVar[List[str]] = ["weapon_stat_display", "display_stats"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "weapon_stat_display": obj.get("weapon_stat_display"),
            "display_stats": [RawHeroStatsUIDisplayV2.from_dict(_item) for _item in obj["display_stats"]] if obj.get("display_stats") is not None else None
        })
        return _obj
