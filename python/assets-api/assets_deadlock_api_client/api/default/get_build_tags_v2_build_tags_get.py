...
from ...models.build_tag_v2 import BuildTagV2
...
) -> Optional[Union[HTTPValidationError, list["BuildTagV2"]]]:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = BuildTagV2.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, list["BuildTagV2"]]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, list['BuildTagV2']]
    """
