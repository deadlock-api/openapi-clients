...
from ...models.map_v1 import MapV1
...
) -> Optional[Union[HTTPValidationError, MapV1]]:
    if response.status_code == 200:
        response_200 = MapV1.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[HTTPValidationError, MapV1]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[HTTPValidationError, MapV1]
    """
