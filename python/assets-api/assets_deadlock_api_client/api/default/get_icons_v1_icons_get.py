...
from ...models.get_icons_v1_icons_get_response_get_icons_v1_icons_get import (
    GetIconsV1IconsGetResponseGetIconsV1IconsGet,
)
...
) -> Optional[Union[GetIconsV1IconsGetResponseGetIconsV1IconsGet, HTTPValidationError]]:
    if response.status_code == 200:
        response_200 = GetIconsV1IconsGetResponseGetIconsV1IconsGet.from_dict(response.json())
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[Union[GetIconsV1IconsGetResponseGetIconsV1IconsGet, HTTPValidationError]]:
    return Response(
...
def sync(
    *,
    ...
    Returns:
        Union[GetIconsV1IconsGetResponseGetIconsV1IconsGet, HTTPValidationError]
    """
