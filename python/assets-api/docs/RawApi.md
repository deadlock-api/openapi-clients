...
with assets_deadlock_api_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Raw Accolades
        api_response = api_instance.get_raw_accolades_raw_accolades_get(client_version=client_version)
        print("The response of RawApi->get_raw_accolades_raw_accolades_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RawApi->get_raw_accolades_raw_accolades_get: %s\n" % e)
```
