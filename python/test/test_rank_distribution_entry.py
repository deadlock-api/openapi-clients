...
class TestRankDistributionEntry(unittest.TestCase):
    """RankDistributionEntry unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RankDistributionEntry:
        """Test RankDistributionEntry
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RankDistributionEntry`
        """
        model = RankDistributionEntry()
        if include_optional:
    ...
    def testRankDistributionEntry(self):
        """Test RankDistributionEntry"""
