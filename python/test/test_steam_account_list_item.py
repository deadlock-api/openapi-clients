...
class TestSteamAccountListItem(unittest.TestCase):
    """SteamAccountListItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SteamAccountListItem:
        ...
        """
        model = SteamAccountListItem()
        if include_optional:
            return SteamAccountListItem(
    ...
    def testSteamAccountListItem(self):
        """Test SteamAccountListItem"""
