...
class TestIngestLiveUrl(unittest.TestCase):
    """IngestLiveUrl unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IngestLiveUrl:
        """Test IngestLiveUrl
