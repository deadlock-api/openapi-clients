...
class TestSubclassModifierDefinitionSubclass(unittest.TestCase):
    """SubclassModifierDefinitionSubclass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubclassModifierDefinitionSubclass:
        ...
        """
        model = SubclassModifierDefinitionSubclass()
        if include_optional:
            return SubclassModifierDefinitionSubclass(
                always_show_in_ui = [
                    ''
                    ],
                class_name = '',
    ...
    def testSubclassModifierDefinitionSubclass(self):
        """Test SubclassModifierDefinitionSubclass"""
