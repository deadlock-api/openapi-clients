...
class TestReplaceSteamAccountRequest(unittest.TestCase):
    """ReplaceSteamAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ReplaceSteamAccountRequest:
        """Test ReplaceSteamAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ReplaceSteamAccountRequest`
        """
        model = ReplaceSteamAccountRequest()
        if include_optional:
            return ReplaceSteamAccountRequest(
                steam_id3 = 56
            )
        else:
            return ReplaceSteamAccountRequest(
    ...
    def testReplaceSteamAccountRequest(self):
        """Test ReplaceSteamAccountRequest"""
