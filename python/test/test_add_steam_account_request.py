...
class TestAddSteamAccountRequest(unittest.TestCase):
    """AddSteamAccountRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddSteamAccountRequest:
        """Test AddSteamAccountRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddSteamAccountRequest`
        """
        model = AddSteamAccountRequest()
        if include_optional:
            return AddSteamAccountRequest(
                steam_id3 = 56
            )
        else:
            return AddSteamAccountRequest(
    ...
    def testAddSteamAccountRequest(self):
        """Test AddSteamAccountRequest"""
