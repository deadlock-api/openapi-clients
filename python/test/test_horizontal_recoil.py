...
class TestHorizontalRecoil(unittest.TestCase):
    """HorizontalRecoil unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HorizontalRecoil:
        """Test HorizontalRecoil
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HorizontalRecoil`
        """
        model = HorizontalRecoil()
        if include_optional:
