...
class TestHashMapStringLevelInfoValue(unittest.TestCase):
    """HashMapStringLevelInfoValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HashMapStringLevelInfoValue:
        ...
        """
        model = HashMapStringLevelInfoValue()
        if include_optional:
            return HashMapStringLevelInfoValue(
                bonus_currencies = [
                    ''
                    ],
                required_gold = 56,
    ...
    def testHashMapStringLevelInfoValue(self):
        """Test HashMapStringLevelInfoValue"""
