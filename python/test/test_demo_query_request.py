...
class TestDemoQueryRequest(unittest.TestCase):
    """DemoQueryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DemoQueryRequest:
        """Test DemoQueryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemoQueryRequest`
        """
        model = DemoQueryRequest()
        if include_optional:
            return DemoQueryRequest(
                format = 'parquet',
                match_id = 0,
                query = ''
            )
