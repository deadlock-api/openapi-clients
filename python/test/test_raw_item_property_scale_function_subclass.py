...
class TestRawItemPropertyScaleFunctionSubclass(unittest.TestCase):
    """RawItemPropertyScaleFunctionSubclass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawItemPropertyScaleFunctionSubclass:
        ...
        """
        model = RawItemPropertyScaleFunctionSubclass()
        if include_optional:
            return RawItemPropertyScaleFunctionSubclass(
                class_name = '',
                scaling_stats = [
                    ''
                    ],
    ...
    def testRawItemPropertyScaleFunctionSubclass(self):
        """Test RawItemPropertyScaleFunctionSubclass"""
