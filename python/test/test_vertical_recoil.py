...
class TestVerticalRecoil(unittest.TestCase):
    """VerticalRecoil unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VerticalRecoil:
        """Test VerticalRecoil
