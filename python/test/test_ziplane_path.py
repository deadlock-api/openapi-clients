...
class TestZiplanePath(unittest.TestCase):
    """ZiplanePath unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ZiplanePath:
        """Test ZiplanePath
        ...
        if include_optional:
            return ZiplanePath(
                ...
                color = '',
                color_parsed = deadlock_api_client.models.color.Color(
                    alpha = 0, 
                    blue = 0, 
                    green = 0, 
                    red = 0, ),
