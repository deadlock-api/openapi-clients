    ...
    def make_instance(self, include_optional) -> PlayerPerformanceCurvePoint:
        ...
        if include_optional:
            return PlayerPerformanceCurvePoint(
                ...
                game_time = 0,
                gold_boss_avg = 1.337,
                gold_boss_orb_avg = 1.337,
                gold_death_loss_avg = 1.337,
                gold_denied_avg = 1.337,
                gold_lane_creep_avg = 1.337,
                gold_lane_creep_orbs_avg = 1.337,
                gold_neutral_creep_avg = 1.337,
                gold_neutral_creep_orbs_avg = 1.337,
                gold_player_avg = 1.337,
                gold_player_orbs_avg = 1.337,
                gold_treasure_avg = 1.337,
                kills_avg = 1.337,
                kills_std = 1.337,
                net_worth_avg = 1.337,
                net_worth_std = 1.337
