...
class TestRollTypeOneOf(unittest.TestCase):
    """RollTypeOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RollTypeOneOf:
        """Test RollTypeOneOf
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RollTypeOneOf`
        """
        model = RollTypeOneOf()
        if include_optional:
            return RollTypeOneOf(
                other = ''
            )
        else:
            return RollTypeOneOf(
