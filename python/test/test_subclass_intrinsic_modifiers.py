...
class TestSubclassIntrinsicModifiers(unittest.TestCase):
    """SubclassIntrinsicModifiers unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubclassIntrinsicModifiers:
        """Test SubclassIntrinsicModifiers
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubclassIntrinsicModifiers`
        """
        model = SubclassIntrinsicModifiers()
        if include_optional:
            return SubclassIntrinsicModifiers(
    ...
    def testSubclassIntrinsicModifiers(self):
        """Test SubclassIntrinsicModifiers"""
