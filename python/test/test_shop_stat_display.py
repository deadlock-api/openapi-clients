...
class TestShopStatDisplay(unittest.TestCase):
    """ShopStatDisplay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShopStatDisplay:
        ...
        """
        model = ShopStatDisplay()
        if include_optional:
            return ShopStatDisplay(
