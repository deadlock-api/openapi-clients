...
class TestAbilityDescription(unittest.TestCase):
    """AbilityDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityDescription:
    ...
    def testAbilityDescription(self):
        """Test AbilityDescription"""
