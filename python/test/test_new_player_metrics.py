...
class TestNewPlayerMetrics(unittest.TestCase):
    """NewPlayerMetrics unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewPlayerMetrics:
        ...
        """
        model = NewPlayerMetrics()
        if include_optional:
            return NewPlayerMetrics(
