...
class TestSubclassObjectiveRegenSubclass(unittest.TestCase):
    """SubclassObjectiveRegenSubclass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubclassObjectiveRegenSubclass:
        ...
        """
        model = SubclassObjectiveRegenSubclass()
        if include_optional:
            return SubclassObjectiveRegenSubclass(
    ...
    def testSubclassObjectiveRegenSubclass(self):
        """Test SubclassObjectiveRegenSubclass"""
