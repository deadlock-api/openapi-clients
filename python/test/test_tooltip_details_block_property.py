...
class TestTooltipDetailsBlockProperty(unittest.TestCase):
    """TooltipDetailsBlockProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TooltipDetailsBlockProperty:
        ...
        """
        model = TooltipDetailsBlockProperty()
        if include_optional:
            return TooltipDetailsBlockProperty(
                important_property = '',
    ...
    def testTooltipDetailsBlockProperty(self):
        """Test TooltipDetailsBlockProperty"""
