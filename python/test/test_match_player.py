...
class TestMatchPlayer(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MatchPlayer:
        """Test MatchPlayer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatchPlayer`
        """
        model = MatchPlayer()
        if include_optional:
            return MatchPlayer(
