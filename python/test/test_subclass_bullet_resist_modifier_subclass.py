...
class TestSubclassBulletResistModifierSubclass(unittest.TestCase):
    """SubclassBulletResistModifierSubclass unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubclassBulletResistModifierSubclass:
        ...
        """
        model = SubclassBulletResistModifierSubclass()
        if include_optional:
            return SubclassBulletResistModifierSubclass(
                bullet_resist = 56,
    ...
    def testSubclassBulletResistModifierSubclass(self):
        """Test SubclassBulletResistModifierSubclass"""
