...
class TestRecoilRange(unittest.TestCase):
    """RecoilRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecoilRange:
        """Test RecoilRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecoilRange`
        """
        model = RecoilRange()
        if include_optional:
            return RecoilRange(
