...
class TestDeleteSteamAccountResponse(unittest.TestCase):
    """DeleteSteamAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeleteSteamAccountResponse:
        """Test DeleteSteamAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeleteSteamAccountResponse`
        """
        model = DeleteSteamAccountResponse()
        if include_optional:
    ...
    def testDeleteSteamAccountResponse(self):
        """Test DeleteSteamAccountResponse"""
