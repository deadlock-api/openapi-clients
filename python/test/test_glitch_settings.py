...
class TestGlitchSettings(unittest.TestCase):
    """GlitchSettings unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GlitchSettings:
        """Test GlitchSettings
