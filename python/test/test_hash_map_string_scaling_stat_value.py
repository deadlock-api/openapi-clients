...
class TestHashMapStringScalingStatValue(unittest.TestCase):
    """HashMapStringScalingStatValue unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HashMapStringScalingStatValue:
        """Test HashMapStringScalingStatValue
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HashMapStringScalingStatValue`
        """
        model = HashMapStringScalingStatValue()
        if include_optional:
            return HashMapStringScalingStatValue(
                scale = 1.337,
                scaling_stat = ''
            )
        else:
    ...
    def testHashMapStringScalingStatValue(self):
        """Test HashMapStringScalingStatValue"""
