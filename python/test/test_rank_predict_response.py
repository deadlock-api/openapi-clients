...
class TestRankPredictResponse(unittest.TestCase):
    """RankPredictResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RankPredictResponse:
    ...
    def testRankPredictResponse(self):
        """Test RankPredictResponse"""
