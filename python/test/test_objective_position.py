...
class TestObjectivePosition(unittest.TestCase):
    """ObjectivePosition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ObjectivePosition:
        """Test ObjectivePosition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ObjectivePosition`
        """
        model = ObjectivePosition()
        if include_optional:
    ...
    def testObjectivePosition(self):
        """Test ObjectivePosition"""
