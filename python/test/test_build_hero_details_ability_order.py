...
class TestBuildHeroDetailsAbilityOrder(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BuildHeroDetailsAbilityOrder:
        """Test BuildHeroDetailsAbilityOrder
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BuildHeroDetailsAbilityOrder`
        """
        model = BuildHeroDetailsAbilityOrder()
        if include_optional:
    ...
    def testBuildHeroDetailsAbilityOrder(self):
        """Test BuildHeroDetailsAbilityOrder"""
