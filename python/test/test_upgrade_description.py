...
class TestUpgradeDescription(unittest.TestCase):
    """UpgradeDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradeDescription:
        """Test UpgradeDescription
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpgradeDescription`
        """
        model = UpgradeDescription()
        if include_optional:
    ...
    def testUpgradeDescription(self):
        """Test UpgradeDescription"""
