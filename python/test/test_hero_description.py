...
class TestHeroDescription(unittest.TestCase):
    """HeroDescription unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeroDescription:
