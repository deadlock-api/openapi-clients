...
class TestLaneMatchupStats(unittest.TestCase):
    """LaneMatchupStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LaneMatchupStats:
