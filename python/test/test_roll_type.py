...
class TestRollType(unittest.TestCase):
    """RollType unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RollType:
        """Test RollType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RollType`
        """
        model = RollType()
        if include_optional:
            return RollType(
