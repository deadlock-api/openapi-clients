...
class TestItemFlowSummary(unittest.TestCase):
    """ItemFlowSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ItemFlowSummary:
        """Test ItemFlowSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ItemFlowSummary`
        """
        model = ItemFlowSummary()
        if include_optional:
            return ItemFlowSummary(
