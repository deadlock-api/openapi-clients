...
class TestTooltipDetailsBlock(unittest.TestCase):
    """TooltipDetailsBlock unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TooltipDetailsBlock:
        """Test TooltipDetailsBlock
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TooltipDetailsBlock`
        """
        model = TooltipDetailsBlock()
        if include_optional:
            return TooltipDetailsBlock(
                loc_string = '',
                properties = [
    ...
    def testTooltipDetailsBlock(self):
        """Test TooltipDetailsBlock"""
