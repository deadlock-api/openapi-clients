...
class TestDemoQueryStatusResponse(unittest.TestCase):
    """DemoQueryStatusResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DemoQueryStatusResponse:
        """Test DemoQueryStatusResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemoQueryStatusResponse`
        """
        model = DemoQueryStatusResponse()
        if include_optional:
    ...
    def testDemoQueryStatusResponse(self):
        """Test DemoQueryStatusResponse"""
