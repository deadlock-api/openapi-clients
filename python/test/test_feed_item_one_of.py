...
class TestFeedItemOneOf(unittest.TestCase):
    """FeedItemOneOf unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FeedItemOneOf:
        """Test FeedItemOneOf
