...
class TestAccountRank(unittest.TestCase):
    """AccountRank unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AccountRank:
        """Test AccountRank
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AccountRank`
        """
        model = AccountRank()
        if include_optional:
            return AccountRank(
