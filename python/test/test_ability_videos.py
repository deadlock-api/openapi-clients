...
class TestAbilityVideos(unittest.TestCase):
    """AbilityVideos unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AbilityVideos:
        """Test AbilityVideos
