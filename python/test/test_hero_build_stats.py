...
class TestHeroBuildStats(unittest.TestCase):
    """HeroBuildStats unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeroBuildStats:
        """Test HeroBuildStats
