...
class TestUpgradeProperty(unittest.TestCase):
    """UpgradeProperty unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpgradeProperty:
