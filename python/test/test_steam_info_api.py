...
class TestSteamInfoApi(unittest.TestCase):
    """SteamInfoApi unit test stubs"""

    def setUp(self) -> None:
        self.api = SteamInfoApi()

    def tearDown(self) -> None:
        pass

    def test_get_all_steam_info(self) -> None:
        """Test case for get_all_steam_info

        Get All Steam Infos
        """
        pass

    def test_get_steam_info(self) -> None:
        """Test case for get_steam_info
