...
class TestRankPrediction(unittest.TestCase):
    """RankPrediction unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RankPrediction:
        """Test RankPrediction
