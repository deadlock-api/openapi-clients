...
class TestSteamAccountResponse(unittest.TestCase):
    """SteamAccountResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SteamAccountResponse:
        """Test SteamAccountResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SteamAccountResponse`
        """
        model = SteamAccountResponse()
        if include_optional:
    ...
    def testSteamAccountResponse(self):
        """Test SteamAccountResponse"""
