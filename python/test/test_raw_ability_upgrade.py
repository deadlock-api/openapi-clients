...
class TestRawAbilityUpgrade(unittest.TestCase):
    """RawAbilityUpgrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawAbilityUpgrade:
        """Test RawAbilityUpgrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RawAbilityUpgrade`
        """
        model = RawAbilityUpgrade()
        if include_optional:
            return RawAbilityUpgrade(
                property_upgrades = [
    ...
    def testRawAbilityUpgrade(self):
        """Test RawAbilityUpgrade"""
