...
class TestDemoQueryJobResponse(unittest.TestCase):
    """DemoQueryJobResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DemoQueryJobResponse:
        """Test DemoQueryJobResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DemoQueryJobResponse`
        """
        model = DemoQueryJobResponse()
        if include_optional:
    ...
    def testDemoQueryJobResponse(self):
        """Test DemoQueryJobResponse"""
