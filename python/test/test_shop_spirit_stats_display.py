...
class TestShopSpiritStatsDisplay(unittest.TestCase):
    """ShopSpiritStatsDisplay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShopSpiritStatsDisplay:
        """Test ShopSpiritStatsDisplay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ShopSpiritStatsDisplay`
        """
        model = ShopSpiritStatsDisplay()
        if include_optional:
            return ShopSpiritStatsDisplay(
                display_stats = [
                    ''
                    ]
            )
    ...
    def testShopSpiritStatsDisplay(self):
        """Test ShopSpiritStatsDisplay"""
