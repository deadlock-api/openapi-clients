...
class TestShopWeaponStatsDisplay(unittest.TestCase):
    """ShopWeaponStatsDisplay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShopWeaponStatsDisplay:
        ...
        """
        model = ShopWeaponStatsDisplay()
        if include_optional:
            return ShopWeaponStatsDisplay(
                display_stats = [
                    ''
                    ],
                other_display_stats = [
    ...
    def testShopWeaponStatsDisplay(self):
        """Test ShopWeaponStatsDisplay"""
