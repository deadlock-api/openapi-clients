...
class TestTableSchemaResponse(unittest.TestCase):
    """TableSchemaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TableSchemaResponse:
        """Test TableSchemaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TableSchemaResponse`
        """
        model = TableSchemaResponse()
        if include_optional:
    ...
    def testTableSchemaResponse(self):
        """Test TableSchemaResponse"""
