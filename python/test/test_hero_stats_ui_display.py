...
class TestHeroStatsUIDisplay(unittest.TestCase):
    """HeroStatsUIDisplay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HeroStatsUIDisplay:
        """Test HeroStatsUIDisplay
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HeroStatsUIDisplay`
        """
        model = HeroStatsUIDisplay()
        if include_optional:
            return HeroStatsUIDisplay(
                category = '',
                stat_type = ''
            )
        else:
    ...
    def testHeroStatsUIDisplay(self):
        """Test HeroStatsUIDisplay"""
