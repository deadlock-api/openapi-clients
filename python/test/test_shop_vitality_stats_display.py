...
class TestShopVitalityStatsDisplay(unittest.TestCase):
    """ShopVitalityStatsDisplay unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ShopVitalityStatsDisplay:
        ...
        """
        model = ShopVitalityStatsDisplay()
        if include_optional:
            return ShopVitalityStatsDisplay(
                display_stats = [
                    ''
                    ],
                other_display_stats = [
    ...
    def testShopVitalityStatsDisplay(self):
        """Test ShopVitalityStatsDisplay"""
