...
class TestRawWeaponInfoVerticalRecoil(unittest.TestCase):
    """RawWeaponInfoVerticalRecoil unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawWeaponInfoVerticalRecoil:
        ...
        """
        model = RawWeaponInfoVerticalRecoil()
        if include_optional:
            return RawWeaponInfoVerticalRecoil(
    ...
    def testRawWeaponInfoVerticalRecoil(self):
        """Test RawWeaponInfoVerticalRecoil"""
