...
class TestItemsApi(unittest.TestCase):
    ...
    def test_get_items_by_hero_id(self) -> None:
        """Test case for get_items_by_hero_id

        List Items By Hero
        """
        pass

    def test_get_items_by_slot_type(self) -> None:
        """Test case for get_items_by_slot_type
    ...
    def test_get_items_by_type(self) -> None:
        """Test case for get_items_by_type
