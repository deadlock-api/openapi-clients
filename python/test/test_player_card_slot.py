...
class TestPlayerCardSlot(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PlayerCardSlot:
        """Test PlayerCardSlot
        ...
        if include_optional:
            return PlayerCardSlot(
                hero = deadlock_api_client.models.player_card_slot_hero.PlayerCardSlotHero(
                    id = 0, 
                    kills = 0, 
                    wins = 0, ),
                slot_id = 0,
                stat = deadlock_api_client.models.player_card_slot_stat.PlayerCardSlotStat(
                    stat_id = 56, 
                    stat_score = 0, )
            )
        else:
