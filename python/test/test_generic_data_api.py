...
class TestGenericDataApi(unittest.TestCase):
    """GenericDataApi unit test stubs"""

    def setUp(self) -> None:
        self.api = GenericDataApi()

    def tearDown(self) -> None:
        pass

    def test_get_generic_data(self) -> None:
        """Test case for get_generic_data
