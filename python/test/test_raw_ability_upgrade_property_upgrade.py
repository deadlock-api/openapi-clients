...
class TestRawAbilityUpgradePropertyUpgrade(unittest.TestCase):
    """RawAbilityUpgradePropertyUpgrade unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RawAbilityUpgradePropertyUpgrade:
        """Test RawAbilityUpgradePropertyUpgrade
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RawAbilityUpgradePropertyUpgrade`
        """
        model = RawAbilityUpgradePropertyUpgrade()
        if include_optional:
    ...
    def testRawAbilityUpgradePropertyUpgrade(self):
        """Test RawAbilityUpgradePropertyUpgrade"""
