...
namespace AssetsDeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class SubclassBulletResistModifier : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubclassBulletResistModifier" /> class.
        /// </summary>
        /// <param name="subclass">subclass</param>
        [JsonConstructor]
        public SubclassBulletResistModifier(Option<BulletResistModifier?> subclass = default)
        {
        ...
        public Option<BulletResistModifier?> SubclassOption { get; private set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubclassBulletResistModifier {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="SubclassBulletResistModifier" />
    /// </summary>
    public class SubclassBulletResistModifierJsonConverter : JsonConverter<SubclassBulletResistModifier>
    {
        /// <summary>
        /// Deserializes json to <see cref="SubclassBulletResistModifier" />
        /// </summary>
        ...
        public override SubclassBulletResistModifier Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<BulletResistModifier?> subclass = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "subclass":
                            subclass = new Option<BulletResistModifier?>(JsonSerializer.Deserialize<BulletResistModifier>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            return new SubclassBulletResistModifier(subclass);
        }

        /// <summary>
        /// Serializes a <see cref="SubclassBulletResistModifier" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, SubclassBulletResistModifier subclassBulletResistModifier, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, subclassBulletResistModifier, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SubclassBulletResistModifier" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="subclassBulletResistModifier"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        {
            if (subclassBulletResistModifier.SubclassOption.IsSet && subclassBulletResistModifier.Subclass == null)
            ...
            if (subclassBulletResistModifier.SubclassOption.IsSet)
            {
