...
namespace AssetsDeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class SubclassTrooperDamageReduction : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SubclassTrooperDamageReduction" /> class.
        /// </summary>
        /// <param name="subclass">subclass</param>
        [JsonConstructor]
        public SubclassTrooperDamageReduction(Option<TrooperDamageReduction?> subclass = default)
        {
        ...
        public Option<TrooperDamageReduction?> SubclassOption { get; private set; }

        /// <summary>
        /// Gets or Sets Subclass
        /// </summary>
        [JsonPropertyName("subclass")]
        public TrooperDamageReduction? Subclass { get { return this.SubclassOption.Value; } set { this.SubclassOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class SubclassTrooperDamageReduction {\n");
    ...
    public class SubclassTrooperDamageReductionJsonConverter : JsonConverter<SubclassTrooperDamageReduction>
    {
        ...
        public override SubclassTrooperDamageReduction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<TrooperDamageReduction?> subclass = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "subclass":
                            subclass = new Option<TrooperDamageReduction?>(JsonSerializer.Deserialize<TrooperDamageReduction>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
            ...
            return new SubclassTrooperDamageReduction(subclass);
        }

        /// <summary>
        /// Serializes a <see cref="SubclassTrooperDamageReduction" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, SubclassTrooperDamageReduction subclassTrooperDamageReduction, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, subclassTrooperDamageReduction, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SubclassTrooperDamageReduction" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="subclassTrooperDamageReduction"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        {
            if (subclassTrooperDamageReduction.SubclassOption.IsSet && subclassTrooperDamageReduction.Subclass == null)
            ...
            if (subclassTrooperDamageReduction.SubclassOption.IsSet)
            {
