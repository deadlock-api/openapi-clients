...
namespace AssetsDeadlockApiClient.Model
{
    ...
    /// StreetBrawlValue
    /// </summary>
    public partial class StreetBrawlValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StreetBrawlValue" /> class.
        /// </summary>
        /// <param name="string"></param>
        /// <param name="decimal"></param>
        internal StreetBrawlValue(Option<string?> @string, Option<decimal?> @decimal)
        {
            StringOption = @string;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class StreetBrawlValue {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
    ...
    /// <summary>
    /// A Json converter for type <see cref="StreetBrawlValue" />
    /// </summary>
    public class StreetBrawlValueJsonConverter : JsonConverter<StreetBrawlValue>
    {
        /// <summary>
        /// Deserializes json to <see cref="StreetBrawlValue" />
        /// </summary>
        ...
        public override StreetBrawlValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new StreetBrawlValue(varStringParsedValue, varDecimalParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="StreetBrawlValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="streetBrawlValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, StreetBrawlValue streetBrawlValue, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (streetBrawlValue.StringOption.IsSet && streetBrawlValue.StringOption.Value != null)
                writer.WriteString("1", streetBrawlValue.StringOption.Value);

            if (streetBrawlValue.DecimalOption.IsSet && streetBrawlValue.DecimalOption.Value != null)
                writer.WriteNumber("1", streetBrawlValue.DecimalOption.Value.Value);

            WriteProperties(writer, streetBrawlValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="StreetBrawlValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="streetBrawlValue"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, StreetBrawlValue streetBrawlValue, JsonSerializerOptions jsonSerializerOptions)
        {
