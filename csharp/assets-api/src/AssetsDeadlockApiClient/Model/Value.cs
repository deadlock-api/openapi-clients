...
namespace AssetsDeadlockApiClient.Model
{
    ...
    public partial class Value : IValidatableObject
    {
        ...
        internal Value(Option<int?> @int, Option<decimal?> @decimal)
        {
            IntOption = @int;
    ...
    public class ValueJsonConverter : JsonConverter<Value>
    {
        ...
        public override Value Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Value(varIntParsedValue, varDecimalParsedValue);
        }
        ...
        public override void Write(Utf8JsonWriter writer, Value value, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (value.IntOption.IsSet && value.IntOption.Value != null)
                writer.WriteNumber("Value", value.IntOption.Value.Value);

            if (value.DecimalOption.IsSet && value.DecimalOption.Value != null)
                writer.WriteNumber("1", value.DecimalOption.Value.Value);
