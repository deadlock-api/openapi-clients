...
namespace AssetsDeadlockApiClient.Model
{
    ...
    /// Bonus
    /// </summary>
    public partial class Bonus : IValidatableObject
    {
        /// <summary>
        ...
        internal Bonus(Option<string?> @string, Option<decimal?> @decimal)
        {
            StringOption = @string;
    ...
    /// <summary>
    /// A Json converter for type <see cref="Bonus" />
    /// </summary>
    public class BonusJsonConverter : JsonConverter<Bonus>
    {
        /// <summary>
        /// Deserializes json to <see cref="Bonus" />
        /// </summary>
        ...
        public override Bonus Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            return new Bonus(varStringParsedValue, varDecimalParsedValue);
        }

        /// <summary>
        /// Serializes a <see cref="Bonus" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bonus"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, Bonus bonus, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            if (bonus.StringOption.IsSet && bonus.StringOption.Value != null)
                writer.WriteString("1", bonus.StringOption.Value);

            if (bonus.DecimalOption.IsSet && bonus.DecimalOption.Value != null)
                writer.WriteNumber("1", bonus.DecimalOption.Value.Value);

            WriteProperties(writer, bonus, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="Bonus" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="bonus"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, Bonus bonus, JsonSerializerOptions jsonSerializerOptions)
        {
