...
inputSpec: https://assets.deadlock-api.com/openapi.json
outputDir: out

# https://openapi-generator.tech/docs/generators/csharp
additionalProperties:
  packageGuid: '{72F3F5D0-2AF8-4F3B-906F-46DA1A1F2D4F}'
...
namespace YourProject
{
    public class Program
    {
        public static async Task Main(string[] args)
        {
            ...
            IGetAccoladeByNameV2AccoladesByNameNameGetApiResponse apiResponse = await api.GetAccoladeByNameV2AccoladesByNameNameGetAsync("todo");
            AccoladeV2? model = apiResponse.Ok();
        }
