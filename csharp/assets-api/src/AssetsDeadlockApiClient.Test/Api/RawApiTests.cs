...
{
    /// <summary>
    ///  Class for testing RawApi
    /// </summary>
    public sealed class RawApiTests : ApiTestsBase
    {
        private readonly IRawApi _instance;

        public RawApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IRawApi>();
        }

        /// <summary>
        /// Test GetRawAccoladesRawAccoladesGet
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetRawAccoladesRawAccoladesGetAsyncTest()
        {
        ...
        /// <summary>
        /// Test GetRawHeroesRawHeroesGet
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetRawHeroesRawHeroesGetAsyncTest()
        {
            Client.Option<DeadlockAssetsApiRoutesValidClientVersions?> clientVersion = default!;
        ...
        /// <summary>
        /// Test GetRawItemsRawItemsGet
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetRawItemsRawItemsGetAsyncTest()
        {
            Client.Option<DeadlockAssetsApiRoutesValidClientVersions?> clientVersion = default!;
