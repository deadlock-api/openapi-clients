...
{
    /// <summary>
    ///  Class for testing CustomMatchesApi
    /// </summary>
    public sealed class CustomMatchesApiTests : ApiTestsBase
    {
        private readonly ICustomMatchesApi _instance;

        public CustomMatchesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ICustomMatchesApi>();
        }
        ...
        public async Task CreateCustomAsyncTest()
        {
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetCustomAsyncTest()
        {
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ReadyUpAsyncTest()
        {
            string lobbyId = default!;
            await _instance.ReadyUpAsync(lobbyId);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task UnreadyAsyncTest()
        {
            string lobbyId = default!;
            await _instance.UnreadyAsync(lobbyId);
        }
    }
}
