...
namespace DeadlockApiClient.Test.Api
{
    ...
    /// </summary>
    public sealed class ServersApiTests : ApiTestsBase
    {
        private readonly IServersApi _instance;

        public ServersApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IServersApi>();
        }
