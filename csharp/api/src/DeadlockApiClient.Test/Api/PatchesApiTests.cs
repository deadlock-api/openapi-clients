...
{
    /// <summary>
    ///  Class for testing PatchesApi
    /// </summary>
    public sealed class PatchesApiTests : ApiTestsBase
    {
        private readonly IPatchesApi _instance;

        public PatchesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IPatchesApi>();
        }
        ...
        public async Task BigPatchDaysAsyncTest()
        {
            var response = await _instance.BigPatchDaysAsync();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task FeedAsyncTest()
        {
            var response = await _instance.FeedAsync();
            var model = response.Ok();
