...
{
    /// <summary>
    ///  Class for testing SteamApi
    /// </summary>
    public sealed class SteamApiTests : ApiTestsBase
    {
        private readonly ISteamApi _instance;

        public SteamApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISteamApi>();
        }
