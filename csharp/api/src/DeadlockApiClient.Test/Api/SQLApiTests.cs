...
namespace DeadlockApiClient.Test.Api
{
    ...
    /// </summary>
    public sealed class SQLApiTests : ApiTestsBase
    {
        private readonly ISQLApi _instance;

        public SQLApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISQLApi>();
        }
        ...
        public async Task ListTablesAsyncTest()
        {
            var response = await _instance.ListTablesAsync();
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task TableSchemaAsyncTest()
        {
            string table = default!;
            var response = await _instance.TableSchemaAsync(table);
            var model = response.Ok();
