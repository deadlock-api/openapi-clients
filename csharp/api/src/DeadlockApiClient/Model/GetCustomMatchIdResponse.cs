...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class GetCustomMatchIdResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GetCustomMatchIdResponse" /> class.
        /// </summary>
        /// <param name="matchId">matchId</param>
        [JsonConstructor]
        public GetCustomMatchIdResponse(long matchId)
        {
            MatchId = matchId;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class GetCustomMatchIdResponse {\n");
    ...
    public class GetCustomMatchIdResponseJsonConverter : JsonConverter<GetCustomMatchIdResponse>
    {
        ...
        public override GetCustomMatchIdResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="GetCustomMatchIdResponse" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, GetCustomMatchIdResponse getCustomMatchIdResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, getCustomMatchIdResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="GetCustomMatchIdResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="getCustomMatchIdResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
