...
{
    /// <summary>
    ///  Class for testing SteamInfoApi
    /// </summary>
    public sealed class SteamInfoApiTests : ApiTestsBase
    {
        private readonly ISteamInfoApi _instance;

        public SteamInfoApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ISteamInfoApi>();
        }

        /// <summary>
        /// Test GetAllSteamInfo
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetAllSteamInfoAsyncTest()
        {
            var response = await _instance.GetAllSteamInfoAsync();
            var model = response.Ok();
            Assert.IsType<List<SteamInfo>>(model);
        }
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task GetSteamInfoAsyncTest()
        {
