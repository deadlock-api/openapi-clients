...
{
    /// <summary>
    ///  Class for testing GraphQLApi
    /// </summary>
    public sealed class GraphQLApiTests : ApiTestsBase
    {
        private readonly IGraphQLApi _instance;

        public GraphQLApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IGraphQLApi>();
        }
        ...
        public async Task PlaygroundAsyncTest()
        {
            await _instance.PlaygroundAsync();
        }
    }
}
