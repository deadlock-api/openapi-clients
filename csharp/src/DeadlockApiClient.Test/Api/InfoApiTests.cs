...
namespace DeadlockApiClient.Test.Api
{
    ...
    /// </summary>
    public sealed class InfoApiTests : ApiTestsBase
    {
        private readonly IInfoApi _instance;

        public InfoApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IInfoApi>();
        }
