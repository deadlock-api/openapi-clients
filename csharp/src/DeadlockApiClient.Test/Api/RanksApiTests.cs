...
{
    /// <summary>
    ///  Class for testing RanksApi
    /// </summary>
    public sealed class RanksApiTests : ApiTestsBase
    {
        private readonly IRanksApi _instance;

        public RanksApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IRanksApi>();
        }
        ...
        public async Task GetRankAsyncTest()
        {
            int tier = default!;
        ...
        /// </summary>
        [Fact (Skip = "not implemented")]
        public async Task ListRanksAsyncTest()
        {
            Client.Option<string?> language = default!;
            Client.Option<int?> clientVersion = default!;
