...
{
    /// <summary>
    ///  Class for testing DemoApi
    /// </summary>
    public sealed class DemoApiTests : ApiTestsBase
    {
        private readonly IDemoApi _instance;

        public DemoApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IDemoApi>();
        }
        ...
        public async Task SchemaAsyncTest()
        {
