...
{
    /// <summary>
    ///  Class for testing GenericDataApi
    /// </summary>
    public sealed class GenericDataApiTests : ApiTestsBase
    {
        private readonly IGenericDataApi _instance;

        public GenericDataApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<IGenericDataApi>();
        }
        ...
        public async Task GetGenericDataAsyncTest()
        {
            ...
            Assert.IsType<GenericData>(model);
        }
    }
}
