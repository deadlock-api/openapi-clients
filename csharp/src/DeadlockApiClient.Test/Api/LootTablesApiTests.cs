...
{
    /// <summary>
    ///  Class for testing LootTablesApi
    /// </summary>
    public sealed class LootTablesApiTests : ApiTestsBase
    {
        private readonly ILootTablesApi _instance;

        public LootTablesApiTests(): base(Array.Empty<string>())
        {
            _instance = _host.Services.GetRequiredService<ILootTablesApi>();
        }
        ...
        public async Task ListLootTablesAsyncTest()
        {
