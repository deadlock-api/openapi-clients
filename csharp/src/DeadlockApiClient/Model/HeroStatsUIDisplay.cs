...
namespace DeadlockApiClient.Model
{
    ...
    /// HeroStatsUIDisplay
    /// </summary>
    public partial class HeroStatsUIDisplay : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HeroStatsUIDisplay" /> class.
        /// </summary>
        /// <param name="category">category</param>
        /// <param name="statType">statType</param>
        [JsonConstructor]
        public HeroStatsUIDisplay(string category, string statType)
        {
            Category = category;
            StatType = statType;
            OnCreated();
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HeroStatsUIDisplay {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="HeroStatsUIDisplay" />
    /// </summary>
    public partial class HeroStatsUIDisplayJsonConverter : JsonConverter<HeroStatsUIDisplay>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="HeroStatsUIDisplayJsonConverter" /> class.
        /// </summary>
        public HeroStatsUIDisplayJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="HeroStatsUIDisplay" />
        /// </summary>
        ...
        public override HeroStatsUIDisplay Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="HeroStatsUIDisplay" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, HeroStatsUIDisplay heroStatsUIDisplay, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, heroStatsUIDisplay, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="HeroStatsUIDisplay" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="heroStatsUIDisplay"></param>
        /// <param name="jsonSerializerOptions"></param>
