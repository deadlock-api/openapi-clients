...
namespace DeadlockApiClient.Model
{
    ...
    public partial class AnalyticsGameStats : IValidatableObject
    {
        ...
        /// <summary>
        /// Gets or Sets AvgFirstObjectiveDestroyedTimeS
        /// </summary>
        [JsonPropertyName("avg_first_objective_destroyed_time_s")]
    ...
    /// </summary>
    public partial class AnalyticsGameStatsJsonConverter : JsonConverter<AnalyticsGameStats>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="AnalyticsGameStatsJsonConverter" /> class.
        /// </summary>
        public AnalyticsGameStatsJsonConverter()
        {
            OnCreated();
        }
