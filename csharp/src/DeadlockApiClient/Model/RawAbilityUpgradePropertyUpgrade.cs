...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class RawAbilityUpgradePropertyUpgrade : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RawAbilityUpgradePropertyUpgrade" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="RawAbilityUpgradePropertyUpgrade" />
    /// </summary>
    public partial class RawAbilityUpgradePropertyUpgradeJsonConverter : JsonConverter<RawAbilityUpgradePropertyUpgrade>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RawAbilityUpgradePropertyUpgradeJsonConverter" /> class.
        /// </summary>
        public RawAbilityUpgradePropertyUpgradeJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="RawAbilityUpgradePropertyUpgrade" />
        /// </summary>
        ...
        public override RawAbilityUpgradePropertyUpgrade Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "bonus":
                            bonus = new Option<string?>(utf8JsonReader.GetString()!);
                            break;
                        case "name":
        ...
        /// <summary>
        /// Serializes a <see cref="RawAbilityUpgradePropertyUpgrade" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, RawAbilityUpgradePropertyUpgrade rawAbilityUpgradePropertyUpgrade, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, rawAbilityUpgradePropertyUpgrade, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RawAbilityUpgradePropertyUpgrade" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rawAbilityUpgradePropertyUpgrade"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, RawAbilityUpgradePropertyUpgrade rawAbilityUpgradePropertyUpgrade, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (rawAbilityUpgradePropertyUpgrade.ScaleStatFilterOption.IsSet)
                if (rawAbilityUpgradePropertyUpgrade.ScaleStatFilterOption.Value != null)
                    writer.WriteString("scale_stat_filter", rawAbilityUpgradePropertyUpgrade.ScaleStatFilter);
                else
                    writer.WriteNull("scale_stat_filter");

            if (rawAbilityUpgradePropertyUpgrade.UpgradeTypeOption.IsSet)
                if (rawAbilityUpgradePropertyUpgrade.UpgradeTypeOption.Value != null)
                    writer.WriteString("upgrade_type", rawAbilityUpgradePropertyUpgrade.UpgradeType);
                else
