...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class ShopWeaponStatsDisplay : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShopWeaponStatsDisplay" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public ShopWeaponStatsDisplay(List<string> displayStats, List<string> otherDisplayStats, Option<List<string>?> weaponAttributes = default, Option<string?> weaponImage = default, Option<string?> weaponImageWebp = default)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShopWeaponStatsDisplay {\n");
    ...
    public class ShopWeaponStatsDisplayJsonConverter : JsonConverter<ShopWeaponStatsDisplay>
    {
        ...
        public override ShopWeaponStatsDisplay Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ShopWeaponStatsDisplay" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ShopWeaponStatsDisplay shopWeaponStatsDisplay, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, shopWeaponStatsDisplay, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShopWeaponStatsDisplay" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shopWeaponStatsDisplay"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ShopWeaponStatsDisplay shopWeaponStatsDisplay, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            JsonSerializer.Serialize(writer, shopWeaponStatsDisplay.OtherDisplayStats, jsonSerializerOptions);
            if (shopWeaponStatsDisplay.WeaponAttributesOption.IsSet)
                if (shopWeaponStatsDisplay.WeaponAttributesOption.Value != null)
                {
                    writer.WritePropertyName("weapon_attributes");
                    JsonSerializer.Serialize(writer, shopWeaponStatsDisplay.WeaponAttributes, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("weapon_attributes");
            if (shopWeaponStatsDisplay.WeaponImageOption.IsSet)
                if (shopWeaponStatsDisplay.WeaponImageOption.Value != null)
                    writer.WriteString("weapon_image", shopWeaponStatsDisplay.WeaponImage);
                else
                    writer.WriteNull("weapon_image");

            if (shopWeaponStatsDisplay.WeaponImageWebpOption.IsSet)
                if (shopWeaponStatsDisplay.WeaponImageWebpOption.Value != null)
                    writer.WriteString("weapon_image_webp", shopWeaponStatsDisplay.WeaponImageWebp);
                else
