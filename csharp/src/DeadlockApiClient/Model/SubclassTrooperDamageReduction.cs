...
namespace DeadlockApiClient.Model
{
    ...
    public partial class SubclassTrooperDamageReduction : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SubclassTrooperDamageReduction(SubclassTrooperDamageReductionSubclass subclass)
        {
            Subclass = subclass;
            OnCreated();
        }
        ...
        public SubclassTrooperDamageReductionSubclass Subclass { get; set; }
    ...
    public partial class SubclassTrooperDamageReductionJsonConverter : JsonConverter<SubclassTrooperDamageReduction>
    {
        ...
        public override SubclassTrooperDamageReduction Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SubclassTrooperDamageReductionSubclass?> subclass = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "subclass":
                            subclass = new Option<SubclassTrooperDamageReductionSubclass?>(JsonSerializer.Deserialize<SubclassTrooperDamageReductionSubclass>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
