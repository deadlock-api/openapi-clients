...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class RankDistributionEntry : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RankDistributionEntry" /> class.
        /// </summary>
        /// <param name="badge">Rank badge, &#x60;tier * 10 + subrank&#x60;. See more: &lt;https://api.deadlock-api.com/v1/assets/ranks&gt;</param>
        /// <param name="players">Number of players whose rank at the end of their latest ranked match in the filtered range is this badge.</param>
        /// <param name="rank">Rank tier.</param>
        /// <param name="subrank">Sub-rank within the tier.</param>
        [JsonConstructor]
        public RankDistributionEntry(int badge, long players, int rank, int subrank)
        {
            Badge = badge;
            Players = players;
            Rank = rank;
        ...
        /// </summary>
        /// <value>Rank badge, &#x60;tier * 10 + subrank&#x60;. See more: &lt;https://api.deadlock-api.com/v1/assets/ranks&gt;</value>
        ...
        /// </summary>
        /// <value>Number of players whose rank at the end of their latest ranked match in the filtered range is this badge.</value>
        ...
        /// </summary>
        /// <value>Sub-rank within the tier.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RankDistributionEntry {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="RankDistributionEntry" />
    /// </summary>
    public partial class RankDistributionEntryJsonConverter : JsonConverter<RankDistributionEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RankDistributionEntryJsonConverter" /> class.
        /// </summary>
        public RankDistributionEntryJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="RankDistributionEntry" />
        /// </summary>
        ...
        public override RankDistributionEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="RankDistributionEntry" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, RankDistributionEntry rankDistributionEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, rankDistributionEntry, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RankDistributionEntry" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rankDistributionEntry"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, RankDistributionEntry rankDistributionEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("players", rankDistributionEntry.Players);

            writer.WriteNumber("rank", rankDistributionEntry.Rank);

            writer.WriteNumber("subrank", rankDistributionEntry.Subrank);
        }
    }
}
