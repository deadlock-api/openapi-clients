...
namespace DeadlockApiClient.Model
{
    ...
    public partial class MiniMapOffsets : IValidatableObject
    {
        ...
        [JsonConstructor]
        public MiniMapOffsets(string entityClass, List<double> offset2d, Option<long?> laneIndex = default)
        {
        ...
        public List<double> Offset2d { get; set; }
        ...
        public Option<long?> LaneIndexOption { get; private set; }

        /// <summary>
        /// Gets or Sets LaneIndex
        /// </summary>
        [JsonPropertyName("lane_index")]
        public long? LaneIndex { get { return this.LaneIndexOption.Value; } set { this.LaneIndexOption = new(value); } }
    ...
    public partial class MiniMapOffsetsJsonConverter : JsonConverter<MiniMapOffsets>
    {
        ...
        public override MiniMapOffsets Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<double>?> offset2d = default;
            Option<long?> laneIndex = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "entity_class":
                            ...
                            break;
                        case "offset_2d":
                            offset2d = new Option<List<double>?>(JsonSerializer.Deserialize<List<double>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "lane_index":
                            laneIndex = new Option<long?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (long?)null : utf8JsonReader.GetInt64());
                            break;
                        default:
                            break;
                    }
