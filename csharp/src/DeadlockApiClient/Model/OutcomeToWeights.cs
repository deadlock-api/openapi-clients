...
namespace DeadlockApiClient.Model
{
    ...
    public partial class OutcomeToWeights : IValidatableObject
    {
        ...
        [JsonConstructor]
        public OutcomeToWeights(Dictionary<string, double> outcomesToWeights)
        {
        ...
        public Dictionary<string, double> OutcomesToWeights { get; set; }
    ...
    public class OutcomeToWeightsJsonConverter : JsonConverter<OutcomeToWeights>
    {
        ...
        public override OutcomeToWeights Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<Dictionary<string, double>?> outcomesToWeights = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "outcomes_to_weights":
                            outcomesToWeights = new Option<Dictionary<string, double>?>(JsonSerializer.Deserialize<Dictionary<string, double>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
