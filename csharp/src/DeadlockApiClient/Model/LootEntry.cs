...
namespace DeadlockApiClient.Model
{
    ...
    /// LootEntry
    /// </summary>
    public partial class LootEntry : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="LootEntry" />
    /// </summary>
    public partial class LootEntryJsonConverter : JsonConverter<LootEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="LootEntryJsonConverter" /> class.
        /// </summary>
        public LootEntryJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="LootEntry" />
        /// </summary>
        ...
        public override LootEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="LootEntry" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, LootEntry lootEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, lootEntry, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LootEntry" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="lootEntry"></param>
        /// <param name="jsonSerializerOptions"></param>
