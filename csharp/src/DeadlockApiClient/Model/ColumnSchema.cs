...
namespace DeadlockApiClient.Model
{
    ...
    /// ColumnSchema
    /// </summary>
    public partial class ColumnSchema : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ColumnSchema" /> class.
        /// </summary>
        /// <param name="dataType">Arrow data type, rendered as its canonical textual form (e.g. &#x60;Int32&#x60;, &#x60;Utf8&#x60;).</param>
        /// <param name="name">name</param>
        /// <param name="nullable">nullable</param>
        [JsonConstructor]
        public ColumnSchema(string dataType, string name, bool nullable)
        {
            DataType = dataType;
            Name = name;
            Nullable = nullable;
        ...
        /// </summary>
        /// <value>Arrow data type, rendered as its canonical textual form (e.g. &#x60;Int32&#x60;, &#x60;Utf8&#x60;).</value>
    ...
    public class ColumnSchemaJsonConverter : JsonConverter<ColumnSchema>
    {
        ...
        public override ColumnSchema Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ColumnSchema" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ColumnSchema columnSchema, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, columnSchema, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ColumnSchema" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="columnSchema"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ColumnSchema columnSchema, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteBoolean("nullable", columnSchema.Nullable);
        }
    }
}
