...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class HeroStatsJsonConverter : JsonConverter<HeroStats>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="HeroStatsJsonConverter" /> class.
        /// </summary>
        public HeroStatsJsonConverter()
        {
            OnCreated();
        }
