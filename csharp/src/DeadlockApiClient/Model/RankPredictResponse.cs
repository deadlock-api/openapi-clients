...
namespace DeadlockApiClient.Model
{
    ...
    /// RankPredictResponse
    /// </summary>
    public partial class RankPredictResponse : IValidatableObject
    {
        /// <summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="RankPredictResponse" />
    /// </summary>
    public partial class RankPredictResponseJsonConverter : JsonConverter<RankPredictResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RankPredictResponseJsonConverter" /> class.
        /// </summary>
        public RankPredictResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="RankPredictResponse" />
        /// </summary>
        ...
        public override RankPredictResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="RankPredictResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rankPredictResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public override void Write(Utf8JsonWriter writer, RankPredictResponse rankPredictResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            writer.WriteStartObject();

            WriteProperties(writer, rankPredictResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RankPredictResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rankPredictResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
        /// <exception cref="NotImplementedException"></exception>
        public void WriteProperties(Utf8JsonWriter writer, RankPredictResponse rankPredictResponse, JsonSerializerOptions jsonSerializerOptions)
        {
