...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class MateStatsJsonConverter : JsonConverter<MateStats>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="MateStatsJsonConverter" /> class.
        /// </summary>
        public MateStatsJsonConverter()
        {
            OnCreated();
        }
