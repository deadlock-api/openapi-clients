...
namespace DeadlockApiClient.Model
{
    ...
    public partial class SubclassObjectiveRegen : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SubclassObjectiveRegen(SubclassObjectiveRegenSubclass subclass)
        {
            Subclass = subclass;
            OnCreated();
        }
        ...
        public SubclassObjectiveRegenSubclass Subclass { get; set; }
    ...
    /// </summary>
    public partial class SubclassObjectiveRegenJsonConverter : JsonConverter<SubclassObjectiveRegen>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="SubclassObjectiveRegenJsonConverter" /> class.
        /// </summary>
        public SubclassObjectiveRegenJsonConverter()
        {
            OnCreated();
        }
        ...
        public override SubclassObjectiveRegen Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SubclassObjectiveRegenSubclass?> subclass = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "subclass":
                            subclass = new Option<SubclassObjectiveRegenSubclass?>(JsonSerializer.Deserialize<SubclassObjectiveRegenSubclass>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
