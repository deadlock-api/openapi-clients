...
namespace DeadlockApiClient.Model
{
    ...
    /// PlayerEntry
    /// </summary>
    public partial class PlayerEntry : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerEntry" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerEntry" />
    /// </summary>
    public partial class PlayerEntryJsonConverter : JsonConverter<PlayerEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerEntryJsonConverter" /> class.
        /// </summary>
        public PlayerEntryJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="PlayerEntry" />
        /// </summary>
        ...
        public override PlayerEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="PlayerEntry" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, PlayerEntry playerEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerEntry, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerEntry" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerEntry"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, PlayerEntry playerEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("matches", playerEntry.Matches);
