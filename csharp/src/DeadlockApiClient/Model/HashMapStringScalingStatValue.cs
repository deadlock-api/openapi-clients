...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class HashMapStringScalingStatValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HashMapStringScalingStatValue" /> class.
        /// </summary>
        /// <param name="scale">scale</param>
        /// <param name="scalingStat">scalingStat</param>
        [JsonConstructor]
        public HashMapStringScalingStatValue(double scale, string scalingStat)
        {
            Scale = scale;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HashMapStringScalingStatValue {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="HashMapStringScalingStatValue" />
    /// </summary>
    public partial class HashMapStringScalingStatValueJsonConverter : JsonConverter<HashMapStringScalingStatValue>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="HashMapStringScalingStatValueJsonConverter" /> class.
        /// </summary>
        public HashMapStringScalingStatValueJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="HashMapStringScalingStatValue" />
        /// </summary>
        ...
        public override HashMapStringScalingStatValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "scale":
                            scale = new Option<double?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (double?)null : utf8JsonReader.GetDouble());
                            break;
                        case "scaling_stat":
        ...
        /// <summary>
        /// Serializes a <see cref="HashMapStringScalingStatValue" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, HashMapStringScalingStatValue hashMapStringScalingStatValue, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, hashMapStringScalingStatValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="HashMapStringScalingStatValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="hashMapStringScalingStatValue"></param>
        /// <param name="jsonSerializerOptions"></param>
