...
namespace DeadlockApiClient.Model
{
    ...
    /// MatchPlayer
    /// </summary>
    public partial class MatchPlayer : IValidatableObject
    {
        /// <summary>
        ...
        [JsonConstructor]
        public MatchPlayer(int accountId)
        {
            AccountId = accountId;
            OnCreated();
        }
    ...
    public partial class MatchPlayerJsonConverter : JsonConverter<MatchPlayer>
    {
        ...
        public override MatchPlayer Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="MatchPlayer" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, MatchPlayer matchPlayer, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, matchPlayer, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="MatchPlayer" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="matchPlayer"></param>
        /// <param name="jsonSerializerOptions"></param>
