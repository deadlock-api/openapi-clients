...
namespace DeadlockApiClient.Model
{
    ...
    /// HeroEntry
    /// </summary>
    public partial class HeroEntry : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HeroEntry" /> class.
        /// </summary>
    ...
    /// <summary>
    /// A Json converter for type <see cref="HeroEntry" />
    /// </summary>
    public partial class HeroEntryJsonConverter : JsonConverter<HeroEntry>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="HeroEntryJsonConverter" /> class.
        /// </summary>
        public HeroEntryJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="HeroEntry" />
        /// </summary>
        ...
        public override HeroEntry Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="HeroEntry" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, HeroEntry heroEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, heroEntry, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="HeroEntry" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="heroEntry"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, HeroEntry heroEntry, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("matches", heroEntry.Matches);

            writer.WriteNumber("rank", heroEntry.Rank);

            writer.WriteNumber("value", heroEntry.Value);
        }
    }
}
