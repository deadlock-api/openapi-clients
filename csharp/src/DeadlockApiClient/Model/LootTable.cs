...
namespace DeadlockApiClient.Model
{
    ...
    /// LootTable
    /// </summary>
    public partial class LootTable : IValidatableObject
    {
        /// <summary>
    ...
    public class LootTableJsonConverter : JsonConverter<LootTable>
    {
        ...
        public override LootTable Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<LootEntry>?> entries = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "entries":
                            entries = new Option<List<LootEntry>?>(JsonSerializer.Deserialize<List<LootEntry>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
        ...
        /// <summary>
        /// Serializes a <see cref="LootTable" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, LootTable lootTable, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, lootTable, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LootTable" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="lootTable"></param>
        /// <param name="jsonSerializerOptions"></param>
