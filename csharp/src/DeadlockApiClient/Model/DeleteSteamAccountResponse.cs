...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class DeleteSteamAccountResponse : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSteamAccountResponse" /> class.
        /// </summary>
        /// <param name="message">message</param>
        [JsonConstructor]
        public DeleteSteamAccountResponse(string message)
        {
            Message = message;
            OnCreated();
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DeleteSteamAccountResponse {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="DeleteSteamAccountResponse" />
    /// </summary>
    public partial class DeleteSteamAccountResponseJsonConverter : JsonConverter<DeleteSteamAccountResponse>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="DeleteSteamAccountResponseJsonConverter" /> class.
        /// </summary>
        public DeleteSteamAccountResponseJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="DeleteSteamAccountResponse" />
        /// </summary>
        ...
        public override DeleteSteamAccountResponse Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="DeleteSteamAccountResponse" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, DeleteSteamAccountResponse deleteSteamAccountResponse, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, deleteSteamAccountResponse, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="DeleteSteamAccountResponse" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="deleteSteamAccountResponse"></param>
        /// <param name="jsonSerializerOptions"></param>
