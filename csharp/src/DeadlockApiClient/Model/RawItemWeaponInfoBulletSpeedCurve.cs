...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class RawItemWeaponInfoBulletSpeedCurve : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RawItemWeaponInfoBulletSpeedCurve" /> class.
        /// </summary>
        /// <param name="domainMaxs">domainMaxs</param>
        /// <param name="domainMins">domainMins</param>
        /// <param name="spline">spline</param>
        [JsonConstructor]
        public RawItemWeaponInfoBulletSpeedCurve(List<double> domainMaxs, List<double> domainMins, Option<List<RawItemWeaponInfoBulletSpeedCurveSpline>?> spline = default)
        {
        ...
        public List<double> DomainMaxs { get; set; }

        /// <summary>
        /// Gets or Sets DomainMins
        /// </summary>
        [JsonPropertyName("domain_mins")]
        public List<double> DomainMins { get; set; }
        ...
        public Option<List<RawItemWeaponInfoBulletSpeedCurveSpline>?> SplineOption { get; private set; }

        /// <summary>
        /// Gets or Sets Spline
        /// </summary>
        [JsonPropertyName("spline")]
        public List<RawItemWeaponInfoBulletSpeedCurveSpline>? Spline { get { return this.SplineOption.Value; } set { this.SplineOption = new(value); } }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RawItemWeaponInfoBulletSpeedCurve {\n");
    ...
    public partial class RawItemWeaponInfoBulletSpeedCurveJsonConverter : JsonConverter<RawItemWeaponInfoBulletSpeedCurve>
    {
        ...
        public override RawItemWeaponInfoBulletSpeedCurve Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<double>?> domainMaxs = default;
            Option<List<double>?> domainMins = default;
            Option<List<RawItemWeaponInfoBulletSpeedCurveSpline>?> spline = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "domain_maxs":
                            domainMaxs = new Option<List<double>?>(JsonSerializer.Deserialize<List<double>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "domain_mins":
                            domainMins = new Option<List<double>?>(JsonSerializer.Deserialize<List<double>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        case "spline":
                            spline = new Option<List<RawItemWeaponInfoBulletSpeedCurveSpline>?>(JsonSerializer.Deserialize<List<RawItemWeaponInfoBulletSpeedCurveSpline>>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
        ...
        /// <summary>
        /// Serializes a <see cref="RawItemWeaponInfoBulletSpeedCurve" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, RawItemWeaponInfoBulletSpeedCurve rawItemWeaponInfoBulletSpeedCurve, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, rawItemWeaponInfoBulletSpeedCurve, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RawItemWeaponInfoBulletSpeedCurve" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rawItemWeaponInfoBulletSpeedCurve"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, RawItemWeaponInfoBulletSpeedCurve rawItemWeaponInfoBulletSpeedCurve, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            JsonSerializer.Serialize(writer, rawItemWeaponInfoBulletSpeedCurve.DomainMins, jsonSerializerOptions);
            if (rawItemWeaponInfoBulletSpeedCurve.SplineOption.IsSet)
                if (rawItemWeaponInfoBulletSpeedCurve.SplineOption.Value != null)
                {
                    writer.WritePropertyName("spline");
                    JsonSerializer.Serialize(writer, rawItemWeaponInfoBulletSpeedCurve.Spline, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("spline");
        }
    }
}
