...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class ShopVitalityStatsDisplay : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShopVitalityStatsDisplay" /> class.
        /// </summary>
        /// <param name="displayStats">displayStats</param>
        /// <param name="otherDisplayStats">otherDisplayStats</param>
        [JsonConstructor]
        public ShopVitalityStatsDisplay(List<string> displayStats, List<string> otherDisplayStats)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShopVitalityStatsDisplay {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShopVitalityStatsDisplay" />
    /// </summary>
    public partial class ShopVitalityStatsDisplayJsonConverter : JsonConverter<ShopVitalityStatsDisplay>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ShopVitalityStatsDisplayJsonConverter" /> class.
        /// </summary>
        public ShopVitalityStatsDisplayJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="ShopVitalityStatsDisplay" />
        /// </summary>
        ...
        public override ShopVitalityStatsDisplay Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ShopVitalityStatsDisplay" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ShopVitalityStatsDisplay shopVitalityStatsDisplay, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, shopVitalityStatsDisplay, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShopVitalityStatsDisplay" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shopVitalityStatsDisplay"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, ShopVitalityStatsDisplay shopVitalityStatsDisplay, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            JsonSerializer.Serialize(writer, shopVitalityStatsDisplay.OtherDisplayStats, jsonSerializerOptions);
        }
    }
}
