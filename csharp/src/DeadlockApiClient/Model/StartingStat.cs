...
namespace DeadlockApiClient.Model
{
    ...
    /// StartingStat
    /// </summary>
    public partial class StartingStat : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StartingStat" /> class.
        /// </summary>
        /// <param name="displayStatName">displayStatName</param>
        /// <param name="value">value</param>
        [JsonConstructor]
        public StartingStat(string displayStatName, double value)
        {
    ...
    /// <summary>
    /// A Json converter for type <see cref="StartingStat" />
    /// </summary>
    public partial class StartingStatJsonConverter : JsonConverter<StartingStat>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="StartingStatJsonConverter" /> class.
        /// </summary>
        public StartingStatJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="StartingStat" />
        /// </summary>
        ...
        public override StartingStat Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="StartingStat" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, StartingStat startingStat, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, startingStat, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="StartingStat" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="startingStat"></param>
        /// <param name="jsonSerializerOptions"></param>
