...
namespace DeadlockApiClient.Model
{
    ...
    /// SteamNews
    /// </summary>
    public partial class SteamNews : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SteamNews" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public SteamNews(string content, PatchGuid guid, string link, DateTime pubDate, string title)
        {
            Content = content;
            Guid = guid;
            Link = link;
    ...
    public partial class SteamNewsJsonConverter : JsonConverter<SteamNews>
    {
        ...
        public override SteamNews Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="SteamNews" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, SteamNews steamNews, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, steamNews, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SteamNews" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="steamNews"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, SteamNews steamNews, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            JsonSerializer.Serialize(writer, steamNews.Guid, jsonSerializerOptions);
            writer.WriteString("link", steamNews.Link);

            writer.WriteString("pub_date", steamNews.PubDate.ToString(PubDateFormat));

            writer.WriteString("title", steamNews.Title);
        }
    }
}
