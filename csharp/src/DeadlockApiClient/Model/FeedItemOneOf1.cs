...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public class FeedItemOneOf1JsonConverter : JsonConverter<FeedItemOneOf1>
    {
        /// <summary>
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "source":
                            ...
                            if (sourceRawValue != null)
                                source = new Option<FeedItemOneOf1.SourceEnum?>(FeedItemOneOf1.SourceEnumFromStringOrDefault(sourceRawValue));
                            break;
                        default:
                            break;
                    }
