...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class RawItemWeaponInfoBulletSpeedCurveSpline : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RawItemWeaponInfoBulletSpeedCurveSpline" /> class.
        /// </summary>
        ...
        [JsonConstructor]
        public RawItemWeaponInfoBulletSpeedCurveSpline(double slopeIncoming, double slopeOutgoing, double x, double y)
        {
        ...
        public double SlopeIncoming { get; set; }

        /// <summary>
        /// Gets or Sets SlopeOutgoing
        /// </summary>
        [JsonPropertyName("slope_outgoing")]
        public double SlopeOutgoing { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RawItemWeaponInfoBulletSpeedCurveSpline {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="RawItemWeaponInfoBulletSpeedCurveSpline" />
    /// </summary>
    public partial class RawItemWeaponInfoBulletSpeedCurveSplineJsonConverter : JsonConverter<RawItemWeaponInfoBulletSpeedCurveSpline>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="RawItemWeaponInfoBulletSpeedCurveSplineJsonConverter" /> class.
        /// </summary>
        public RawItemWeaponInfoBulletSpeedCurveSplineJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="RawItemWeaponInfoBulletSpeedCurveSpline" />
        /// </summary>
        ...
        public override RawItemWeaponInfoBulletSpeedCurveSpline Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<double?> slopeIncoming = default;
            Option<double?> slopeOutgoing = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "slope_incoming":
                            slopeIncoming = new Option<double?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (double?)null : utf8JsonReader.GetDouble());
                            break;
                        case "slope_outgoing":
                            slopeOutgoing = new Option<double?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (double?)null : utf8JsonReader.GetDouble());
                            break;
                        case "x":
        ...
        /// <summary>
        /// Serializes a <see cref="RawItemWeaponInfoBulletSpeedCurveSpline" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, RawItemWeaponInfoBulletSpeedCurveSpline rawItemWeaponInfoBulletSpeedCurveSpline, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, rawItemWeaponInfoBulletSpeedCurveSpline, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="RawItemWeaponInfoBulletSpeedCurveSpline" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="rawItemWeaponInfoBulletSpeedCurveSpline"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, RawItemWeaponInfoBulletSpeedCurveSpline rawItemWeaponInfoBulletSpeedCurveSpline, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteNumber("slope_outgoing", rawItemWeaponInfoBulletSpeedCurveSpline.SlopeOutgoing);

            writer.WriteNumber("x", rawItemWeaponInfoBulletSpeedCurveSpline.X);

            writer.WriteNumber("y", rawItemWeaponInfoBulletSpeedCurveSpline.Y);
        }
    }
}
