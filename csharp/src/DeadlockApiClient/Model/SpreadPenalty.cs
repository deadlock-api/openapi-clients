...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class SpreadPenalty : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SpreadPenalty" /> class.
        /// </summary>
        /// <param name="list"></param>
        internal SpreadPenalty(List<double> list)
        {
            List = list;
            OnCreated();
        }
        ...
        internal SpreadPenalty(string @string)
        {
            String = @string;
            OnCreated();
        }
    ...
    public partial class SpreadPenaltyJsonConverter : JsonConverter<SpreadPenalty>
    {
        ...
        public override SpreadPenalty Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (list != null)
                return new SpreadPenalty(list);

            if (varString != null)
                return new SpreadPenalty(varString);

            throw new JsonException();
        }

        /// <summary>
        /// Serializes a <see cref="SpreadPenalty" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, SpreadPenalty spreadPenalty, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, spreadPenalty, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="SpreadPenalty" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="spreadPenalty"></param>
        /// <param name="jsonSerializerOptions"></param>
