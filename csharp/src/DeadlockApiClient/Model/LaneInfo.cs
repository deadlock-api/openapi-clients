...
namespace DeadlockApiClient.Model
{
    ...
    /// LaneInfo
    /// </summary>
    public partial class LaneInfo : IValidatableObject
    {
        /// <summary>
    ...
    public partial class LaneInfoJsonConverter : JsonConverter<LaneInfo>
    {
        ...
        public override LaneInfo Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        ...
                        case "objective_color":
                            objectiveColor = new Option<Color?>(JsonSerializer.Deserialize<Color>(ref utf8JsonReader, jsonSerializerOptions));
                            break;
                        default:
                            break;
                    }
        ...
        /// <summary>
        /// Serializes a <see cref="LaneInfo" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, LaneInfo laneInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, laneInfo, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="LaneInfo" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="laneInfo"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, LaneInfo laneInfo, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            if (laneInfo.MinimapZiplineColorOverrideOption.IsSet)
                if (laneInfo.MinimapZiplineColorOverrideOption.Value != null)
                {
                    ...
                    JsonSerializer.Serialize(writer, laneInfo.MinimapZiplineColorOverride, jsonSerializerOptions);
                }
                else
                    writer.WriteNull("minimap_zipline_color_override");
            if (laneInfo.ObjectiveColorOption.IsSet)
                if (laneInfo.ObjectiveColorOption.Value != null)
                {
                    writer.WritePropertyName("objective_color");
                    JsonSerializer.Serialize(writer, laneInfo.ObjectiveColor, jsonSerializerOptions);
                }
                else
