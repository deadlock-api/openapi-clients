...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class BuildHeroJsonConverter : JsonConverter<BuildHero>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="BuildHeroJsonConverter" /> class.
        /// </summary>
        public BuildHeroJsonConverter()
        {
            OnCreated();
        }
