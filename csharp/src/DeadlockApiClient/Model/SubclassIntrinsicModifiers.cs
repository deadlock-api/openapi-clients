...
namespace DeadlockApiClient.Model
{
    ...
    public partial class SubclassIntrinsicModifiers : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SubclassIntrinsicModifiers(SubclassIntrinsicModifiersSubclass subclass)
        {
            Subclass = subclass;
            OnCreated();
        }
        ...
        public SubclassIntrinsicModifiersSubclass Subclass { get; set; }
    ...
    /// </summary>
    public partial class SubclassIntrinsicModifiersJsonConverter : JsonConverter<SubclassIntrinsicModifiers>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="SubclassIntrinsicModifiersJsonConverter" /> class.
        /// </summary>
        public SubclassIntrinsicModifiersJsonConverter()
        {
            OnCreated();
        }
        ...
        public override SubclassIntrinsicModifiers Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SubclassIntrinsicModifiersSubclass?> subclass = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "subclass":
                            subclass = new Option<SubclassIntrinsicModifiersSubclass?>(JsonSerializer.Deserialize<SubclassIntrinsicModifiersSubclass>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
