...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class HashMapItemSlotTypeVecPurchaseBonusValueInner : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HashMapItemSlotTypeVecPurchaseBonusValueInner" /> class.
        /// </summary>
        /// <param name="tier">tier</param>
        /// <param name="value">value</param>
        /// <param name="valueType">valueType</param>
        [JsonConstructor]
        public HashMapItemSlotTypeVecPurchaseBonusValueInner(long tier, string value, string valueType)
        {
            Tier = tier;
            Value = value;
            ValueType = valueType;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HashMapItemSlotTypeVecPurchaseBonusValueInner {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="HashMapItemSlotTypeVecPurchaseBonusValueInner" />
    /// </summary>
    public partial class HashMapItemSlotTypeVecPurchaseBonusValueInnerJsonConverter : JsonConverter<HashMapItemSlotTypeVecPurchaseBonusValueInner>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="HashMapItemSlotTypeVecPurchaseBonusValueInnerJsonConverter" /> class.
        /// </summary>
        public HashMapItemSlotTypeVecPurchaseBonusValueInnerJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="HashMapItemSlotTypeVecPurchaseBonusValueInner" />
        /// </summary>
        ...
        public override HashMapItemSlotTypeVecPurchaseBonusValueInner Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "tier":
                            tier = new Option<long?>(utf8JsonReader.TokenType == JsonTokenType.Null ? (long?)null : utf8JsonReader.GetInt64());
                            break;
                        case "value":
        ...
        /// <summary>
        /// Serializes a <see cref="HashMapItemSlotTypeVecPurchaseBonusValueInner" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, HashMapItemSlotTypeVecPurchaseBonusValueInner hashMapItemSlotTypeVecPurchaseBonusValueInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, hashMapItemSlotTypeVecPurchaseBonusValueInner, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="HashMapItemSlotTypeVecPurchaseBonusValueInner" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="hashMapItemSlotTypeVecPurchaseBonusValueInner"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, HashMapItemSlotTypeVecPurchaseBonusValueInner hashMapItemSlotTypeVecPurchaseBonusValueInner, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            writer.WriteString("value_type", hashMapItemSlotTypeVecPurchaseBonusValueInner.ValueType);
        }
    }
}
