...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class ShopSpiritStatsDisplay : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ShopSpiritStatsDisplay" /> class.
        /// </summary>
        /// <param name="displayStats">displayStats</param>
        [JsonConstructor]
        public ShopSpiritStatsDisplay(List<string> displayStats)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ShopSpiritStatsDisplay {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="ShopSpiritStatsDisplay" />
    /// </summary>
    public partial class ShopSpiritStatsDisplayJsonConverter : JsonConverter<ShopSpiritStatsDisplay>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="ShopSpiritStatsDisplayJsonConverter" /> class.
        /// </summary>
        public ShopSpiritStatsDisplayJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="ShopSpiritStatsDisplay" />
        /// </summary>
        ...
        public override ShopSpiritStatsDisplay Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
        ...
        /// <summary>
        /// Serializes a <see cref="ShopSpiritStatsDisplay" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, ShopSpiritStatsDisplay shopSpiritStatsDisplay, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, shopSpiritStatsDisplay, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="ShopSpiritStatsDisplay" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="shopSpiritStatsDisplay"></param>
        /// <param name="jsonSerializerOptions"></param>
