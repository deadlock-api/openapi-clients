...
namespace DeadlockApiClient.Model
{
    ...
    /// PlayerAccountStats
    /// </summary>
    public partial class PlayerAccountStats : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerAccountStats" /> class.
        /// </summary>
        /// <param name="accountId">accountId</param>
        /// <param name="stats">stats</param>
        [JsonConstructor]
        public PlayerAccountStats(int accountId, List<PlayerAccountHeroStats> stats)
        {
            AccountId = accountId;
            Stats = stats;
            OnCreated();
        ...
        public List<PlayerAccountHeroStats> Stats { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PlayerAccountStats {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="PlayerAccountStats" />
    /// </summary>
    public partial class PlayerAccountStatsJsonConverter : JsonConverter<PlayerAccountStats>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="PlayerAccountStatsJsonConverter" /> class.
        /// </summary>
        public PlayerAccountStatsJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="PlayerAccountStats" />
        /// </summary>
        ...
        public override PlayerAccountStats Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<PlayerAccountHeroStats>?> stats = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "account_id":
                            ...
                            break;
                        case "stats":
                            stats = new Option<List<PlayerAccountHeroStats>?>(JsonSerializer.Deserialize<List<PlayerAccountHeroStats>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
        ...
        /// <summary>
        /// Serializes a <see cref="PlayerAccountStats" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, PlayerAccountStats playerAccountStats, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, playerAccountStats, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="PlayerAccountStats" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="playerAccountStats"></param>
        /// <param name="jsonSerializerOptions"></param>
        ...
        public void WriteProperties(Utf8JsonWriter writer, PlayerAccountStats playerAccountStats, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            JsonSerializer.Serialize(writer, playerAccountStats.Stats, jsonSerializerOptions);
        }
    }
}
