...
namespace DeadlockApiClient.Model
{
    ...
    /// </summary>
    public partial class HashMapItemSlotTypeItemSlotInfoValue : IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HashMapItemSlotTypeItemSlotInfoValue" /> class.
        /// </summary>
        /// <param name="maxPurchasesForTier">maxPurchasesForTier</param>
        [JsonConstructor]
        public HashMapItemSlotTypeItemSlotInfoValue(List<long> maxPurchasesForTier)
        {
        ...
        public List<long> MaxPurchasesForTier { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class HashMapItemSlotTypeItemSlotInfoValue {\n");
    ...
    /// <summary>
    /// A Json converter for type <see cref="HashMapItemSlotTypeItemSlotInfoValue" />
    /// </summary>
    public partial class HashMapItemSlotTypeItemSlotInfoValueJsonConverter : JsonConverter<HashMapItemSlotTypeItemSlotInfoValue>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="HashMapItemSlotTypeItemSlotInfoValueJsonConverter" /> class.
        /// </summary>
        public HashMapItemSlotTypeItemSlotInfoValueJsonConverter()
        {
            OnCreated();
        }

        /// <summary>
        /// Deserializes json to <see cref="HashMapItemSlotTypeItemSlotInfoValue" />
        /// </summary>
        ...
        public override HashMapItemSlotTypeItemSlotInfoValue Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<List<long>?> maxPurchasesForTier = default;
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    switch (localVarJsonPropertyName)
                    {
                        case "max_purchases_for_tier":
                            maxPurchasesForTier = new Option<List<long>?>(JsonSerializer.Deserialize<List<long>>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
        ...
        /// <summary>
        /// Serializes a <see cref="HashMapItemSlotTypeItemSlotInfoValue" />
        /// </summary>
        ...
        public override void Write(Utf8JsonWriter writer, HashMapItemSlotTypeItemSlotInfoValue hashMapItemSlotTypeItemSlotInfoValue, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            WriteProperties(writer, hashMapItemSlotTypeItemSlotInfoValue, jsonSerializerOptions);
            writer.WriteEndObject();
        }

        /// <summary>
        /// Serializes the properties of <see cref="HashMapItemSlotTypeItemSlotInfoValue" />
        /// </summary>
        /// <param name="writer"></param>
        /// <param name="hashMapItemSlotTypeItemSlotInfoValue"></param>
        /// <param name="jsonSerializerOptions"></param>
