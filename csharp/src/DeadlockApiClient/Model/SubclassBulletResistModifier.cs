...
namespace DeadlockApiClient.Model
{
    ...
    public partial class SubclassBulletResistModifier : IValidatableObject
    {
        ...
        [JsonConstructor]
        public SubclassBulletResistModifier(SubclassBulletResistModifierSubclass subclass)
        {
            Subclass = subclass;
            OnCreated();
        }
        ...
        public SubclassBulletResistModifierSubclass Subclass { get; set; }
    ...
    /// </summary>
    public partial class SubclassBulletResistModifierJsonConverter : JsonConverter<SubclassBulletResistModifier>
    {
        partial void OnCreated();

        /// <summary>
        /// Initializes a new instance of the <see cref="SubclassBulletResistModifierJsonConverter" /> class.
        /// </summary>
        public SubclassBulletResistModifierJsonConverter()
        {
            OnCreated();
        }
        ...
        public override SubclassBulletResistModifier Read(ref Utf8JsonReader utf8JsonReader, Type typeToConvert, JsonSerializerOptions jsonSerializerOptions)
        {
            ...
            Option<SubclassBulletResistModifierSubclass?> subclass = default;
            ...
            while (utf8JsonReader.Read())
            {
                ...
                if (utf8JsonReader.TokenType == JsonTokenType.PropertyName && currentDepth == utf8JsonReader.CurrentDepth - 1)
                {
                    ...
                    {
                        case "subclass":
                            subclass = new Option<SubclassBulletResistModifierSubclass?>(JsonSerializer.Deserialize<SubclassBulletResistModifierSubclass>(ref utf8JsonReader, jsonSerializerOptions)!);
                            break;
                        default:
                            break;
                    }
