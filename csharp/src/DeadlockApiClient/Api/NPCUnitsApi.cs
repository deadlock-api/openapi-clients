...
namespace DeadlockApiClient.Api
{
    ...
    public sealed partial class NPCUnitsApi : INPCUnitsApi
    {
        ...
        public async Task<IGetNpcUnitApiResponse> GetNpcUnitAsync(string idOrClassname, Option<int?> clientVersion = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    {
                        ILogger<GetNpcUnitApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<GetNpcUnitApiResponse>();
                        GetNpcUnitApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/assets/npc-units/{id_or_classname}", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class GetNpcUnitApiResponse : DeadlockApiClient.Client.ApiResponse, IGetNpcUnitApiResponse
        {
            ...
            /// The logger
            /// </summary>
            public ILogger<GetNpcUnitApiResponse> Logger { get; }
            ...
            public GetNpcUnitApiResponse(ILogger<GetNpcUnitApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
        ...
        public async Task<IListNpcUnitsApiResponse> ListNpcUnitsAsync(Option<int?> clientVersion = default, System.Threading.CancellationToken cancellationToken = default)
        {
            ...
            try
            {
                ...
                using (HttpRequestMessage httpRequestMessageLocalVar = new HttpRequestMessage())
                {
                    ...
                    using (HttpResponseMessage httpResponseMessageLocalVar = await HttpClient.SendAsync(httpRequestMessageLocalVar, cancellationToken).ConfigureAwait(false))
                    {
                        ILogger<ListNpcUnitsApiResponse> apiResponseLoggerLocalVar = LoggerFactory.CreateLogger<ListNpcUnitsApiResponse>();
                        ListNpcUnitsApiResponse apiResponseLocalVar;

                        switch ((int)httpResponseMessageLocalVar.StatusCode) {
                            default: {
                                string responseContentLocalVar = await httpResponseMessageLocalVar.Content.ReadAsStringAsync(cancellationToken).ConfigureAwait(false);
                                apiResponseLocalVar = new(apiResponseLoggerLocalVar, httpRequestMessageLocalVar, httpResponseMessageLocalVar, responseContentLocalVar, "/v1/assets/npc-units", requestedAtLocalVar, _jsonSerializerOptions);
        ...
        public partial class ListNpcUnitsApiResponse : DeadlockApiClient.Client.ApiResponse, IListNpcUnitsApiResponse
        {
            ...
            /// The logger
            /// </summary>
            public ILogger<ListNpcUnitsApiResponse> Logger { get; }
            ...
            /// <param name="requestedAt"></param>
            /// <param name="jsonSerializerOptions"></param>
            public ListNpcUnitsApiResponse(ILogger<ListNpcUnitsApiResponse> logger, System.Net.Http.HttpRequestMessage httpRequestMessage, System.Net.Http.HttpResponseMessage httpResponseMessage, string rawContent, string path, DateTime requestedAt, System.Text.Json.JsonSerializerOptions jsonSerializerOptions) : base(httpRequestMessage, httpResponseMessage, rawContent, path, requestedAt, jsonSerializerOptions)
            {
                Logger = logger;
                OnCreated(httpRequestMessage, httpResponseMessage);
            }
