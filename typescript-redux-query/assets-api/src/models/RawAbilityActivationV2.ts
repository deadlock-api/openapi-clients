...
export function RawAbilityActivationV2FromJSON(json: any): RawAbilityActivationV2 {
    return json as RawAbilityActivationV2;
}

export function RawAbilityActivationV2ToJSON(value?: RawAbilityActivationV2): any {
    return value as any;
}
