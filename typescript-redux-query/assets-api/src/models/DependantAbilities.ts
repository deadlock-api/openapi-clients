 ...
 * 
 * @export
 * @interface DependantAbilities
 */
export interface DependantAbilities  {
    /**
     * 
     * @type {Array<string>}
     * @memberof DependantAbilities
     */
    flags?: Array<string>;
}

export function DependantAbilitiesFromJSON(json: any): DependantAbilities {
    return {
        'flags': !exists(json, 'flags') ? undefined : json['flags'],
    };
}

export function DependantAbilitiesToJSON(value?: DependantAbilities): any {
    if (value === undefined) {
        return undefined;
    }
    return {
