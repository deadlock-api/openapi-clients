...
export function ItemSlotTypeV2FromJSON(json: any): ItemSlotTypeV2 {
    return json as ItemSlotTypeV2;
}

export function ItemSlotTypeV2ToJSON(value?: ItemSlotTypeV2): any {
    return value as any;
}
