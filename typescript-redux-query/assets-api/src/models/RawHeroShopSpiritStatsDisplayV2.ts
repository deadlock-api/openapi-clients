...
export function RawHeroShopSpiritStatsDisplayV2FromJSON(json: any): RawHeroShopSpiritStatsDisplayV2 {
    return {
        'displayStats': json['display_stats'],
    };
}

export function RawHeroShopSpiritStatsDisplayV2ToJSON(value?: RawHeroShopSpiritStatsDisplayV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
