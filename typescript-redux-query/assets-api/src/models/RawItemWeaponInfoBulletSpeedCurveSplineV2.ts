...
export function RawItemWeaponInfoBulletSpeedCurveSplineV2FromJSON(json: any): RawItemWeaponInfoBulletSpeedCurveSplineV2 {
    return {
...
export function RawItemWeaponInfoBulletSpeedCurveSplineV2ToJSON(value?: RawItemWeaponInfoBulletSpeedCurveSplineV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
