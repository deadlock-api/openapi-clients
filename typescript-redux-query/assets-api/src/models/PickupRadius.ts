 ...
 * 
 * @export
 * @interface PickupRadius
 */
export interface PickupRadius  {
    /**
     * 
     * @type {number}
     * @memberof PickupRadius
     */
    base?: number;
    /**
     * 
...
export function PickupRadiusFromJSON(json: any): PickupRadius {
    return {
...
export function PickupRadiusToJSON(value?: PickupRadius): any {
    if (value === undefined) {
        return undefined;
    }
    return {
