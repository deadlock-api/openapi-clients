...
export interface ExpirationDuration  {
     ...
     * @memberof ExpirationDuration
     */
    perMinuteAfterStart?: number;
}

export function ExpirationDurationFromJSON(json: any): ExpirationDuration {
    return {
        'base': !exists(json, 'base') ? undefined : json['base'],
        'perMinuteAfterStart': !exists(json, 'per_minute_after_start') ? undefined : json['per_minute_after_start'],
    };
}

export function ExpirationDurationToJSON(value?: ExpirationDuration): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'base': value.base,
        'per_minute_after_start': value.perMinuteAfterStart,
    };
}
