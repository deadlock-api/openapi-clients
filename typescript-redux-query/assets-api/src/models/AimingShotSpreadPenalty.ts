...
export function AimingShotSpreadPenaltyFromJSON(json: any): AimingShotSpreadPenalty {
    return json;
}

export function AimingShotSpreadPenaltyToJSON(value?: AimingShotSpreadPenalty): any {
    return value;
}
