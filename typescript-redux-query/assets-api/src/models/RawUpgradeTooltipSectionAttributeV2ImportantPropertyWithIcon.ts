 ...
 * 
 * @export
 * @interface RawUpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon
 */
export interface RawUpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon  {
    /**
     * 
     * @type {string}
     * @memberof RawUpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon
     */
    name?: string;
    /**
     * 
...
export function RawUpgradeTooltipSectionAttributeV2ImportantPropertyWithIconFromJSON(json: any): RawUpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon {
    return {
...
export function RawUpgradeTooltipSectionAttributeV2ImportantPropertyWithIconToJSON(value?: RawUpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon): any {
    if (value === undefined) {
        return undefined;
    }
    return {
