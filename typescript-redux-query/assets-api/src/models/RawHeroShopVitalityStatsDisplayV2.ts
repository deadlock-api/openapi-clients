...
export function RawHeroShopVitalityStatsDisplayV2FromJSON(json: any): RawHeroShopVitalityStatsDisplayV2 {
    return {
...
export function RawHeroShopVitalityStatsDisplayV2ToJSON(value?: RawHeroShopVitalityStatsDisplayV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
