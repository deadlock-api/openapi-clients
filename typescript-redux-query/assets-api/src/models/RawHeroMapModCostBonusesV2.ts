...
export function RawHeroMapModCostBonusesV2FromJSON(json: any): RawHeroMapModCostBonusesV2 {
    return {
...
export function RawHeroMapModCostBonusesV2ToJSON(value?: RawHeroMapModCostBonusesV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
