 ...
 * 
 * @export
 * @interface RawHeroDraftBucketing
 */
export interface RawHeroDraftBucketing  {
    /**
     * 
     * @type {string}
     * @memberof RawHeroDraftBucketing
     */
    bucket?: string;
    /**
     * 
...
export function RawHeroDraftBucketingFromJSON(json: any): RawHeroDraftBucketing {
    return {
...
export function RawHeroDraftBucketingToJSON(value?: RawHeroDraftBucketing): any {
    if (value === undefined) {
        return undefined;
    }
    return {
