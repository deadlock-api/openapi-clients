 ...
 * 
 * @export
 * @interface HeroV2ItemDraftBucketingValue
 */
export interface HeroV2ItemDraftBucketingValue  {
    /**
     * 
     * @type {string}
     * @memberof HeroV2ItemDraftBucketingValue
     */
    bucket?: string;
    /**
     * 
...
export function HeroV2ItemDraftBucketingValueFromJSON(json: any): HeroV2ItemDraftBucketingValue {
    return {
...
export function HeroV2ItemDraftBucketingValueToJSON(value?: HeroV2ItemDraftBucketingValue): any {
    if (value === undefined) {
        return undefined;
    }
    return {
