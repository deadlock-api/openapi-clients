...
export function RankV2FromJSON(json: any): RankV2 {
    return {
        'tier': json['tier'],
        'name': json['name'],
        'images': RankImagesV2FromJSON(json['images']),
        'color': json['color'],
    };
}

export function RankV2ToJSON(value?: RankV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'tier': value.tier,
        'name': value.name,
        'images': RankImagesV2ToJSON(value.images),
    };
}
