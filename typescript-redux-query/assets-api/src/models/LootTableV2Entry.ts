 ...
 * 
 * @export
 * @interface LootTableV2Entry
 */
export interface LootTableV2Entry  {
    /**
     * 
     * @type {string}
     * @memberof LootTableV2Entry
     */
    item: string;
}

export function LootTableV2EntryFromJSON(json: any): LootTableV2Entry {
    return {
        'item': json['item'],
    };
}

export function LootTableV2EntryToJSON(value?: LootTableV2Entry): any {
    if (value === undefined) {
        return undefined;
    }
    return {
