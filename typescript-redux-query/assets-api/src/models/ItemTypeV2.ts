...
export function ItemTypeV2FromJSON(json: any): ItemTypeV2 {
    return json as ItemTypeV2;
}

export function ItemTypeV2ToJSON(value?: ItemTypeV2): any {
    return value as any;
}
