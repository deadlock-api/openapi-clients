...
import {
    StatsUsageFlagV2,
    StatsUsageFlagV2FromJSON,
    StatsUsageFlagV2ToJSON,
} from './';
...
export function UsageFlagsFromJSON(json: any): UsageFlags {
    return json;
}

export function UsageFlagsToJSON(value?: UsageFlags): any {
    return value;
}
