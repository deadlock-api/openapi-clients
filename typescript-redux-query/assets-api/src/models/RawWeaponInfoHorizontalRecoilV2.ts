...
export function RawWeaponInfoHorizontalRecoilV2FromJSON(json: any): RawWeaponInfoHorizontalRecoilV2 {
    return {
...
export function RawWeaponInfoHorizontalRecoilV2ToJSON(value?: RawWeaponInfoHorizontalRecoilV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
