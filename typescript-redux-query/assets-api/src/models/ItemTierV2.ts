...
export function ItemTierV2FromJSON(json: any): ItemTierV2 {
    return json as ItemTierV2;
}

export function ItemTierV2ToJSON(value?: ItemTierV2): any {
    return value as any;
}
