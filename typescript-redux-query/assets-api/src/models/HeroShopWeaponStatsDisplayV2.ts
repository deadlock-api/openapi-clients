...
export function HeroShopWeaponStatsDisplayV2FromJSON(json: any): HeroShopWeaponStatsDisplayV2 {
    return {
...
export function HeroShopWeaponStatsDisplayV2ToJSON(value?: HeroShopWeaponStatsDisplayV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
