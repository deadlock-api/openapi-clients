...
export function StandingShotSpreadPenaltyFromJSON(json: any): StandingShotSpreadPenalty {
    return json;
}

export function StandingShotSpreadPenaltyToJSON(value?: StandingShotSpreadPenalty): any {
    return value;
}
