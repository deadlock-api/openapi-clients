...
export function ScriptValuesFromJSON(json: any): ScriptValues {
    return {
        'modifierValue': !exists(json, 'modifier_value') ? undefined : json['modifier_value'],
        'value': !exists(json, 'value') ? undefined : json['value'],
    };
}

export function ScriptValuesToJSON(value?: ScriptValues): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'modifier_value': value.modifierValue,
        'value': value.value,
    };
}
