...
export function RawHeroItemSlotInfoValueV2FromJSON(json: any): RawHeroItemSlotInfoValueV2 {
    return {
        'maxPurchasesForTier': json['max_purchases_for_tier'],
    };
}

export function RawHeroItemSlotInfoValueV2ToJSON(value?: RawHeroItemSlotInfoValueV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
