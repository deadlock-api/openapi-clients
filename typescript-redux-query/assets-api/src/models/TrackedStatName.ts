...
export function TrackedStatNameFromJSON(json: any): TrackedStatName {
    return json as TrackedStatName;
}

export function TrackedStatNameToJSON(value?: TrackedStatName): any {
    return value as any;
}
