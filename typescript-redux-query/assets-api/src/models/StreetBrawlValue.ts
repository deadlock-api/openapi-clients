 ...
 * 
 * @export
 * @interface StreetBrawlValue
 */
export interface StreetBrawlValue  {
}

export function StreetBrawlValueFromJSON(json: any): StreetBrawlValue {
    return json;
}

export function StreetBrawlValueToJSON(value?: StreetBrawlValue): any {
    return value;
}
