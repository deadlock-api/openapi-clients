...
export function RawAbilityImbueV2FromJSON(json: any): RawAbilityImbueV2 {
    return json as RawAbilityImbueV2;
}

export function RawAbilityImbueV2ToJSON(value?: RawAbilityImbueV2): any {
    return value as any;
}
