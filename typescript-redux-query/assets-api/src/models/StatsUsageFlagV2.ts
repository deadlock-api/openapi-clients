...
export function StatsUsageFlagV2FromJSON(json: any): StatsUsageFlagV2 {
    return json as StatsUsageFlagV2;
}

export function StatsUsageFlagV2ToJSON(value?: StatsUsageFlagV2): any {
    return value as any;
}
