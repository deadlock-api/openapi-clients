 ...
 * 
 * @export
 * @interface DraftBuckets
 */
export interface DraftBuckets  {
    /**
     * 
     * @type {DraftBucket}
     * @memberof DraftBuckets
     */
    bucket?: DraftBucket;
    /**
     * 
...
export function DraftBucketsFromJSON(json: any): DraftBuckets {
    return {
...
export function DraftBucketsToJSON(value?: DraftBuckets): any {
    if (value === undefined) {
        return undefined;
    }
    return {
