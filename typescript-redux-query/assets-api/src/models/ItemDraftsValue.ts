 ...
 * 
 * @export
 * @interface ItemDraftsValue
 */
export interface ItemDraftsValue  {
    /**
     * 
     * @type {DraftBucket}
     * @memberof ItemDraftsValue
     */
    bucket?: DraftBucket;
    /**
     * 
...
export function ItemDraftsValueFromJSON(json: any): ItemDraftsValue {
    return {
        'bucket': !exists(json, 'bucket') ? undefined : DraftBucketFromJSON(json['bucket']),
        'name': !exists(json, 'name') ? undefined : json['name'],
    };
}

export function ItemDraftsValueToJSON(value?: ItemDraftsValue): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'bucket': DraftBucketToJSON(value.bucket),
        'name': value.name,
    };
}
