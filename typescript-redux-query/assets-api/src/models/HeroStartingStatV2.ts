...
export function HeroStartingStatV2FromJSON(json: any): HeroStartingStatV2 {
    return {
        'value': ValueFromJSON(json['value']),
        'displayStatName': json['display_stat_name'],
    };
}

export function HeroStartingStatV2ToJSON(value?: HeroStartingStatV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'value': ValueToJSON(value.value),
        'display_stat_name': value.displayStatName,
    };
}
