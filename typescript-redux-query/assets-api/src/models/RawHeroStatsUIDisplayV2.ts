...
export function RawHeroStatsUIDisplayV2FromJSON(json: any): RawHeroStatsUIDisplayV2 {
    return {
...
export function RawHeroStatsUIDisplayV2ToJSON(value?: RawHeroStatsUIDisplayV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
