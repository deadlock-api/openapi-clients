 ...
 * 
 * @export
 * @interface OutcomeToWeights
 */
export interface OutcomeToWeights  {
    /**
     * 
     * @type {{ [key: string]: number; }}
     * @memberof OutcomeToWeights
     */
    outcomesToWeights: { [key: string]: number; };
}

export function OutcomeToWeightsFromJSON(json: any): OutcomeToWeights {
    return {
        'outcomesToWeights': json['outcomes_to_weights'],
    };
}

export function OutcomeToWeightsToJSON(value?: OutcomeToWeights): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'outcomes_to_weights': value.outcomesToWeights,
    };
}
