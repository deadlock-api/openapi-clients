...
export function DraftBucketFromJSON(json: any): DraftBucket {
    return {
        'normal': !exists(json, 'normal') ? undefined : json['normal'],
        'good': !exists(json, 'good') ? undefined : json['good'],
    };
}

export function DraftBucketToJSON(value?: DraftBucket): any {
    if (value === undefined) {
        return undefined;
    }
    return {
