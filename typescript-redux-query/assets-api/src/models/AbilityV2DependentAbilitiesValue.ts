 ...
 * 
 * @export
 * @interface AbilityV2DependentAbilitiesValue
 */
export interface AbilityV2DependentAbilitiesValue  {
    /**
     * 
     * @type {Array<string>}
     * @memberof AbilityV2DependentAbilitiesValue
     */
    flags?: Array<string>;
}

export function AbilityV2DependentAbilitiesValueFromJSON(json: any): AbilityV2DependentAbilitiesValue {
    return {
        'flags': !exists(json, 'flags') ? undefined : json['flags'],
    };
}

export function AbilityV2DependentAbilitiesValueToJSON(value?: AbilityV2DependentAbilitiesValue): any {
    if (value === undefined) {
        return undefined;
    }
    return {
