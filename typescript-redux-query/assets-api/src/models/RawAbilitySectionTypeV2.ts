...
export function RawAbilitySectionTypeV2FromJSON(json: any): RawAbilitySectionTypeV2 {
    return json as RawAbilitySectionTypeV2;
}

export function RawAbilitySectionTypeV2ToJSON(value?: RawAbilitySectionTypeV2): any {
    return value as any;
}
