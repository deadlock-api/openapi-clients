...
export function RawHeroPurchaseBonusV2FromJSON(json: any): RawHeroPurchaseBonusV2 {
    return {
...
export function RawHeroPurchaseBonusV2ToJSON(value?: RawHeroPurchaseBonusV2): any {
    if (value === undefined) {
        return undefined;
    }
    return {
