 ...
 * 
 * @export
 * @interface RollTypeOneOf
 */
export interface RollTypeOneOf  {
    /**
     * 
     * @type {string}
     * @memberof RollTypeOneOf
     */
    other: string;
}

export function RollTypeOneOfFromJSON(json: any): RollTypeOneOf {
    return {
        'other': json['Other'],
    };
}

export function RollTypeOneOfToJSON(value?: RollTypeOneOf): any {
    if (value === undefined) {
        return undefined;
    }
    return {
