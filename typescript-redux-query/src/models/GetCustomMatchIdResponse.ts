...
export function GetCustomMatchIdResponseFromJSON(json: any): GetCustomMatchIdResponse {
    return {
        'matchId': json['match_id'],
    };
}

export function GetCustomMatchIdResponseToJSON(value?: GetCustomMatchIdResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
