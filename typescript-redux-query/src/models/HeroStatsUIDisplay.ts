 ...
 * 
 * @export
 * @interface HeroStatsUIDisplay
 */
export interface HeroStatsUIDisplay  {
    /**
     * 
     * @type {string}
     * @memberof HeroStatsUIDisplay
     */
    category: string;
    /**
     * 
...
export function HeroStatsUIDisplayFromJSON(json: any): HeroStatsUIDisplay {
    return {
...
export function HeroStatsUIDisplayToJSON(value?: HeroStatsUIDisplay): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'category': value.category,
        'stat_type': value.statType,
    };
}
