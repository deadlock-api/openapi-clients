 ...
 * @export
 * @interface DeleteSteamAccountResponse
 */
export interface DeleteSteamAccountResponse  {
    /**
     * 
     * @type {string}
     * @memberof DeleteSteamAccountResponse
     */
    message: string;
}

export function DeleteSteamAccountResponseFromJSON(json: any): DeleteSteamAccountResponse {
    return {
        'message': json['message'],
    };
}

export function DeleteSteamAccountResponseToJSON(value?: DeleteSteamAccountResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
