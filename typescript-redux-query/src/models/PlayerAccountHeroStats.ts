 ...
 * 
 * @export
 * @interface PlayerAccountHeroStats
 */
export interface PlayerAccountHeroStats  {
    /**
     * 
     * @type {number}
     * @memberof PlayerAccountHeroStats
     */
    heroId?: number;
    /**
     * 
     ...
     * @memberof PlayerAccountHeroStats
     */
    medalsBronze: Array<number>;
    /**
     * 
     * @type {Array<number>}
     * @memberof PlayerAccountHeroStats
     */
    medalsGold: Array<number>;
    /**
     * 
     * @type {Array<number>}
     * @memberof PlayerAccountHeroStats
     */
    medalsSilver: Array<number>;
    /**
     * 
     * @type {Array<number>}
     * @memberof PlayerAccountHeroStats
     ...
     * @memberof PlayerAccountHeroStats
     */
    totalValue: Array<number>;
}

export function PlayerAccountHeroStatsFromJSON(json: any): PlayerAccountHeroStats {
    return {
        'heroId': !exists(json, 'hero_id') ? undefined : json['hero_id'],
...
export function PlayerAccountHeroStatsToJSON(value?: PlayerAccountHeroStats): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'hero_id': value.heroId,
        'medals_bronze': value.medalsBronze,
        'medals_gold': value.medalsGold,
        'medals_silver': value.medalsSilver,
        'stat_id': value.statId,
