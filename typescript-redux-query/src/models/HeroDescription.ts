...
export function HeroDescriptionFromJSON(json: any): HeroDescription {
    return {
...
export function HeroDescriptionToJSON(value?: HeroDescription): any {
    if (value === undefined) {
        return undefined;
    }
    return {
