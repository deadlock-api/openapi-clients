...
export function AbilityActivationFromJSON(json: any): AbilityActivation {
    return json as AbilityActivation;
}

export function AbilityActivationToJSON(value?: AbilityActivation): any {
    return value as any;
}
