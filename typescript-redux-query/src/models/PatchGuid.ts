...
export function PatchGuidFromJSON(json: any): PatchGuid {
    return {
        'isPermaLink': json['is_perma_link'],
        'text': json['text'],
    };
}

export function PatchGuidToJSON(value?: PatchGuid): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'is_perma_link': value.isPermaLink,
        'text': value.text,
    };
}
