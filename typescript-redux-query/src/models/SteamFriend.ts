...
export function SteamFriendFromJSON(json: any): SteamFriend {
    return {
        'accountId': json['account_id'],
        'friendSince': new Date(json['friend_since']),
    };
}

export function SteamFriendToJSON(value?: SteamFriend): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'account_id': value.accountId,
        'friend_since': value.friendSince.toISOString(),
    };
}
