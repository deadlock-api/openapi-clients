...
export function SlotsSummaryFromJSON(json: any): SlotsSummary {
    return {
        'availableSlots': json['available_slots'],
        'slotsInCooldown': json['slots_in_cooldown'],
        'totalSlots': json['total_slots'],
        'usedSlots': json['used_slots'],
    };
}

export function SlotsSummaryToJSON(value?: SlotsSummary): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'available_slots': value.availableSlots,
        'slots_in_cooldown': value.slotsInCooldown,
