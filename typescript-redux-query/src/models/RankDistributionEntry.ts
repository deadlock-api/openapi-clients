...
export interface RankDistributionEntry  {
     ...
     * @type {number}
     * @memberof RankDistributionEntry
     */
    badge: number;
    /**
...
export function RankDistributionEntryFromJSON(json: any): RankDistributionEntry {
    return {
        'badge': json['badge'],
...
export function RankDistributionEntryToJSON(value?: RankDistributionEntry): any {
    if (value === undefined) {
        return undefined;
    }
    return {
