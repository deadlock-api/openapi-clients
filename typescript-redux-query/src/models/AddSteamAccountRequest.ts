 ...
 * @export
 * @interface AddSteamAccountRequest
 */
export interface AddSteamAccountRequest  {
    /**
     * Steam ID3 (32-bit unsigned integer format)
     * @type {number}
     * @memberof AddSteamAccountRequest
     */
    steamId3: number;
}

export function AddSteamAccountRequestFromJSON(json: any): AddSteamAccountRequest {
    return {
        'steamId3': json['steam_id3'],
    };
}

export function AddSteamAccountRequestToJSON(value?: AddSteamAccountRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
