...
export function StatsUsageFlagFromJSON(json: any): StatsUsageFlag {
    return json as StatsUsageFlag;
}

export function StatsUsageFlagToJSON(value?: StatsUsageFlag): any {
    return value as any;
}
