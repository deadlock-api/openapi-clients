 ...
 * 
 * @export
 * @interface IngestLiveUrl
 */
export interface IngestLiveUrl  {
    /**
     * 
     * @type {string}
     * @memberof IngestLiveUrl
     */
    broadcastUrl: string;
    /**
     * 
...
export function IngestLiveUrlFromJSON(json: any): IngestLiveUrl {
    return {
...
export function IngestLiveUrlToJSON(value?: IngestLiveUrl): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'broadcast_url': value.broadcastUrl,
