 ...
 * @enum {string}
 */
export enum AbilitySectionType {
    Innate = 'innate',
    Active = 'active',
    Passive = 'passive'
}

export function AbilitySectionTypeFromJSON(json: any): AbilitySectionType {
    return json as AbilitySectionType;
}

export function AbilitySectionTypeToJSON(value?: AbilitySectionType): any {
    return value as any;
}
