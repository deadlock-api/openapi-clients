...
export function UpgradeDescriptionFromJSON(json: any): UpgradeDescription {
    return {
...
export function UpgradeDescriptionToJSON(value?: UpgradeDescription): any {
    if (value === undefined) {
        return undefined;
    }
    return {
