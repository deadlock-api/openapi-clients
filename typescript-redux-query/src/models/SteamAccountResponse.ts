 ...
 * @export
 * @interface SteamAccountResponse
 */
export interface SteamAccountResponse  {
    /**
     * 
     * @type {Date}
     * @memberof SteamAccountResponse
     */
    createdAt: Date;
    /**
     * 
...
export function SteamAccountResponseFromJSON(json: any): SteamAccountResponse {
    return {
...
export function SteamAccountResponseToJSON(value?: SteamAccountResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
