 ...
 * 
 * @export
 * @interface ShopSpiritStatsDisplay
 */
export interface ShopSpiritStatsDisplay  {
    /**
     * 
     * @type {Array<string>}
     * @memberof ShopSpiritStatsDisplay
     */
    displayStats: Array<string>;
}

export function ShopSpiritStatsDisplayFromJSON(json: any): ShopSpiritStatsDisplay {
    return {
        'displayStats': json['display_stats'],
    };
}

export function ShopSpiritStatsDisplayToJSON(value?: ShopSpiritStatsDisplay): any {
    if (value === undefined) {
        return undefined;
    }
    return {
