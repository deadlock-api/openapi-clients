...
export function ItemDraftRoundFromJSON(json: any): ItemDraftRound {
    return {
        'normalModTier': json['normal_mod_tier'],
        'rareModTier': json['rare_mod_tier'],
    };
}

export function ItemDraftRoundToJSON(value?: ItemDraftRound): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'normal_mod_tier': value.normalModTier,
        'rare_mod_tier': value.rareModTier,
    };
}
