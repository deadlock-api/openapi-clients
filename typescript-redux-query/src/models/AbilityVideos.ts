 ...
 * 
 * @export
 * @interface AbilityVideos
 */
export interface AbilityVideos  {
    /**
     * 
     * @type {string}
     * @memberof AbilityVideos
     */
    mp4?: string;
    /**
     * 
...
export function AbilityVideosFromJSON(json: any): AbilityVideos {
    return {
        'mp4': !exists(json, 'mp4') ? undefined : json['mp4'],
        'webm': !exists(json, 'webm') ? undefined : json['webm'],
    };
}

export function AbilityVideosToJSON(value?: AbilityVideos): any {
    if (value === undefined) {
        return undefined;
    }
    return {
