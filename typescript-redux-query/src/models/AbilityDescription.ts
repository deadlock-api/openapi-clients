...
export function AbilityDescriptionFromJSON(json: any): AbilityDescription {
    return {
...
export function AbilityDescriptionToJSON(value?: AbilityDescription): any {
    if (value === undefined) {
        return undefined;
    }
    return {
