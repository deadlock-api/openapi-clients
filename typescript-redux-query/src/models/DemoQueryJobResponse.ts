 ...
 * 
 * @export
 * @interface DemoQueryJobResponse
 */
export interface DemoQueryJobResponse  {
    /**
     * Stable id of the job; poll `/demo/query/{job_id}` for status and the result URL.
     * @type {string}
     * @memberof DemoQueryJobResponse
     */
    jobId: string;
    /**
     * 
...
export function DemoQueryJobResponseFromJSON(json: any): DemoQueryJobResponse {
    return {
        'jobId': json['job_id'],
...
export function DemoQueryJobResponseToJSON(value?: DemoQueryJobResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
