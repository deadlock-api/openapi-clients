...
export function BuildHeroDetailsAbilityOrderCurrencyChangeFromJSON(json: any): BuildHeroDetailsAbilityOrderCurrencyChange {
    return {
...
export function BuildHeroDetailsAbilityOrderCurrencyChangeToJSON(value?: BuildHeroDetailsAbilityOrderCurrencyChange): any {
    if (value === undefined) {
        return undefined;
    }
    return {
