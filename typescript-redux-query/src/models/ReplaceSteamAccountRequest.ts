 ...
 * @export
 * @interface ReplaceSteamAccountRequest
 */
export interface ReplaceSteamAccountRequest  {
    /**
     * New Steam ID3 (32-bit unsigned integer format)
     * @type {number}
     * @memberof ReplaceSteamAccountRequest
     */
    steamId3: number;
}

export function ReplaceSteamAccountRequestFromJSON(json: any): ReplaceSteamAccountRequest {
    return {
        'steamId3': json['steam_id3'],
    };
}

export function ReplaceSteamAccountRequestToJSON(value?: ReplaceSteamAccountRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
