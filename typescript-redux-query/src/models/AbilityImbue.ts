 ...
 * @enum {string}
 */
export enum AbilityImbue {
    ImbueActive = 'imbue_active',
    ImbueActiveNonUlt = 'imbue_active_non_ult',
    ImbueModifierValue = 'imbue_modifier_value'
}

export function AbilityImbueFromJSON(json: any): AbilityImbue {
    return json as AbilityImbue;
}

export function AbilityImbueToJSON(value?: AbilityImbue): any {
    return value as any;
}
