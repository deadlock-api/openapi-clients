...
export function DemoQueryRequestFromJSON(json: any): DemoQueryRequest {
    return {
        'format': !exists(json, 'format') ? undefined : OutputFormatFromJSON(json['format']),
        'matchId': json['match_id'],
        'query': json['query'],
    };
}

export function DemoQueryRequestToJSON(value?: DemoQueryRequest): any {
    if (value === undefined) {
        return undefined;
    }
    return {
