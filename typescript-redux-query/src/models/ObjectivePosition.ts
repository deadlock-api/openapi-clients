...
export function ObjectivePositionFromJSON(json: any): ObjectivePosition {
    return {
        'leftRelative': json['left_relative'],
        'topRelative': json['top_relative'],
    };
}

export function ObjectivePositionToJSON(value?: ObjectivePosition): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'left_relative': value.leftRelative,
        'top_relative': value.topRelative,
    };
}
