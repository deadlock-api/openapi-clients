 ...
 * @export
 */
export interface FeedItemOneOf extends ForumPatch {
}

export function FeedItemOneOfFromJSON(json: any): FeedItemOneOf {
    return {
        ...ForumPatchFromJSON(json),
    };
}

export function FeedItemOneOfToJSON(value?: FeedItemOneOf): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...ForumPatchToJSON(value),
    };
}
