 ...
 */
function listClientVersionsRaw<T>( requestConfig: runtime.TypedQueryConfig<T, Array<number>> = {}): QueryConfig<T> {
    ...
    const config: QueryConfig<T> = {
        url: `${runtime.Configuration.basePath}/v1/assets/client-versions`,
        meta,
...
* List Client Versions
*/
export function listClientVersions<T>( requestConfig?: runtime.TypedQueryConfig<T, Array<number>>): QueryConfig<T> {
    return listClientVersionsRaw( requestConfig);
}
