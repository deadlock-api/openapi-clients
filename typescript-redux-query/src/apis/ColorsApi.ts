...
export interface ListColorsRequest {
 ...
 * List Colors
 */
function listColorsRaw<T>(requestParameters: ListColorsRequest, requestConfig: runtime.TypedQueryConfig<T, { [key: string]: Color; }> = {}): QueryConfig<T> {
    ...
    const config: QueryConfig<T> = {
        url: `${runtime.Configuration.basePath}/v1/assets/colors`,
        meta,
    ...
    if (requestTransform) {
        config.transform = (body: ResponseBody, text: ResponseBody) => requestTransform(ColorFromJSON(body), text);
    }
...
* List Colors
*/
export function listColors<T>(requestParameters: ListColorsRequest, requestConfig?: runtime.TypedQueryConfig<T, { [key: string]: Color; }>): QueryConfig<T> {
    return listColorsRaw(requestParameters, requestConfig);
}
