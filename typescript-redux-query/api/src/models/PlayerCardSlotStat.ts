...
export function PlayerCardSlotStatFromJSON(json: any): PlayerCardSlotStat {
    return {
        'statId': !exists(json, 'stat_id') ? undefined : json['stat_id'],
        'statScore': !exists(json, 'stat_score') ? undefined : json['stat_score'],
    };
}

export function PlayerCardSlotStatToJSON(value?: PlayerCardSlotStat): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'stat_id': value.statId,
        'stat_score': value.statScore,
    };
}
