...
export function DistributionEntryFromJSON(json: any): DistributionEntry {
    return {
...
export function DistributionEntryToJSON(value?: DistributionEntry): any {
    if (value === undefined) {
        return undefined;
    }
    return {
