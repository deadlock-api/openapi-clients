...
export function ActiveMatchGameModeFromJSON(json: any): ActiveMatchGameMode {
    return json as ActiveMatchGameMode;
}

export function ActiveMatchGameModeToJSON(value?: ActiveMatchGameMode): any {
    return value as any;
}
