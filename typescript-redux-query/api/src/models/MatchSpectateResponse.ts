...
export function MatchSpectateResponseFromJSON(json: any): MatchSpectateResponse {
    return {
...
export function MatchSpectateResponseToJSON(value?: MatchSpectateResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
