...
export function MMRHistoryFromJSON(json: any): MMRHistory {
    return {
        'accountId': json['account_id'],
        'division': json['division'],
        'divisionTier': json['division_tier'],
...
export function MMRHistoryToJSON(value?: MMRHistory): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...
        'division_tier': value.divisionTier,
