 ...
 * @enum {string}
 */
export enum ESportsMatchStatus {
    Live = 'Live',
    Completed = 'Completed',
    Scheduled = 'Scheduled',
    Cancelled = 'Cancelled'
...
export function ESportsMatchStatusFromJSON(json: any): ESportsMatchStatus {
    return json as ESportsMatchStatus;
}

export function ESportsMatchStatusToJSON(value?: ESportsMatchStatus): any {
    return value as any;
}
