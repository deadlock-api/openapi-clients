...
export function AnalyticsAbilityOrderStatsFromJSON(json: any): AnalyticsAbilityOrderStats {
    return {
...
export function AnalyticsAbilityOrderStatsToJSON(value?: AnalyticsAbilityOrderStats): any {
    if (value === undefined) {
        return undefined;
    }
    return {
