...
export function ActiveMatchTeamFromJSON(json: any): ActiveMatchTeam {
    return json as ActiveMatchTeam;
}

export function ActiveMatchTeamToJSON(value?: ActiveMatchTeam): any {
    return value as any;
}
