...
import {
    GameServerInfo,
    GameServerInfoFromJSON,
    GameServerInfoToJSON,
} from './';
...
export interface ListServersResponse  {
    /**
     * 
     * @type {Array<GameServerInfo>}
     * @memberof ListServersResponse
     */
    servers: Array<GameServerInfo>;
}

export function ListServersResponseFromJSON(json: any): ListServersResponse {
    return {
        'servers': (json['servers'] as Array<any>).map(GameServerInfoFromJSON),
    };
}

export function ListServersResponseToJSON(value?: ListServersResponse): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        'servers': (value.servers as Array<any>).map(GameServerInfoToJSON),
    };
}
