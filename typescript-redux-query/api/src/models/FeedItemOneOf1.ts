 ...
 * @export
 */
export interface FeedItemOneOf1 extends SteamNews {
}

export function FeedItemOneOf1FromJSON(json: any): FeedItemOneOf1 {
    return {
        ...SteamNewsFromJSON(json),
    };
}

export function FeedItemOneOf1ToJSON(value?: FeedItemOneOf1): any {
    if (value === undefined) {
        return undefined;
    }
    return {
        ...SteamNewsToJSON(value),
    };
}
