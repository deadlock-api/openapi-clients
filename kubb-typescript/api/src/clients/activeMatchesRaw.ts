...
const res = await request<ActiveMatchesRawQueryResponse, ResponseErrorConfig<ActiveMatchesRaw500>, unknown>({ method : "GET", url : getActiveMatchesRawUrl().url.toString(), ... requestConfig })
return res.data
}