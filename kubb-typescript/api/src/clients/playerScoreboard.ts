...
export async function playerScoreboard(params: PlayerScoreboardQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<PlayerScoreboardQueryResponse, ResponseErrorConfig<PlayerScoreboard400 | PlayerScoreboard500>, unknown>({
    method: 'GET',
    url: getPlayerScoreboardUrl().url.toString(),
    params,
    ...requestConfig,
  })
  return res.data
