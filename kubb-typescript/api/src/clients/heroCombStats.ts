...
const res = await request<HeroCombStatsQueryResponse, ResponseErrorConfig<HeroCombStats400 | HeroCombStats500>, unknown>({ method : "GET", url : getHeroCombStatsUrl().url.toString(), params, ... requestConfig })
return res.data
}