...
const res = await request<SaltsQueryResponse, ResponseErrorConfig<Salts400 | Salts429 | Salts500>, unknown>({ method : "GET", url : getSaltsUrl(match_id).url.toString(), ... requestConfig })
return res.data
}