...
const res = await request<VariablesResolveQueryResponse, ResponseErrorConfig<VariablesResolve400>, unknown>({ method : "GET", url : getVariablesResolveUrl().url.toString(), params, ... requestConfig })
return res.data
}