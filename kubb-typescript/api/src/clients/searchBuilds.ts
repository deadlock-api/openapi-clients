...
export async function searchBuilds(params?: SearchBuildsQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<SearchBuildsQueryResponse, ResponseErrorConfig<SearchBuilds400 | SearchBuilds429 | SearchBuilds500>, unknown>({
    method: 'GET',
    url: getSearchBuildsUrl().url.toString(),
    params,
    ...requestConfig,
  })
  return res.data
