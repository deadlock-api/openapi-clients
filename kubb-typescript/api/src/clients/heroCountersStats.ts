...
const res = await request<HeroCountersStatsQueryResponse, ResponseErrorConfig<HeroCountersStats400 | HeroCountersStats500>, unknown>({ method : "GET", url : getHeroCountersStatsUrl().url.toString(), params, ... requestConfig })
return res.data
}