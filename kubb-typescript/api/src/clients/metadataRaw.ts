...
const res = await request<MetadataRawQueryResponse, ResponseErrorConfig<MetadataRaw400 | MetadataRaw404 | MetadataRaw429 | MetadataRaw500>, unknown>({ method : "GET", url : getMetadataRawUrl(match_id).url.toString(), ... requestConfig })
return res.data
}