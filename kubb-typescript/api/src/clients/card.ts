...
const res = await request<CardQueryResponse, ResponseErrorConfig<Card400 | Card429 | Card500>, unknown>({ method : "GET", url : getCardUrl(account_id).url.toString(), ... requestConfig })
return res.data
}