...
import type { ItemPermutationStatsQueryResponse, ItemPermutationStatsQueryParams, ItemPermutationStats400, ItemPermutationStats500 } from "../types/ItemPermutationStats.ts";
...
const res = await request<ItemPermutationStatsQueryResponse, ResponseErrorConfig<ItemPermutationStats400 | ItemPermutationStats500>, unknown>({ method : "GET", url : getItemPermutationStatsUrl().url.toString(), params, ... requestConfig })
return res.data
}