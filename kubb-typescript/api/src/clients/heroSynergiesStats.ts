...
import type {
  HeroSynergiesStatsQueryResponse,
  HeroSynergiesStatsQueryParams,
  HeroSynergiesStats400,
  HeroSynergiesStats500,
} from '../types/HeroSynergiesStats.ts'
...
export async function heroSynergiesStats(params?: HeroSynergiesStatsQueryParams, config: Partial<RequestConfig> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<HeroSynergiesStatsQueryResponse, ResponseErrorConfig<HeroSynergiesStats400 | HeroSynergiesStats500>, unknown>({
    method: 'GET',
    url: getHeroSynergiesStatsUrl().url.toString(),
    params,
    ...requestConfig,
  })
  return res.data
