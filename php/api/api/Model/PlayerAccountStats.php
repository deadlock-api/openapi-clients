...
/**
 * PlayerAccountStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PlayerAccountStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PlayerAccountStats';
    ...
    protected static $openAPITypes = [
        'account_id' => 'int',
        'stats' => '\OpenAPI\Client\Model\PlayerAccountHeroStats[]'
    ];
    ...
    */
    ...
    public function setAccountId($account_id)
    {
        ...
        if (($account_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $account_id when calling PlayerAccountStats., must be bigger than or equal to 0.');
        }
     ...
     * Gets stats
     *
     * @return \OpenAPI\Client\Model\PlayerAccountHeroStats[]
     */
     ...
     * Sets stats
     *
     * @param \OpenAPI\Client\Model\PlayerAccountHeroStats[] $stats stats
     *
     * @return self
     */
