...
/**
 * GetCustomMatchIdResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GetCustomMatchIdResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'GetCustomMatchIdResponse';
    ...
    */
    ...
    public function setMatchId($match_id)
    {
        ...
        if (($match_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $match_id when calling GetCustomMatchIdResponse., must be bigger than or equal to 0.');
        }
