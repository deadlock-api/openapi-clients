...
class ServerStatusResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ttl_secs', $data ?? [], null);
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['ttl_secs'] === null) {
            $invalidProperties[] = "'ttl_secs' can't be null";
        }
     ...
     * Sets server_id
     *
     * @param string $server_id The server ID that reported status
     *
     * @return self
     */
     ...
     * @return int
     */
    public function getTtlSecs()
    {
        return $this->container['ttl_secs'];
    }

    /**
     * Sets ttl_secs
     *
     * @param int $ttl_secs TTL in seconds before this registration expires
     *
     * @return self
     */
    public function setTtlSecs($ttl_secs)
    {
        if (is_null($ttl_secs)) {
            throw new \InvalidArgumentException('non-nullable ttl_secs cannot be null');
        }
        $this->container['ttl_secs'] = $ttl_secs;
