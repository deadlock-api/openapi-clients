...
/**
 * DistributionEntry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DistributionEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DistributionEntry';
    ...
    */
    ...
    public function setPlayers($players)
    {
        ...
        if (($players < 0)) {
            throw new \InvalidArgumentException('invalid value for $players when calling DistributionEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setRank($rank)
    {
        ...
        if (($rank < 0)) {
            throw new \InvalidArgumentException('invalid value for $rank when calling DistributionEntry., must be bigger than or equal to 0.');
        }
