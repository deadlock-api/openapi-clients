...
/**
 * HeroBanStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HeroBanStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HeroBanStats';
     ...
     * Sets bans
     *
     * @param int $bans The number of matches in which this hero was banned.
     *
     * @return self
     */
    ...
    {
        if (is_null($bans)) {
            throw new \InvalidArgumentException('non-nullable bans cannot be null');
        }

        if (($bans < 0)) {
            throw new \InvalidArgumentException('invalid value for $bans when calling HeroBanStats., must be bigger than or equal to 0.');
        }
    ...
    public function setHeroId($hero_id)
    {
        ...
        if (($hero_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $hero_id when calling HeroBanStats., must be bigger than or equal to 0.');
        }
