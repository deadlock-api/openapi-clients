...
class PlayerEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setAccountId($account_id)
    {
        ...
        if (($account_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $account_id when calling PlayerEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setMatches($matches)
    {
        ...
        if (($matches < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches when calling PlayerEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setRank($rank)
    {
        ...
        if (($rank < 0)) {
            throw new \InvalidArgumentException('invalid value for $rank when calling PlayerEntry., must be bigger than or equal to 0.');
        }
