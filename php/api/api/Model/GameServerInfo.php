...
/**
 * GameServerInfo Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class GameServerInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'GameServerInfo';
     ...
     *
     * @param int $current_player_count current_player_count
     *
     * @return self
     */
    public function setCurrentPlayerCount($current_player_count)
    {
        ...
        if (($current_player_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $current_player_count when calling GameServerInfo., must be bigger than or equal to 0.');
        }
    ...
    public function setPort($port)
    {
        ...
        if (($port < 0)) {
            throw new \InvalidArgumentException('invalid value for $port when calling GameServerInfo., must be bigger than or equal to 0.');
        }
