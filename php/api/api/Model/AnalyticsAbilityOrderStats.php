...
/**
 * AnalyticsAbilityOrderStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AnalyticsAbilityOrderStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AnalyticsAbilityOrderStats';
    ...
    */
    ...
    public function setLosses($losses)
    {
        ...
        if (($losses < 0)) {
            throw new \InvalidArgumentException('invalid value for $losses when calling AnalyticsAbilityOrderStats., must be bigger than or equal to 0.');
        }
    ...
    public function setMatches($matches)
    {
        ...
        if (($matches < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches when calling AnalyticsAbilityOrderStats., must be bigger than or equal to 0.');
        }
    ...
    public function setPlayers($players)
    {
        ...
        if (($players < 0)) {
            throw new \InvalidArgumentException('invalid value for $players when calling AnalyticsAbilityOrderStats., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalAssists($total_assists)
    {
        ...
        if (($total_assists < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_assists when calling AnalyticsAbilityOrderStats., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalDeaths($total_deaths)
    {
        ...
        if (($total_deaths < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_deaths when calling AnalyticsAbilityOrderStats., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalKills($total_kills)
    {
        ...
        if (($total_kills < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_kills when calling AnalyticsAbilityOrderStats., must be bigger than or equal to 0.');
        }
    ...
    public function setWins($wins)
    {
        ...
        if (($wins < 0)) {
            throw new \InvalidArgumentException('invalid value for $wins when calling AnalyticsAbilityOrderStats., must be bigger than or equal to 0.');
        }
