 ...
 */
class LiveUrl implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'LiveUrl';
    ...
    public function setLobbyId($lobby_id)
    {
        ...
        if (!is_null($lobby_id) && ($lobby_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $lobby_id when calling LiveUrl., must be bigger than or equal to 0.');
        }
    ...
    public function setMatchId($match_id)
    {
        ...
        if (($match_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $match_id when calling LiveUrl., must be bigger than or equal to 0.');
        }
