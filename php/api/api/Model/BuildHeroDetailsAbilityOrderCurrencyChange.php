...
class BuildHeroDetailsAbilityOrderCurrencyChange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setAbilityId($ability_id)
    {
        ...
        if (($ability_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $ability_id when calling BuildHeroDetailsAbilityOrderCurrencyChange., must be bigger than or equal to 0.');
        }
