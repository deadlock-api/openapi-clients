...
/**
 * HeroCombStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class HeroCombStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'HeroCombStats';
    ...
    */
    ...
    public function setLosses($losses)
    {
        ...
        if (($losses < 0)) {
            throw new \InvalidArgumentException('invalid value for $losses when calling HeroCombStats., must be bigger than or equal to 0.');
        }
    ...
    public function setMatches($matches)
    {
        ...
        if (($matches < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches when calling HeroCombStats., must be bigger than or equal to 0.');
        }
    ...
    public function setWins($wins)
    {
        ...
        if (($wins < 0)) {
            throw new \InvalidArgumentException('invalid value for $wins when calling HeroCombStats., must be bigger than or equal to 0.');
        }
