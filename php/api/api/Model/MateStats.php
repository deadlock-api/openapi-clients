 ...
 */
class MateStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MateStats';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mate_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mate_id'] === null) {
            $invalidProperties[] = "'mate_id' can't be null";
        }
        if (($this->container['mate_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'mate_id', must be bigger than or equal to 0.";
        }
    ...
    public function setMatchesPlayed($matches_played)
    {
        ...
        if (($matches_played < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches_played when calling MateStats., must be bigger than or equal to 0.');
        }
     ...
     * @return int
     */
    public function getMateId()
    {
        return $this->container['mate_id'];
    }

    /**
     * Sets mate_id
     *
     * @param int $mate_id mate_id
     *
     * @return self
     */
    public function setMateId($mate_id)
    {
        if (is_null($mate_id)) {
            throw new \InvalidArgumentException('non-nullable mate_id cannot be null');
        }

        if (($mate_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $mate_id when calling MateStats., must be bigger than or equal to 0.');
        }

        $this->container['mate_id'] = $mate_id;
    ...
    public function setWins($wins)
    {
        ...
        if (($wins < 0)) {
            throw new \InvalidArgumentException('invalid value for $wins when calling MateStats., must be bigger than or equal to 0.');
        }
