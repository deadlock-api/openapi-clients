...
/**
 * ActiveMatchMode Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class ActiveMatchMode
{
    ...
    public const PRIVATE_LOBBY = 'PrivateLobby';

    public const COOP_BOT = 'CoopBot';

    public const RANKED = 'Ranked';

    public const SERVER_TEST = 'ServerTest';
