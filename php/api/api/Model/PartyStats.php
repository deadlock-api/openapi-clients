 ...
 */
class PartyStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PartyStats';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('party_size', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['party_size'] === null) {
            $invalidProperties[] = "'party_size' can't be null";
        }
        if (($this->container['party_size'] < 0)) {
            $invalidProperties[] = "invalid value for 'party_size', must be bigger than or equal to 0.";
        }
    ...
    public function setMatchesPlayed($matches_played)
    {
        ...
        if (($matches_played < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches_played when calling PartyStats., must be bigger than or equal to 0.');
        }
     ...
     * Sets party_size
     *
     * @param int $party_size party_size
     *
     * @return self
     */
    public function setPartySize($party_size)
    {
        if (is_null($party_size)) {
            throw new \InvalidArgumentException('non-nullable party_size cannot be null');
        }

        if (($party_size < 0)) {
            throw new \InvalidArgumentException('invalid value for $party_size when calling PartyStats., must be bigger than or equal to 0.');
        }
    ...
    public function setWins($wins)
    {
        ...
        if (($wins < 0)) {
            throw new \InvalidArgumentException('invalid value for $wins when calling PartyStats., must be bigger than or equal to 0.');
        }
