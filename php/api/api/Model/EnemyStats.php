 ...
 */
class EnemyStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EnemyStats';
    ...
    {
        $this->setIfExists('enemy_id', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['enemy_id'] === null) {
            $invalidProperties[] = "'enemy_id' can't be null";
        }
        if (($this->container['enemy_id'] < 0)) {
            $invalidProperties[] = "invalid value for 'enemy_id', must be bigger than or equal to 0.";
        }
    ...
    {
        return $this->container['enemy_id'];
    }

    /**
     * Sets enemy_id
     *
     * @param int $enemy_id enemy_id
     *
     * @return self
     */
    public function setEnemyId($enemy_id)
    {
        if (is_null($enemy_id)) {
            throw new \InvalidArgumentException('non-nullable enemy_id cannot be null');
        }

        if (($enemy_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $enemy_id when calling EnemyStats., must be bigger than or equal to 0.');
        }

        $this->container['enemy_id'] = $enemy_id;
    ...
    public function setMatchesPlayed($matches_played)
    {
        ...
        if (($matches_played < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches_played when calling EnemyStats., must be bigger than or equal to 0.');
        }
     ...
     * Sets wins
     *
     * @param int $wins The amount of matches won against the enemy.
     *
     * @return self
     */
    public function setWins($wins)
    {
        ...
        if (($wins < 0)) {
            throw new \InvalidArgumentException('invalid value for $wins when calling EnemyStats., must be bigger than or equal to 0.');
        }
