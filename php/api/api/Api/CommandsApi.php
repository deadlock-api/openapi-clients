...
class CommandsApi
{
    ...
    public function availableVariablesWithHttpInfo(string $contentType = self::contentTypes['availableVariables'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\VariableDescription[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\VariableDescription[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\VariableDescription[]', []),
     ...
     * @param  string $region The players region (optional)
     * @param  string $template The command template to resolve (optional)
     * @param  string $hero_name Hero name to check for hero specific stats (optional)
     ...
     * @param  string $variables Variables to resolve, separated by commas. (optional)
     * @param  string $hero_name Hero name to check for hero specific stats (optional)
