...
class MMRApi
{
    ...
    public function heroMmrWithHttpInfo($account_ids, $hero_id, $max_match_id = null, string $contentType = self::contentTypes['heroMmr'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\MMRHistory[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\MMRHistory[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\MMRHistory[]', []),
