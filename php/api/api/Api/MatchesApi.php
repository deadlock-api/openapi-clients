...
class MatchesApi
{
     ...
     */
    public function badgeDistribution($min_unix_timestamp = null, $max_unix_timestamp = null, $min_match_id = null, $max_match_id = null, string $contentType = self::contentTypes['badgeDistribution'][0])
    {
        list($response) = $this->badgeDistributionWithHttpInfo($min_unix_timestamp, $max_unix_timestamp, $min_match_id, $max_match_id, $contentType);
        return $response;
    }
     ...
     */
    public function badgeDistributionWithHttpInfo($min_unix_timestamp = null, $max_unix_timestamp = null, $min_match_id = null, $max_match_id = null, string $contentType = self::contentTypes['badgeDistribution'][0])
    {
        $request = $this->badgeDistributionRequest($min_unix_timestamp, $max_unix_timestamp, $min_match_id, $max_match_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function badgeDistributionAsync($min_unix_timestamp = null, $max_unix_timestamp = null, $min_match_id = null, $max_match_id = null, string $contentType = self::contentTypes['badgeDistribution'][0])
    {
        return $this->badgeDistributionAsyncWithHttpInfo($min_unix_timestamp, $max_unix_timestamp, $min_match_id, $max_match_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function badgeDistributionAsyncWithHttpInfo($min_unix_timestamp = null, $max_unix_timestamp = null, $min_match_id = null, $max_match_id = null, string $contentType = self::contentTypes['badgeDistribution'][0])
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function badgeDistributionRequest($min_unix_timestamp = null, $max_unix_timestamp = null, $min_match_id = null, $max_match_id = null, string $contentType = self::contentTypes['badgeDistribution'][0])
    {



        if ($min_match_id !== null && $min_match_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$min_match_id" when calling MatchesApi.badgeDistribution, must be bigger than or equal to 0.');
        }
        
        if ($max_match_id !== null && $max_match_id < 0) {
            throw new \InvalidArgumentException('invalid value for "$max_match_id" when calling MatchesApi.badgeDistribution, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v1/matches/badge-distribution';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
