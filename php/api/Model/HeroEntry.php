 ...
 */
class HeroEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'HeroEntry';
    ...
    public function setHeroId($hero_id)
    {
        ...
        if (($hero_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $hero_id when calling HeroEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setMatches($matches)
    {
        ...
        if (($matches < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches when calling HeroEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setRank($rank)
    {
        ...
        if (($rank < 0)) {
            throw new \InvalidArgumentException('invalid value for $rank when calling HeroEntry., must be bigger than or equal to 0.');
        }
