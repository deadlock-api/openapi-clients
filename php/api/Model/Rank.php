...
class Rank implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'color' => 'string',
        'images' => '\OpenAPI\Client\Model\RankImages',
        'name' => 'string',
        'tier' => 'int'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if (($this->container['tier'] < 0)) {
            $invalidProperties[] = "invalid value for 'tier', must be bigger than or equal to 0.";
        }
     ...
     * Gets images
     *
     * @return \OpenAPI\Client\Model\RankImages
     */
     ...
     * Sets images
     *
     * @param \OpenAPI\Client\Model\RankImages $images images
     *
     * @return self
     */
    ...
    public function setTier($tier)
    {
        ...
        if (($tier < 0)) {
            throw new \InvalidArgumentException('invalid value for $tier when calling Rank., must be bigger than or equal to 0.');
        }
