...
/**
 * SeasonInterval Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class SeasonInterval implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SeasonInterval';
     ...
     * Sets end_timestamp
     *
     * @param int $end_timestamp Unix timestamp (seconds) at which the interval ends.
     *
     * @return self
     */
    ...
    public function setInterval($interval)
    {
        ...
        if (($interval < 0)) {
            throw new \InvalidArgumentException('invalid value for $interval when calling SeasonInterval., must be bigger than or equal to 0.');
        }
     ...
     *
     * @param int $start_timestamp Unix timestamp (seconds) at which the interval starts.
     *
     * @return self
     */
