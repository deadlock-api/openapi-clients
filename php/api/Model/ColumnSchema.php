...
/**
 * ColumnSchema Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ColumnSchema implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ColumnSchema';
     ...
     * Sets data_type
     *
     * @param string $data_type Arrow data type, rendered as its canonical textual form (e.g. `Int32`, `Utf8`).
     *
     * @return self
     */
