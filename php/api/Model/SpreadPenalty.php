...
/**
 * SpreadPenalty Class Doc Comment
 *
 * @category Class
 * @description Source data emits spread penalties as either a list of floats or a string (sometimes a comma-separated list, sometimes a literal label).
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class SpreadPenalty implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SpreadPenalty';
