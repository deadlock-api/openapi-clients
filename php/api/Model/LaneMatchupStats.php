...
/**
 * LaneMatchupStats Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class LaneMatchupStats implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'LaneMatchupStats';
    ...
    public function setAssignedLane($assigned_lane)
    {
        ...
        if (($assigned_lane < 0)) {
            throw new \InvalidArgumentException('invalid value for $assigned_lane when calling LaneMatchupStats., must be bigger than or equal to 0.');
        }
     ...
     * Sets matches_played
     *
     * @param int $matches_played The total number of lane matchups between `hero_ids` and `enemy_hero_ids` in this lane.
     *
     * @return self
     */
    public function setMatchesPlayed($matches_played)
    {
        ...
        if (($matches_played < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches_played when calling LaneMatchupStats., must be bigger than or equal to 0.');
        }
     ...
     * Sets wins
     *
     * @param int $wins The number of matches `hero_ids` won against `enemy_hero_ids` in this lane.
     *
     * @return self
     */
    public function setWins($wins)
    {
        ...
        if (($wins < 0)) {
            throw new \InvalidArgumentException('invalid value for $wins when calling LaneMatchupStats., must be bigger than or equal to 0.');
        }
