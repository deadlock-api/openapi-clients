...
/**
 * DemoQueryRequest Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DemoQueryRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DemoQueryRequest';
     ...
     * Sets format
     *
     * @param \OpenAPI\Client\Model\OutputFormat|null $format Output format of the result artifact.
     *
     * @return self
     */
     ...
     * Sets match_id
     *
     * @param int $match_id Match whose demo to query.
     *
     * @return self
     */
    public function setMatchId($match_id)
    {
        ...
        if (($match_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $match_id when calling DemoQueryRequest., must be bigger than or equal to 0.');
        }
     ...
     * Sets query
     *
     * @param string $query SQL query to run over the demo's entity/event tables (see `/demo/schema`).
     *
     * @return self
     */
