...
/**
 * TableSchemaResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class TableSchemaResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TableSchemaResponse';
    ...
    protected static $openAPITypes = [
        'columns' => '\OpenAPI\Client\Model\ColumnSchema[]',
        'kind' => 'string',
        'name' => 'string'
    ];
     ...
     * Gets columns
     *
     * @return \OpenAPI\Client\Model\ColumnSchema[]
     */
     ...
     * Sets columns
     *
     * @param \OpenAPI\Client\Model\ColumnSchema[] $columns columns
     *
     * @return self
     */
     ...
     * Sets kind
     *
     * @param string $kind `entity` for tables discovered from the demo's send-tables, `event` for the event tables common to every demo.
     *
     * @return self
     */
