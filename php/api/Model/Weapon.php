...
class Weapon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setHero($hero)
    {
        ...
        if (!is_null($hero) && ($hero < 0)) {
            throw new \InvalidArgumentException('invalid value for $hero when calling Weapon., must be bigger than or equal to 0.');
        }
    ...
    public function setId($id)
    {
        ...
        if (($id < 0)) {
            throw new \InvalidArgumentException('invalid value for $id when calling Weapon., must be bigger than or equal to 0.');
        }
