...
/**
 * DemoQueryJobResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DemoQueryJobResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DemoQueryJobResponse';
     ...
     * Sets job_id
     *
     * @param string $job_id Stable id of the job; poll `/demo/query/{job_id}` for status and the result URL.
     *
     * @return self
     */
