 ...
 */
class MatchPlayer implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MatchPlayer';
    ...
    public function setAccountId($account_id)
    {
        ...
        if (($account_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $account_id when calling MatchPlayer., must be bigger than or equal to 0.');
        }
