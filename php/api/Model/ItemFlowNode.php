...
/**
 * ItemFlowNode Class Doc Comment
 *
 * @category Class
 ...
 */
class ItemFlowNode implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ItemFlowNode';
    ...
    protected static $openAPIFormats = [
        'adjusted_win_rate' => 'double',
        'avg_net_worth_at_buy' => 'double',
        'column' => 'int32',
        'item_id' => 'int32',
        'losses' => 'int64',
        'matches' => 'int64',
    ...
    protected static array $openAPINullables = [
        'adjusted_win_rate' => false,
        'avg_net_worth_at_buy' => false,
        'column' => false,
        'item_id' => false,
        'losses' => false,
        'matches' => false,
    ...
    protected static $attributeMap = [
        ...
        'avg_net_worth_at_buy' => 'avg_net_worth_at_buy',
        'column' => 'column',
        'item_id' => 'item_id',
        'losses' => 'losses',
        'matches' => 'matches',
    ...
    protected static $setters = [
        'adjusted_win_rate' => 'setAdjustedWinRate',
        'avg_net_worth_at_buy' => 'setAvgNetWorthAtBuy',
        'column' => 'setColumn',
        'item_id' => 'setItemId',
        'losses' => 'setLosses',
        'matches' => 'setMatches',
    ...
    protected static $getters = [
        'adjusted_win_rate' => 'getAdjustedWinRate',
        'avg_net_worth_at_buy' => 'getAvgNetWorthAtBuy',
        'column' => 'getColumn',
        'item_id' => 'getItemId',
        'losses' => 'getLosses',
        'matches' => 'getMatches',
    ...
    {
        $this->setIfExists('adjusted_win_rate', $data ?? [], null);
        $this->setIfExists('avg_net_worth_at_buy', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['adjusted_win_rate'] === null) {
            $invalidProperties[] = "'adjusted_win_rate' can't be null";
        }
        if ($this->container['avg_net_worth_at_buy'] === null) {
            $invalidProperties[] = "'avg_net_worth_at_buy' can't be null";
        }
        if ($this->container['column'] === null) {
            $invalidProperties[] = "'column' can't be null";
        }
        if (($this->container['column'] < 0)) {
    ...
    /**
     * Gets adjusted_win_rate
     *
     * @return float
     */
    public function getAdjustedWinRate()
    {
        return $this->container['adjusted_win_rate'];
    }

    /**
     * Sets adjusted_win_rate
     *
     * @param float $adjusted_win_rate Win rate standardized to the stage's net-worth-at-buy distribution, removing the \"richer buyers win more\" confound. See the endpoint description.
     *
     * @return self
     */
    public function setAdjustedWinRate($adjusted_win_rate)
    {
        if (is_null($adjusted_win_rate)) {
            throw new \InvalidArgumentException('non-nullable adjusted_win_rate cannot be null');
        }
        $this->container['adjusted_win_rate'] = $adjusted_win_rate;

        return $this;
    }

    /**
     * Gets avg_net_worth_at_buy
     *
     * @return float
     */
    public function getAvgNetWorthAtBuy()
    {
        return $this->container['avg_net_worth_at_buy'];
    }

    /**
     * Sets avg_net_worth_at_buy
     *
     * @param float $avg_net_worth_at_buy Average net worth of buyers at the moment they bought this item (confound visibility).
     *
     * @return self
     */
    public function setAvgNetWorthAtBuy($avg_net_worth_at_buy)
    {
        if (is_null($avg_net_worth_at_buy)) {
            throw new \InvalidArgumentException('non-nullable avg_net_worth_at_buy cannot be null');
        }
        $this->container['avg_net_worth_at_buy'] = $avg_net_worth_at_buy;
     ...
     * Sets column
     *
     * @param int $column The phase column (0-based) the item was bought in.
     *
     * @return self
     */
    public function setColumn($column)
    {
        ...
        if (($column < 0)) {
            throw new \InvalidArgumentException('invalid value for $column when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setItemId($item_id)
    {
        ...
        if (($item_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setLosses($losses)
    {
        ...
        if (($losses < 0)) {
            throw new \InvalidArgumentException('invalid value for $losses when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setMatches($matches)
    {
        ...
        if (($matches < 0)) {
            throw new \InvalidArgumentException('invalid value for $matches when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setPlayers($players)
    {
        ...
        if (($players < 0)) {
            throw new \InvalidArgumentException('invalid value for $players when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalAssists($total_assists)
    {
        ...
        if (($total_assists < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_assists when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalDeaths($total_deaths)
    {
        ...
        if (($total_deaths < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_deaths when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setTotalKills($total_kills)
    {
        ...
        if (($total_kills < 0)) {
            throw new \InvalidArgumentException('invalid value for $total_kills when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
    ...
    public function setWins($wins)
    {
        ...
        if (($wins < 0)) {
            throw new \InvalidArgumentException('invalid value for $wins when calling ItemFlowNode., must be bigger than or equal to 0.');
        }
