...
/**
 * RankDistributionEntry Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RankDistributionEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'RankDistributionEntry';
     ...
     * Sets badge
     *
     * @param int $badge Rank badge, `tier * 10 + subrank`. See more: <https://api.deadlock-api.com/v1/assets/ranks>
     *
     * @return self
     */
    public function setBadge($badge)
    {
        ...
        if (($badge < 0)) {
            throw new \InvalidArgumentException('invalid value for $badge when calling RankDistributionEntry., must be bigger than or equal to 0.');
        }
     ...
     * Sets players
     *
     * @param int $players Number of players whose rank at the end of their latest ranked match in the filtered range is this badge.
     *
     * @return self
     */
    public function setPlayers($players)
    {
        ...
        if (($players < 0)) {
            throw new \InvalidArgumentException('invalid value for $players when calling RankDistributionEntry., must be bigger than or equal to 0.');
        }
    ...
    public function setRank($rank)
    {
        ...
        if (($rank < 0)) {
            throw new \InvalidArgumentException('invalid value for $rank when calling RankDistributionEntry., must be bigger than or equal to 0.');
        }
     ...
     * Sets subrank
     *
     * @param int $subrank Sub-rank within the tier.
     *
     * @return self
     */
    public function setSubrank($subrank)
    {
        ...
        if (($subrank < 0)) {
            throw new \InvalidArgumentException('invalid value for $subrank when calling RankDistributionEntry., must be bigger than or equal to 0.');
        }
