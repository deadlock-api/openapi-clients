...
class SteamInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string $version_datetime `version_date` + `version_time` combined into a naive ISO-8601 string (`YYYY-MM-DDTHH:MM:SS`, no timezone) — matches the Python output.
     *
     * @return self
     */
