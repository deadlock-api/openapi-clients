...
/**
 * DemoSchemaResponse Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DemoSchemaResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DemoSchemaResponse';
    ...
    protected static $openAPITypes = [
        'demo_url' => 'string',
        'match_id' => 'int',
        'tables' => '\OpenAPI\Client\Model\TableSchemaResponse[]'
    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['demo_url'] === null) {
            $invalidProperties[] = "'demo_url' can't be null";
        }
    ...
    {
        if (is_null($demo_url)) {
            throw new \InvalidArgumentException('non-nullable demo_url cannot be null');
        }
    ...
    public function setMatchId($match_id)
    {
        ...
        if (($match_id < 0)) {
            throw new \InvalidArgumentException('invalid value for $match_id when calling DemoSchemaResponse., must be bigger than or equal to 0.');
        }
     ...
     * Gets tables
     *
     * @return \OpenAPI\Client\Model\TableSchemaResponse[]
     */
     ...
     * Sets tables
     *
     * @param \OpenAPI\Client\Model\TableSchemaResponse[] $tables tables
     *
     * @return self
     */
