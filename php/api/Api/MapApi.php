...
class MapApi
{
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getMap'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->getMapWithHttpInfo($client_version, $contentType);
        return $response;
    }
     ...
     */
    public function getMapAsync($client_version = null, string $contentType = self::contentTypes['getMap'][0])
    {
        return $this->getMapAsyncWithHttpInfo($client_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function getMapRequest($client_version = null, string $contentType = self::contentTypes['getMap'][0])
    {

        if ($client_version !== null && $client_version < 0) {
            throw new \InvalidArgumentException('invalid value for "$client_version" when calling MapApi.getMap, must be bigger than or equal to 0.');
        }
        

        $resourcePath = '/v1/assets/map';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
