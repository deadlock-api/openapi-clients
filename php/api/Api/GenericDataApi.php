...
class GenericDataApi
{
    ...
    /**
     * Operation getGenericDataWithHttpInfo
     *
     * Get Generic Data
     *
     * @param  int|null $client_version Client/game version (e.g. &#x60;6518&#x60;). Defaults to the latest known version. (optional)
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\GenericData',
                        $request,
                        $response,
                    );
            }
    ...
    /**
     * Operation getGenericDataAsyncWithHttpInfo
     *
     * Get Generic Data
     *
     * @param  int|null $client_version Client/game version (e.g. &#x60;6518&#x60;). Defaults to the latest known version. (optional)
    ...
    public function getGenericDataRequest($client_version = null, string $contentType = self::contentTypes['getGenericData'][0])
    {
        ...
        $resourcePath = '/v1/assets/generic-data';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
