...
**health_bar_color_friend** | [**\OpenAPI\Client\Model\HealthBarColorFriend**](HealthBarColorFriend.md) |  | [optional]
**health_bar_color_enemy** | [**\OpenAPI\Client\Model\HealthBarColorEnemy**](HealthBarColorEnemy.md) |  | [optional]
**health_bar_color_team1** | [**\OpenAPI\Client\Model\HealthBarColorTeam1**](HealthBarColorTeam1.md) |  | [optional]
**health_bar_color_team2** | [**\OpenAPI\Client\Model\HealthBarColorTeam2**](HealthBarColorTeam2.md) |  | [optional]
**health_bar_color_team_neutral** | [**\OpenAPI\Client\Model\HealthBarColorTeamNeutral**](HealthBarColorTeamNeutral.md) |  | [optional]
**glow_color_friend** | [**\OpenAPI\Client\Model\GlowColorFriend**](GlowColorFriend.md) |  | [optional]
**glow_color_enemy** | [**\OpenAPI\Client\Model\GlowColorEnemy**](GlowColorEnemy.md) |  | [optional]
**glow_color_team1** | [**\OpenAPI\Client\Model\GlowColorTeam1**](GlowColorTeam1.md) |  | [optional]
**glow_color_team2** | [**\OpenAPI\Client\Model\GlowColorTeam2**](GlowColorTeam2.md) |  | [optional]
**glow_color_team_neutral** | [**\OpenAPI\Client\Model\GlowColorTeamNeutral**](GlowColorTeamNeutral.md) |  | [optional]
**id** | **int** |  | [readonly]
