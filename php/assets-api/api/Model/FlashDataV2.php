 ...
 */
class FlashDataV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'FlashDataV2';
    ...
    */
     ...
     * Sets color
     *
     * @param \OpenAPI\Client\Model\ColorV1 $color color
     *
     * @return self
     */
    ...
    /**
     * Gets brightness_in_light_sensitivity_mode
     *
     * @return float|null
     */
    public function getBrightnessInLightSensitivityMode()
    {
        return $this->container['brightness_in_light_sensitivity_mode'];
    }

    /**
     * Sets brightness_in_light_sensitivity_mode
     *
     * @param float|null $brightness_in_light_sensitivity_mode brightness_in_light_sensitivity_mode
     *
     * @return self
     */
    public function setBrightnessInLightSensitivityMode($brightness_in_light_sensitivity_mode)
    {
        if (is_null($brightness_in_light_sensitivity_mode)) {
            array_push($this->openAPINullablesSetToNull, 'brightness_in_light_sensitivity_mode');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('brightness_in_light_sensitivity_mode', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['brightness_in_light_sensitivity_mode'] = $brightness_in_light_sensitivity_mode;
