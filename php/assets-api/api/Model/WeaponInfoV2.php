...
class WeaponInfoV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shots_per_second'] === null && !$this->isNullableSetToNull('shots_per_second')) {
            $invalidProperties[] = "'shots_per_second' is required";
        }
        if ($this->container['shots_per_second_with_reload'] === null && !$this->isNullableSetToNull('shots_per_second_with_reload')) {
            $invalidProperties[] = "'shots_per_second_with_reload' is required";
        }
        if ($this->container['bullets_per_second'] === null && !$this->isNullableSetToNull('bullets_per_second')) {
            $invalidProperties[] = "'bullets_per_second' is required";
        }
        if ($this->container['bullets_per_second_with_reload'] === null && !$this->isNullableSetToNull('bullets_per_second_with_reload')) {
            $invalidProperties[] = "'bullets_per_second_with_reload' is required";
        }
        if ($this->container['damage_per_second'] === null && !$this->isNullableSetToNull('damage_per_second')) {
            $invalidProperties[] = "'damage_per_second' is required";
        }
        if ($this->container['damage_per_second_with_reload'] === null && !$this->isNullableSetToNull('damage_per_second_with_reload')) {
            $invalidProperties[] = "'damage_per_second_with_reload' is required";
        }
        if ($this->container['damage_per_shot'] === null && !$this->isNullableSetToNull('damage_per_shot')) {
            $invalidProperties[] = "'damage_per_shot' is required";
        }
        if ($this->container['damage_per_magazine'] === null && !$this->isNullableSetToNull('damage_per_magazine')) {
            $invalidProperties[] = "'damage_per_magazine' is required";
        }
     ...
     *
     * @param float|null $shots_per_second Calculates the shots per second of the weapon
     *
     * @return self
     */
     ...
     *
     * @param float|null $shots_per_second_with_reload Calculates the shots per second of the weapon adjusted for reload time
     *
     * @return self
     */
     ...
     *
     * @param float|null $bullets_per_second Calculates the bullets per second of the weapon, by multiplying shots per second by bullets per shot.
     *
     * @return self
     */
     ...
     *
     * @param float|null $bullets_per_second_with_reload Calculates the bullets per second of the weapon adjusted for reload time.
     *
     * @return self
     */
     ...
     *
     * @param float|null $damage_per_second Calculates the damage per second of the weapon, by multiplying bullets per second by bullet damage.
     *
     * @return self
     */
     ...
     *
     * @param float|null $damage_per_second_with_reload Calculates the damage per second of the weapon adjusted for reload time.
     *
     * @return self
     */
     ...
     *
     * @param float|null $damage_per_shot Calculates the damage per shot of the weapon, by multiplying bullets per shot by bullet damage.
     *
     * @return self
     */
     ...
     *
     * @param float|null $damage_per_magazine Calculates the damage per magazine of the weapon, by multiplying clip size by damage per shot.
     *
     * @return self
     */
