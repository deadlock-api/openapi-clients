...
/**
 * ItemDraftsValue Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ItemDraftsValue implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'Item_Drafts_value';
    ...
    protected static $openAPITypes = [
        'bucket' => '\OpenAPI\Client\Model\DraftBucket',
        'name' => 'string'
    ];
     ...
     * Gets bucket
     *
     * @return \OpenAPI\Client\Model\DraftBucket|null
     */
     ...
     * Sets bucket
     *
     * @param \OpenAPI\Client\Model\DraftBucket|null $bucket bucket
     *
     * @return self
     */
