...
/**
 * UpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpgradeTooltipSectionAttributeV2ImportantPropertyWithIcon';
    ...
    */
    ...
    public function setLocalizedName($localized_name)
    {
        if (is_null($localized_name)) {
            array_push($this->openAPINullablesSetToNull, 'localized_name');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('localized_name', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
