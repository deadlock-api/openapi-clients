...
/**
 * RawAbilityV2 Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RawAbilityV2 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RawAbilityV2';
    ...
    */
    ...
    public function setBehaviourBits($behaviour_bits)
    {
        if (is_null($behaviour_bits)) {
            array_push($this->openAPINullablesSetToNull, 'behaviour_bits');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('behaviour_bits', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
