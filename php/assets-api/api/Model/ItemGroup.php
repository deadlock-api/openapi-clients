...
class ItemGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('shop_group', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['shop_group'] === null) {
            $invalidProperties[] = "'shop_group' can't be null";
        }
    ...
    {
        return $this->container['shop_group'];
    }

    /**
     * Sets shop_group
     *
     * @param string $shop_group shop_group
     *
     * @return self
     */
    public function setShopGroup($shop_group)
    {
        if (is_null($shop_group)) {
            throw new \InvalidArgumentException('non-nullable shop_group cannot be null');
        }
        $this->container['shop_group'] = $shop_group;
     ...
     * Sets upgrades
     *
     * @param string[] $upgrades upgrades
     *
     * @return self
     */
