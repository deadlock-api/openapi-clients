 ...
 */
class DraftBucket implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DraftBucket';
     ...
     * Sets normal
     *
     * @param float|null $normal normal
     *
     * @return self
     */
    ...
    {
        if (is_null($normal)) {
            array_push($this->openAPINullablesSetToNull, 'normal');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('normal', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (is_null($good)) {
            array_push($this->openAPINullablesSetToNull, 'good');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('good', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
