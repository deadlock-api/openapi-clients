...
class ItemsApi
{
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \OpenAPI\Client\Model\ResponseGetItemsV2ItemsGetInner[]|\OpenAPI\Client\Model\HTTPValidationError
     */
     ...
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \OpenAPI\Client\Model\ResponseGetItemsV2ItemsGetInner[]|\OpenAPI\Client\Model\HTTPValidationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getItemsByHeroIdV2ItemsByHeroIdIdGetWithHttpInfo($id, $language = null, $client_version = null, string $contentType = self::contentTypes['getItemsByHeroIdV2ItemsByHeroIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    return $this->handleResponseWithDataType(
                        '\OpenAPI\Client\Model\ResponseGetItemsV2ItemsGetInner[]',
                        $request,
                        $response,
                    );
                case 422:
    ...
    {
        $returnType = '\OpenAPI\Client\Model\ResponseGetItemsV2ItemsGetInner[]';
        $request = $this->getItemsByHeroIdV2ItemsByHeroIdIdGetRequest($id, $language, $client_version, $contentType);
