...
class ItemsApi
{
    ...
    public function getItemV2ItemsIdOrClassNameGetWithHttpInfo($id_or_class_name, $language = null, $client_version = null, string $contentType = self::contentTypes['getItemV2ItemsIdOrClassNameGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\ResponseGetItemV2ItemsIdOrClassNameGet' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\ResponseGetItemV2ItemsIdOrClassNameGet' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\ResponseGetItemV2ItemsIdOrClassNameGet', []),
    ...
    public function getItemsByHeroIdV2ItemsByHeroIdIdGetWithHttpInfo($id, $language = null, $client_version = null, string $contentType = self::contentTypes['getItemsByHeroIdV2ItemsByHeroIdIdGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\GetItemsV2ItemsGet200ResponseInner[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\GetItemsV2ItemsGet200ResponseInner[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\GetItemsV2ItemsGet200ResponseInner[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
     ...
     *
     * @param  ItemSlotTypeV2 $slot_type slot_type (required)
     * @param  Language $language language (optional)
     * @param  ValidClientVersions $client_version client_version (optional)
     ...
     * Get Items By Slot Type
     *
     * @param  ItemSlotTypeV2 $slot_type (required)
     * @param  Language $language (optional)
     * @param  ValidClientVersions $client_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getItemsBySlotTypeV2ItemsBySlotTypeSlotTypeGet'] to see the possible values for this operation
     *
     ...
     * Get Items By Type
     *
     * @param  ItemTypeV2 $type type (required)
     * @param  Language $language language (optional)
     * @param  ValidClientVersions $client_version client_version (optional)
     ...
     * Get Items By Type
     *
     * @param  ItemTypeV2 $type (required)
     * @param  Language $language (optional)
     * @param  ValidClientVersions $client_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getItemsByTypeV2ItemsByTypeTypeGet'] to see the possible values for this operation
     *
