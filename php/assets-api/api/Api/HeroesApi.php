...
class HeroesApi
{
    ...
    public function getHeroByNameV2HeroesByNameNameGetWithHttpInfo($name, $language = null, $client_version = null, string $contentType = self::contentTypes['getHeroByNameV2HeroesByNameNameGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\HeroV2' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\HeroV2' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\HeroV2', []),
     ...
     * @param  Language $language language (optional)
     * @param  ValidClientVersions $client_version client_version (optional)
     * @param  bool $only_active only_active (optional)
