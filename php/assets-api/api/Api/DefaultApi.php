...
class DefaultApi
{
     ...
     * @param  ValidClientVersions $client_version client_version (optional)
     ...
     * @param  ValidClientVersions $client_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getBuildTagsV2BuildTagsGet'] to see the possible values for this operation
     *
     * @throws \OpenAPI\Client\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
    ...
    public function getBuildTagsV2BuildTagsGetWithHttpInfo($language = null, $client_version = null, string $contentType = self::contentTypes['getBuildTagsV2BuildTagsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\BuildTagV2[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\BuildTagV2[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\BuildTagV2[]', []),
    ...
    public function getColorsV1ColorsGetWithHttpInfo($client_version = null, string $contentType = self::contentTypes['getColorsV1ColorsGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('array<string,\OpenAPI\Client\Model\ColorV1>' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('array<string,\OpenAPI\Client\Model\ColorV1>' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, 'array<string,\OpenAPI\Client\Model\ColorV1>', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
    ...
    public function getMapV1MapGetWithHttpInfo($client_version = null, string $contentType = self::contentTypes['getMapV1MapGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\MapV1' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\MapV1' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\MapV1', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
    ...
    public function getRanksV2RanksGetWithHttpInfo($language = null, $client_version = null, string $contentType = self::contentTypes['getRanksV2RanksGet'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\OpenAPI\Client\Model\RankV2[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\OpenAPI\Client\Model\RankV2[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\RankV2[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 422:
