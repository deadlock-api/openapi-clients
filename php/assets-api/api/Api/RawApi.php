...
class RawApi
{
    ...
    /**
     * Operation getRawAccoladesRawAccoladesGet
     *
     * Get Raw Accolades
     *
     * @param  \OpenAPIClientModelDeadlockAssetsApiRoutesValidClientVersions|null $client_version client_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRawAccoladesRawAccoladesGet'] to see the possible values for this operation
     *
    ...
    {
        list($response) = $this->getRawAccoladesRawAccoladesGetWithHttpInfo($client_version, $contentType);
        return $response;
    }

    /**
     * Operation getRawAccoladesRawAccoladesGetWithHttpInfo
     *
     * Get Raw Accolades
     *
    ...
    /**
     * Operation getRawAccoladesRawAccoladesGetAsync
     *
     * Get Raw Accolades
     *
     * @param  \OpenAPIClientModelDeadlockAssetsApiRoutesValidClientVersions|null $client_version (optional)
     ...
     */
    public function getRawAccoladesRawAccoladesGetAsync($client_version = null, string $contentType = self::contentTypes['getRawAccoladesRawAccoladesGet'][0])
    {
        return $this->getRawAccoladesRawAccoladesGetAsyncWithHttpInfo($client_version, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRawAccoladesRawAccoladesGetAsyncWithHttpInfo
     *
     * Get Raw Accolades
     *
     * @param  \OpenAPIClientModelDeadlockAssetsApiRoutesValidClientVersions|null $client_version (optional)
    ...
    /**
     * Create request for operation 'getRawAccoladesRawAccoladesGet'
     *
     * @param  \OpenAPIClientModelDeadlockAssetsApiRoutesValidClientVersions|null $client_version (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getRawAccoladesRawAccoladesGet'] to see the possible values for this operation
     *
     ...
     */
    public function getRawAccoladesRawAccoladesGetRequest($client_version = null, string $contentType = self::contentTypes['getRawAccoladesRawAccoladesGet'][0])
    {



        $resourcePath = '/raw/accolades';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
