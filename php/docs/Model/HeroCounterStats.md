...
**enemy_hero_id** | **int** | The ID of the opposing hero. See more: &lt;https://api.deadlock-api.com/v1/assets/heroes&gt; |
...
**hero_id** | **int** | The ID of the hero. See more: &lt;https://api.deadlock-api.com/v1/assets/heroes&gt; |
