...
/** See more: <https://api.deadlock-api.com/v1/assets/heroes> */
hero_id?: (Scalars['Int'] | null),build_id?: (Scalars['Int'] | null),version?: (Scalars['Int'] | null),
/** The author's `SteamID3`. */
author_id?: (Scalars['Int'] | null),language?: (BuildLanguage | null),tag?: (Scalars['Int'] | null),rollup_category?: (Scalars['Int'] | null),
 ...
 */
export interface MatchPlayerWhere {match_id?: (U64Filter | null),account_id?: (U32Filter | null),hero_id?: (U32Filter | null),player_slot?: (U32Filter | null),team?: (StringFilter | null),start_time?: (I64Filter | null),duration_s?: (U32Filter | null),match_mode?: (StringFilter | null),game_mode?: (StringFilter | null),winning_team?: (StringFilter | null),match_outcome?: (StringFilter | null),average_badge_team_0?: (U32Filter | null),average_badge_team_1?: (U32Filter | null),average_badge?: (U32Filter | null),is_high_skill_range_parties?: (BoolFilter | null),low_pri_pool?: (BoolFilter | null),new_player_pool?: (BoolFilter | null),not_scored?: (BoolFilter | null),rewards_eligible?: (BoolFilter | null),kills?: (U32Filter | null),deaths?: (U32Filter | null),assists?: (U32Filter | null),net_worth?: (U32Filter | null),player_level?: (U32Filter | null),assigned_lane?: (U32Filter | null),last_hits?: (U32Filter | null),denies?: (U32Filter | null),mvp_rank?: (U32Filter | null),player_rank_initial_display_rank?: (U32Filter | null),player_rank_initial_flat_progress?: (U32Filter | null),player_rank_final_flat_progress?: (U32Filter | null),player_rank_desired_progress_change?: (I32Filter | null),player_rank_initial_calibration_games?: (U32Filter | null),player_rank_initial_demotion_protection_games?: (U32Filter | null),player_rank_consumed_demotion_protection?: (BoolFilter | null),player_rank_initial_win_streak?: (U32Filter | null)}
...
export interface MatchSaltsWhere {match_id?: (U64Filter | null),cluster_id?: (U32Filter | null)}
...
export interface PatchWhere {source?: (StringFilter | null),category?: (StringFilter | null),pub_date?: (I64Filter | null),
...
export interface QueryRootGenqlSelection{
     ...
     * paging, so a page can hold slightly fewer than `limit` nodes.
     */
    match_salts?: (MatchSaltsGenqlSelection & { __args?: {where?: (MatchSaltsWhere | null), order_direction?: (OrderDirection | null), limit?: Scalars['Int'], offset?: Scalars['Int']} })
    /**
     * Patch notes from the official forum changelog and the Steam news feed —
     * the same data as the REST `/v2/patches` feed, so only as far back as
     * those RSS feeds reach. Ordered by `pub_date`. Every patch can scope the
     * match queries to the time it was live.
     */
    patches?: (PatchGenqlSelection & { __args?: {where?: (PatchWhere | null), order_direction?: (OrderDirection | null), limit?: Scalars['Int'], offset?: Scalars['Int']} })
    /**
     * Hero builds from the stored `hero_builds` table — the same data as the
     * REST `/v1/builds` search. Every version of a build is returned unless
     * `where.only_latest` is set.
     */
    hero_builds?: (BuildGenqlSelection & { __args?: {where?: (HeroBuildWhere | null), order_by?: (OrderByHeroBuild | null), order_direction?: (OrderDirection | null), limit?: Scalars['Int'], offset?: Scalars['Int']} })
    /**
     * All heroes for the given client version (defaults to latest), localized
     * to `language` (defaults to English). Sourced from the versioned assets,
     * not ClickHouse.
...
export type QueryGenqlSelection = QueryRootGenqlSelection
    ...
    const BuildHero_possibleTypes: string[] = ['BuildHero']
    export const isBuildHero = (obj?: { __typename?: any } | null): obj is BuildHero => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBuildHero"')
      return BuildHero_possibleTypes.includes(obj.__typename)
    }
    


    const BuildHeroDetails_possibleTypes: string[] = ['BuildHeroDetails']
    export const isBuildHeroDetails = (obj?: { __typename?: any } | null): obj is BuildHeroDetails => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBuildHeroDetails"')
      return BuildHeroDetails_possibleTypes.includes(obj.__typename)
    }
    


    const BuildHeroDetailsAbilityOrder_possibleTypes: string[] = ['BuildHeroDetailsAbilityOrder']
    export const isBuildHeroDetailsAbilityOrder = (obj?: { __typename?: any } | null): obj is BuildHeroDetailsAbilityOrder => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBuildHeroDetailsAbilityOrder"')
      return BuildHeroDetailsAbilityOrder_possibleTypes.includes(obj.__typename)
    }
    


    const BuildHeroDetailsAbilityOrderCurrencyChange_possibleTypes: string[] = ['BuildHeroDetailsAbilityOrderCurrencyChange']
    export const isBuildHeroDetailsAbilityOrderCurrencyChange = (obj?: { __typename?: any } | null): obj is BuildHeroDetailsAbilityOrderCurrencyChange => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBuildHeroDetailsAbilityOrderCurrencyChange"')
      return BuildHeroDetailsAbilityOrderCurrencyChange_possibleTypes.includes(obj.__typename)
    }
    


    const BuildHeroDetailsCategory_possibleTypes: string[] = ['BuildHeroDetailsCategory']
    export const isBuildHeroDetailsCategory = (obj?: { __typename?: any } | null): obj is BuildHeroDetailsCategory => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBuildHeroDetailsCategory"')
      return BuildHeroDetailsCategory_possibleTypes.includes(obj.__typename)
    }
    


    const BuildHeroDetailsCategoryAbility_possibleTypes: string[] = ['BuildHeroDetailsCategoryAbility']
    export const isBuildHeroDetailsCategoryAbility = (obj?: { __typename?: any } | null): obj is BuildHeroDetailsCategoryAbility => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isBuildHeroDetailsCategoryAbility"')
    ...
    const MatchSalts_possibleTypes: string[] = ['MatchSalts']
    export const isMatchSalts = (obj?: { __typename?: any } | null): obj is MatchSalts => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isMatchSalts"')
      return MatchSalts_possibleTypes.includes(obj.__typename)
    }
    


    const Patch_possibleTypes: string[] = ['Patch']
    export const isPatch = (obj?: { __typename?: any } | null): obj is Patch => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isPatch"')
    ...
    const UpgradePurchase_possibleTypes: string[] = ['UpgradePurchase']
    export const isUpgradePurchase = (obj?: { __typename?: any } | null): obj is UpgradePurchase => {
      if (!obj?.__typename) throw new Error('__typename is missing in "isUpgradePurchase"')
...
export const enumBuildLanguage = {
   ...
   SPANISH_SPAIN: 'SPANISH_SPAIN' as const,
   CHINESE_SIMPLIFIED: 'CHINESE_SIMPLIFIED' as const,
   RUSSIAN: 'RUSSIAN' as const,
   THAI: 'THAI' as const,
   JAPANESE: 'JAPANESE' as const,
   PORTUGUESE_PORTUGAL: 'PORTUGUESE_PORTUGAL' as const,
   POLISH: 'POLISH' as const,
   CZECH: 'CZECH' as const,
   TURKISH: 'TURKISH' as const,
   PORTUGUESE_BRAZIL: 'PORTUGUESE_BRAZIL' as const,
   UKRAINIAN: 'UKRAINIAN' as const,
   SPANISH_LATIN_AMERICA: 'SPANISH_LATIN_AMERICA' as const,
...
export const enumOrderByHeroBuild = {
   WEEKLY_FAVORITES: 'WEEKLY_FAVORITES' as const,
   FAVORITES: 'FAVORITES' as const,
   IGNORES: 'IGNORES' as const,
...
export const enumOrderByMatchPlayer = {
   ...
   ACCOUNT_ID: 'ACCOUNT_ID' as const,
   START_TIME: 'START_TIME' as const,
   LAST_HITS: 'LAST_HITS' as const,
   DENIES: 'DENIES' as const,
   MVP_RANK: 'MVP_RANK' as const,
   PLAYER_RANK_INITIAL_DISPLAY_RANK: 'PLAYER_RANK_INITIAL_DISPLAY_RANK' as const,
   PLAYER_RANK_INITIAL_FLAT_PROGRESS: 'PLAYER_RANK_INITIAL_FLAT_PROGRESS' as const,
   PLAYER_RANK_FINAL_FLAT_PROGRESS: 'PLAYER_RANK_FINAL_FLAT_PROGRESS' as const,
   PLAYER_RANK_DESIRED_PROGRESS_CHANGE: 'PLAYER_RANK_DESIRED_PROGRESS_CHANGE' as const,
   PLAYER_RANK_INITIAL_CALIBRATION_GAMES: 'PLAYER_RANK_INITIAL_CALIBRATION_GAMES' as const,
   PLAYER_RANK_INITIAL_DEMOTION_PROTECTION_GAMES: 'PLAYER_RANK_INITIAL_DEMOTION_PROTECTION_GAMES' as const,
   PLAYER_RANK_CONSUMED_DEMOTION_PROTECTION: 'PLAYER_RANK_CONSUMED_DEMOTION_PROTECTION' as const,
   PLAYER_RANK_INITIAL_WIN_STREAK: 'PLAYER_RANK_INITIAL_WIN_STREAK' as const
}
