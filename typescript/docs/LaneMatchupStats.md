...
**net_worth_diff_15min** | **number** | Mean souls the duo is ahead by 15 minutes in, against that duo. Negative means behind. &#x60;0&#x60; when no counted matchup had net-worth samples for all four players. | [default to undefined]
