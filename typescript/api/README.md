...
```
npm install deadlock-api-client@0.1.0 --save
```
...
*PlayersApi* | [**steamBatch**](docs/PlayersApi.md#steambatch) | **GET** /v1/players/steam | Batch Steam Profile
