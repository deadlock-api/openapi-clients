...
|[**steam**](#steam) | **GET** /v1/players/{account_id}/steam | Steam Profile|
|[**steamBatch**](#steambatch) | **GET** /v1/players/steam | Batch Steam Profile|
...
const { status, data } = await apiInstance.steamBatch(
    accountIds
);
```
