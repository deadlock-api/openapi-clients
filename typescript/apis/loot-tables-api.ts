 ...
 */
export const LootTablesApiFp = function(configuration?: Configuration) {
 ...
 */
export const LootTablesApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
