...
**weapon_info** | [**RawWeaponInfoV2Input**](RawWeaponInfoV2Input.md) |  | [optional] [default to undefined]
**type** | **string** |  | [optional] [default to TypeEnum_Weapon]

## Example

```typescript
import { WeaponV2Input } from 'assets-deadlock-api-client';

const instance: WeaponV2Input = {
    id,
    class_name,
    name,
    start_trained,
