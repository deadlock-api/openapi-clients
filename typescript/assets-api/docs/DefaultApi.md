...
|[**getFontsV1FontsGet**](#getfontsv1fontsget) | **GET** /v1/fonts | Get Fonts|
...
|[**getLootTablesV2LootTablesGet**](#getloottablesv2loottablesget) | **GET** /v2/loot-tables | Get Loot Tables|
...
# **getFontsV1FontsGet**
> { [key: string]: string; } getFontsV1FontsGet()
...
> { [key: string]: LootTableV2; } getLootTablesV2LootTablesGet()
...
const { status, data } = await apiInstance.getLootTablesV2LootTablesGet(
    clientVersion
);
```
