 ...
 */
export const CommandsApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         */
        availableVariables: async (options = {}) => {
         ...
         * @throws {RequiredError}
         */
        commandResolve: async (accountId, region, template, heroName, options = {}) => {
         ...
         * @throws {RequiredError}
         */
        variablesResolve: async (accountId, region, variables, heroName, options = {}) => {
            // verify required parameter 'accountId' is not null or undefined
 ...
 */
export const CommandsApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async availableVariables(options) {
         ...
         * @throws {RequiredError}
         */
        async commandResolve(accountId, region, template, heroName, options) {
         ...
         * @throws {RequiredError}
         */
        async variablesResolve(accountId, region, variables, heroName, options) {
 ...
 */
export const CommandsApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        commandResolve(requestParameters, options) {
         ...
         * @throws {RequiredError}
         */
        variablesResolve(requestParameters, options) {
...
//# sourceMappingURL=commands-api.js.map