...
export declare const GraphQLApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    playground: (options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const GraphQLApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    playground(options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<void>>;
};
/**
