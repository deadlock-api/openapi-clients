 ...
 */
export const NPCUnitsApiAxiosParamCreator = function (configuration) {
    return {
        /**
 ...
 */
export const NPCUnitsApiFp = function (configuration) {
 ...
 */
export const NPCUnitsApiFactory = function (configuration, basePath, axios) {
