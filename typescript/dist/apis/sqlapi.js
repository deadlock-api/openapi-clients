 ...
 */
export const SQLApiAxiosParamCreator = function (configuration) {
    return {
        /**
         ...
         * @throws {RequiredError}
         */
        tableSchema: async (table, options = {}) => {
 ...
 */
export const SQLApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async tableSchema(table, options) {
 ...
 */
export const SQLApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        tableSchema(requestParameters, options) {
