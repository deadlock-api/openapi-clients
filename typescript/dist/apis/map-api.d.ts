...
export declare const MapApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     */
    getMap: (clientVersion?: number | null, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const MapApiFp: (configuration?: Configuration) => {
     ...
     * @throws {RequiredError}
     */
    getMap(clientVersion?: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<MapData>>;
};
/**
