...
export const MapApiAxiosParamCreator = function (configuration) {
    return {
         ...
         */
        getMap: async (clientVersion, options = {}) => {
 ...
 */
export const MapApiFp = function (configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getMap(clientVersion, options) {
 ...
 */
export const MapApiFactory = function (configuration, basePath, axios) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getMap(requestParameters = {}, options) {
