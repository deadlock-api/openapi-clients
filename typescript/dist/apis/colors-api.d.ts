 ...
 */
export declare const ColorsApiAxiosParamCreator: (configuration?: Configuration) => {
    /**
     ...
     */
    listColors: (clientVersion?: number | null, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * ColorsApi - functional programming interface
 */
export declare const ColorsApiFp: (configuration?: Configuration) => {
    /**
     * Panorama color palette (`@define <name>: #RRGGBB[AA];` declarations from `citadel_base_styles.css`), keyed by `snake_case` name.
     * @summary List Colors
     * @param {number | null} [clientVersion] Client/game version (e.g. &#x60;6518&#x60;). Defaults to the latest known version.
     ...
     * @throws {RequiredError}
     */
    listColors(clientVersion?: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<{
        [key: string]: Color;
    }>>;
};
/**
 ...
 */
export declare const ColorsApiFactory: (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) => {
    /**
     * Panorama color palette (`@define <name>: #RRGGBB[AA];` declarations from `citadel_base_styles.css`), keyed by `snake_case` name.
     * @summary List Colors
     ...
     * @throws {RequiredError}
     */
    listColors(requestParameters?: ColorsApiListColorsRequest, options?: RawAxiosRequestConfig): AxiosPromise<{
        [key: string]: Color;
    }>;
};
/**
