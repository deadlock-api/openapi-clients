 ...
 */
export declare const AbilitySectionType: {
    readonly Innate: "innate";
    readonly Active: "active";
    readonly Passive: "passive";
};
export type AbilitySectionType = typeof AbilitySectionType[keyof typeof AbilitySectionType];
//# sourceMappingURL=ability-section-type.d.ts.map