 ...
 */
export declare const AbilityImbue: {
    readonly ImbueActive: "imbue_active";
    readonly ImbueActiveNonUlt: "imbue_active_non_ult";
    readonly ImbueModifierValue: "imbue_modifier_value";
};
export type AbilityImbue = typeof AbilityImbue[keyof typeof AbilityImbue];
//# sourceMappingURL=ability-imbue.d.ts.map