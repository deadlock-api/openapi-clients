 ...
 */
import type { RawItemWeaponInfoBulletSpeedCurveSpline } from './raw-item-weapon-info-bullet-speed-curve-spline.js';
export interface RawItemWeaponInfoBulletSpeedCurve {
    'domain_maxs': Array<number>;
    'domain_mins': Array<number>;
    'spline'?: Array<RawItemWeaponInfoBulletSpeedCurveSpline> | null;
}
//# sourceMappingURL=raw-item-weapon-info-bullet-speed-curve.d.ts.map