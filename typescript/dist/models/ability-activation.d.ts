 ...
 */
export declare const AbilityActivation: {
    readonly HoldToggle: "hold_toggle";
    readonly InstantCast: "instant_cast";
    readonly OnButtonIsDown: "on_button_is_down";
    readonly Passive: "passive";
    readonly Press: "press";
    readonly PressToggle: "press_toggle";
    readonly InstantCastToggle: "instant_cast_toggle";
};
export type AbilityActivation = typeof AbilityActivation[keyof typeof AbilityActivation];
//# sourceMappingURL=ability-activation.d.ts.map